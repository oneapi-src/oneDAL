...
abstract public class NumericTableImpl extends SerializableBase {
    ...
    protected long newJavaNumericTable(long nColumns, long nRows, NumericTable.StorageLayout layout, DataDictionary.FeaturesEqual featuresEqual) {
        nJavaFeatures = nColumns;
        nJavaVectors = nRows;
        return cNewJavaNumericTable(nColumns, nRows, layout.ordinal(), featuresEqual.ordinal());
    }

    private native long cNewJavaNumericTable(long nColumns, long nRows, int layout, int featuresEqual);
