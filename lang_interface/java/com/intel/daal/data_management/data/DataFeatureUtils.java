...
public class DataFeatureUtils {
    ...
    @Native private static final int cDaalGenFloat   = 0;
    @Native private static final int cDaalGenDouble  = 1;
    @Native private static final int cDaalGenInteger = 2;
    @Native private static final int cDaalGenBoolean = 3;
    @Native private static final int cDaalGenString  = 4;
    @Native private static final int cDaalGenUnknown = 0xfffffff;
    ...
    @Native private static final int cDaalCategorical = 0;
    @Native private static final int cDaalOrdinal     = 1;
    @Native private static final int cDaalContinuous  = 2;
