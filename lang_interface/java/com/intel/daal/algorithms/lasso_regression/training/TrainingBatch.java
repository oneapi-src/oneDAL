...
import com.intel.daal.algorithms.lasso_regression.TrainParameter;
import com.intel.daal.services.DaalContext;

/**
 * <a name="DAAL-CLASS-ALGORITHMS__LASSO_REGRESSION__TRAINING__TRAININGBATCH"></a>
...
public class TrainingBatch extends com.intel.daal.algorithms.TrainingBatch {
    ...
    /**
     * Constructs a lasso regression training algorithm by copying input objects and parameters of another lasso regression training algorithm in the
     * batch processing mode
     * @param context   Context to manage lasso regression model-based training
     ...
     * @param context   Context to manage lasso regression model-based training
     * @param cls       Data type to use in intermediate computations of lasso regression, Double.class or Float.class
     ...
     * @return Result of lasso regression model-based training
     */
    @Override
    ...
    /**
     * Returns a newly allocated lasso regression training algorithm with a copy of the input objects and parameters of this lasso regression
