 ...
 */
/**
 * \brief Contains classes for lasso regression model-based prediction
 */
 ...
 * @brief %Input object for making lasso regression model-based prediction
 */
public final class Input extends com.intel.daal.algorithms.Input {
    ...
    /**
     * Sets an input object for lasso regression model-based prediction
    ...
    /**
     * Returns an input object for lasso regression model-based prediction
     * @param id      Identifier of the input object
