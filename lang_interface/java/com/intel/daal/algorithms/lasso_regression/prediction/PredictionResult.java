...
/**
 * <a name="DAAL-CLASS-ALGORITHMS__LASSO_REGRESSION__PREDICTION__PREDICTIONRESULT"></a>
 * @brief Result object for lasso regression model-based prediction
 */
public final class PredictionResult extends com.intel.daal.algorithms.Result {
     ...
     * @param context   Context to manage the  result of the lasso regression prediction algorithm
     */
