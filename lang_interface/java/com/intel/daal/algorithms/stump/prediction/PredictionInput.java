...
public class PredictionInput extends com.intel.daal.algorithms.classifier.prediction.PredictionInput {
    ...
    /**
     * Sets the NumericTable input object for the Stump model-based prediction algorithm
    ...
    /**
     * Returns the NumericTable input object for the Stump model-based prediction algorithm
     * @param id Identifier of the input object
    ...
    /**
     * Sets the Model input object for the Stump model-based prediction algorithm
     * @param id    Identifier of the input object
     * @param val   Value of the input object
     */
