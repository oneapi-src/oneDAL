...
/**
 * <a name="DAAL-CLASS-ALGORITHMS__binary_adaboost__TRAINING__TRAININGRESULT"></a>
 * @brief Provides methods to access final results obtained with the compute() method of the binary_adaboost training algorithm in the batch processing mode
 */
public final class TrainingResult extends com.intel.daal.algorithms.boosting.training.TrainingResult {
    ...
    /**
     * Returns the final result of the binary_adaboost training algorithm
