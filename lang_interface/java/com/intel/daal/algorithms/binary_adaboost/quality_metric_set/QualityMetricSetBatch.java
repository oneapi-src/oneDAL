...
/**
 * @defgroup binary_adaboost_quality_metric_set_batch Batch
 * @ingroup binary_adaboost_quality_metric_set
 * @{
 */
/**
 * @brief Contains classes to check the quality of the model trained with the binary_adaboost algorithm
 */
package com.intel.daal.algorithms.binary_adaboost.quality_metric_set;
...
/**
 * <a name="DAAL-CLASS-ALGORITHMS__binary_adaboost__QUALITY_METRIC_SET__QUALITYMETRICSETBATCH"></a>
 * @brief Class that represents a quality metric set to check the model trained with the binary_adaboost algorithm
 *
 * @par Enumerations
