...
/**
 * <a name="DAAL-CLASS-ALGORITHMS__binary_adaboost__QUALITY_METRIC_SET__QUALITYMETRICID"></a>
 * @brief Available identifiers of the quality metrics available for the model trained with the binary_adaboost algorithm
 */
