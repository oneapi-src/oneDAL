...
/**
 * <a name="DAAL-CLASS-ALGORITHMS__REGRESSION__PREDICTION__PREDICTIONRESULT"></a>
 * @brief Provides methods to access final results obtained with the compute() method of the regression model-based prediction algorithm in the batch processing mode
 */
...
public class PredictionResult extends com.intel.daal.algorithms.Result {
    ...
    /**
     * Constructs the result of the regression model-based prediction algorithm
     * @param context   Context to manage the result of the regression model-based prediction algorithm
     */
