...
public class ModelBuilder extends SerializableBase {
     ...
     * @param context    Context to manage linear regression model builder
     * @param cls        Data type to use in intermediate computations of linear regression,
     *                   Double.class or Float.class
     * @param nFeatures  Number of features
     * @param nResponses Number of responses
     */
    public ModelBuilder(DaalContext context, Class<? extends Number> cls, long nFeatures, long nResponses) {
        super(context);
        ...
        this.cObject = cInit(prec.getValue(), nFeatures, nResponses);
    }

    /**
     * Returns built model of linear regression
     * @return Model of linear regression
     */
    ...
    private native long cInit(int prec, long nFeatures, long nResponses);
