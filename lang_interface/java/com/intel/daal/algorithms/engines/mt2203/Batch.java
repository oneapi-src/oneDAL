 ...
 */
/**
 * @brief Contains classes for the mt2203 engine
 */
package com.intel.daal.algorithms.engines.mt2203;
 ...
 */
public class Batch extends com.intel.daal.algorithms.engines.FamilyBatchBase {
     ...
     * @param context Context to manage the mt2203 engine
    ...
    /**
     * Returns the newly allocated mt2203 engine
     * with a copy of input objects and parameters of this mt2203 engine
     * @param context    Context to manage the engine
     * @return The newly allocated mt2203 engine
     */
    @Override
