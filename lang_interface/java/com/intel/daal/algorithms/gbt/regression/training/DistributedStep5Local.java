...
/**
 * <a name="DAAL-CLASS-ALGORITHMS__GBT__REGRESSION__TRAINING__DISTRIBUTEDSTEP5LOCAL"></a>
...
public class DistributedStep5Local extends AnalysisDistributed {
     ...
     * of another gradient boosted trees training algorithm in the fifth step of distributed processing mode
     ...
     */
    public DistributedStep5Local(DaalContext context, Class<? extends Number> cls, Method method) {
        super(context);
