...
/**
 * <a name="DAAL-CLASS-ALGORITHMS__GBT__REGRESSION__TRAINING__DISTRIBUTEDSTEP6LOCAL"></a>
...
public class DistributedStep6Local extends AnalysisDistributed {
     ...
     * of another gradient boosted trees training algorithm in the sixth step of distributed processing mode
     ...
     */
    public DistributedStep6Local(DaalContext context, Class<? extends Number> cls, Method method) {
        super(context);
