/* file: DistributedStep2Local.java */
/*******************************************************************************
...
/**
 * <a name="DAAL-CLASS-ALGORITHMS__GBT__REGRESSION__TRAINING__DISTRIBUTEDSTEP2LOCAL"></a>
 * @brief Provides methods for model-based training in the second step of distributed processing mode
 */
public class DistributedStep2Local extends AnalysisDistributed {
    public  DistributedStep2LocalInput input;      /*!< %Input data */
     ...
     * of another gradient boosted trees training algorithm in the second step of distributed processing mode
     * @param context   Context to manage the algorithm
     * @param other     An algorithm to be used as the source to initialize the input objects
     *                  and parameters of the algorithm
     */
    public DistributedStep2Local(DaalContext context, DistributedStep2Local other) {
        super(context);
        ...
        input     = new DistributedStep2LocalInput(getContext(), cGetInput     (cObject, precision.getValue(), method.getValue()));
     ...
     */
    public DistributedStep2Local(DaalContext context, Class<? extends Number> cls, Method method) {
        super(context);
    ...
    public DistributedPartialResultStep2 compute() {
        super.compute();
        return new DistributedPartialResultStep2(getContext(), cGetPartialResult(cObject, precision.getValue(), method.getValue()));
    }
     ...
     */
    @Override
    public DistributedStep2Local clone(DaalContext context) {
        return new DistributedStep2Local(context, this);
    }
