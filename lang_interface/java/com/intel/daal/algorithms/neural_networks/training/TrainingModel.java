...
public class TrainingModel extends com.intel.daal.algorithms.Model {
     ...
     * @param parameter Parameters of the training. This parameter is not used in current version of the library.
     */
    public void initialize(Class <? extends Number> cls, long[] sampleSize, TrainingTopology topology, TrainingParameter parameter) {
        if (cls == Double.class) {
