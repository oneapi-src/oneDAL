/* file: Convolution2dSpatialDimensions.java */
/*******************************************************************************
...
/**
 * <a name="DAAL-CLASS-ALGORITHMS__NEURAL_NETWORKS__LAYERS__CONVOLUTION2D__CONVOLUTION2DSPATIALDIMENSIONS"></a>
 * \brief Data structure representing the dimension for convolution kernels
 */
public final class Convolution2dSpatialDimensions {
    private long[] size;     /*!< Array of dimensions for convolution kernels */

    /**
    * Constructs Convolution2dSpatialDimensions with parameters
    * @param first  The first dimension for convolution kernels
    * @param second The second dimension for convolution kernels
    */
    public Convolution2dSpatialDimensions(long first, long second) {
        size = new long[2];
        size[0] = first;
        size[1] = second;
    }
