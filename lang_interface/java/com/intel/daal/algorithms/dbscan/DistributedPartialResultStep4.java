 ...
 *        DBSCAN algorithm in the fourth step of the distributed processing mode
 */
public final class DistributedPartialResultStep4 extends com.intel.daal.algorithms.PartialResult {
    ...
    /**
     * Returns a partial result of the DBSCAN algorithm obtained in the fourth step of the distributed processing mode
    ...
    public DataCollection get(DistributedPartialResultStep4Id id) {
        if (id != DistributedPartialResultStep4Id.partitionedData && id != DistributedPartialResultStep4Id.partitionedWeights &&
            id != DistributedPartialResultStep4Id.partitionedPartialOrders) {
    ...
    /**
    * Sets a partial result of the DBSCAN algorithm obtained in the fourth step of the distributed processing mode
