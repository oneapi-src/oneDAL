/* file: DistributedStep8Local.java */
/*******************************************************************************
...
/**
 * <a name="DAAL-CLASS-ALGORITHMS__DBSCAN__DISTRIBUTEDSTEP8LOCAL"></a>
 * @brief Runs the DBSCAN algorithm in the eigth step of the distributed processing mode
 */
public class DistributedStep8Local extends AnalysisDistributed {
    public  DistributedStep8LocalInput input;      /*!< %Input data */
     ...
     */
    public DistributedStep8Local(DaalContext context, DistributedStep8Local other) {
        super(context);
        ...
        input     = new DistributedStep8LocalInput(getContext(), cGetInput     (cObject, precision.getValue(), method.getValue()));
     ...
     */
    public DistributedStep8Local(DaalContext context, Class<? extends Number> cls, Method method, long blockIndex, long nBlocks) {
        super(context);
     ...
     */
    @Override
    public DistributedPartialResultStep8 compute() {
        super.compute();
        return new DistributedPartialResultStep8(getContext(), cGetPartialResult(cObject, precision.getValue(), method.getValue()));
    }
     ...
     */
    public void setPartialResult(DistributedPartialResultStep8 partialResult) {
     ...
     */
    @Override
    public DistributedStep8Local clone(DaalContext context) {
        return new DistributedStep8Local(context, this);
    }
