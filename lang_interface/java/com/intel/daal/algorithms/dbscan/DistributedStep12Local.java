/* file: DistributedStep12Local.java */
/*******************************************************************************
...
/**
 * <a name="DAAL-CLASS-ALGORITHMS__DBSCAN__DISTRIBUTEDSTEP12LOCAL"></a>
 * @brief Runs the DBSCAN algorithm in the twelfth step of the distributed processing mode
 */
public class DistributedStep12Local extends AnalysisDistributed {
    public  DistributedStep12LocalInput input;      /*!< %Input data */
     ...
     */
    public DistributedStep12Local(DaalContext context, DistributedStep12Local other) {
        super(context);
        ...
        input     = new DistributedStep12LocalInput(getContext(), cGetInput     (cObject, precision.getValue(), method.getValue()));
     ...
     */
    public DistributedStep12Local(DaalContext context, Class<? extends Number> cls, Method method, long blockIndex, long nBlocks) {
        super(context);
     ...
     */
    @Override
    public DistributedPartialResultStep12 compute() {
        super.compute();
        return new DistributedPartialResultStep12(getContext(), cGetPartialResult(cObject, precision.getValue(), method.getValue()));
    }
     ...
     */
    public void setPartialResult(DistributedPartialResultStep12 partialResult) {
     ...
     */
    @Override
    public DistributedStep12Local clone(DaalContext context) {
        return new DistributedStep12Local(context, this);
    }
