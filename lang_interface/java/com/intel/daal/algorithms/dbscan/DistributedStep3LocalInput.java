...
/**
 * <a name="DAAL-CLASS-ALGORITHMS__DBSCAN__DISTRIBUTEDSTEP3LOCALINPUT"></a>
 * @brief %Input objects for the DBSCAN algorithm in the third step of the distributed processing mode
 */
...
public final class DistributedStep3LocalInput extends com.intel.daal.algorithms.Input {
    ...
    /**
     * Sets an input object for the DBSCAN algorithm in the third step of the distributed processing mode
    ...
    /**
     * Adds an input object for the DBSCAN algorithm in the third step of the distributed processing mode
     * @param id            Identifier of the input object
     * @param val           Value of the input object
     */
    ...
    /**
     * Returns an input object for the DBSCAN algorithm in the third step of the distributed processing mode
     * @param id      Identifier of the input object
    ...
    public void set(Step3LocalCollectionInputId id, DataCollection val) {
        if (id == Step3LocalCollectionInputId.step3PartialBoundingBoxes) {
            cSetDataCollection(this.cObject, id.getValue(), val.getCObject());
        } else {
            throw new IllegalArgumentException("id unsupported");
        }
