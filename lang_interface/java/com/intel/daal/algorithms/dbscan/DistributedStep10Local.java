/* file: DistributedStep10Local.java */
/*******************************************************************************
...
/**
 * <a name="DAAL-CLASS-ALGORITHMS__DBSCAN__DISTRIBUTEDSTEP10LOCAL"></a>
 * @brief Runs the DBSCAN algorithm in the tenth step of the distributed processing mode
 */
public class DistributedStep10Local extends AnalysisDistributed {
    public  DistributedStep10LocalInput input;      /*!< %Input data */
     ...
     */
    public DistributedStep10Local(DaalContext context, DistributedStep10Local other) {
        super(context);
        ...
        input     = new DistributedStep10LocalInput(getContext(), cGetInput     (cObject, precision.getValue(), method.getValue()));
     ...
     */
    public DistributedStep10Local(DaalContext context, Class<? extends Number> cls, Method method, long blockIndex, long nBlocks) {
        super(context);
     ...
     */
    @Override
    public DistributedPartialResultStep10 compute() {
        super.compute();
        return new DistributedPartialResultStep10(getContext(), cGetPartialResult(cObject, precision.getValue(), method.getValue()));
    }
     ...
     */
    public void setPartialResult(DistributedPartialResultStep10 partialResult) {
     ...
     */
    @Override
    public DistributedStep10Local clone(DaalContext context) {
        return new DistributedStep10Local(context, this);
    }
