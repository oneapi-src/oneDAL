...
/**
 * <a name="DAAL-CLASS-ALGORITHMS__DBSCAN__DISTRIBUTEDSTEP2LOCAL"></a>
 * @brief Runs the DBSCAN algorithm in the second step of the distributed processing mode
 */
public class DistributedStep2Local extends AnalysisDistributed {
     ...
     */
    public DistributedStep2Local(DaalContext context, Class<? extends Number> cls, Method method, long blockIndex, long nBlocks) {
        super(context);
