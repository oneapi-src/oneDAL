...
/**
 * <a name="DAAL-CLASS-ALGORITHMS__DBSCAN__DISTRIBUTEDSTEP2LOCALINPUT"></a>
 * @brief %Input objects for the DBSCAN algorithm in the second step of the distributed processing mode
 */
...
public final class DistributedStep2LocalInput extends com.intel.daal.algorithms.Input {
    ...
    /**
     * Sets an input object for the DBSCAN algorithm in the second step of the distributed processing mode
    ...
    /**
     * Adds an input object for the DBSCAN algorithm in the second step of the distributed processing mode
     * @param id            Identifier of the input object
     * @param val           Value of the input object
     */
    ...
    /**
     * Returns an input object for the DBSCAN algorithm in the second step of the distributed processing mode
     * @param id      Identifier of the input object
