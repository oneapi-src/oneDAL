/* file: DistributedStep5Local.java */
/*******************************************************************************
...
/**
 * <a name="DAAL-CLASS-ALGORITHMS__DBSCAN__DISTRIBUTEDSTEP5LOCAL"></a>
 * @brief Runs the DBSCAN algorithm in the fifth step of the distributed processing mode
 */
public class DistributedStep5Local extends AnalysisDistributed {
    public  DistributedStep5LocalInput input;      /*!< %Input data */
     ...
     */
    public DistributedStep5Local(DaalContext context, DistributedStep5Local other) {
        super(context);
        ...
        input     = new DistributedStep5LocalInput(getContext(), cGetInput     (cObject, precision.getValue(), method.getValue()));
     ...
     */
    public DistributedStep5Local(DaalContext context, Class<? extends Number> cls, Method method, long blockIndex, long nBlocks, double epsilon) {
        super(context);
        ...
        this.cObject = cInit(precision.getValue(), this.method.getValue(), blockIndex, nBlocks, epsilon);
     ...
     */
    @Override
    public DistributedPartialResultStep5 compute() {
        super.compute();
        return new DistributedPartialResultStep5(getContext(), cGetPartialResult(cObject, precision.getValue(), method.getValue()));
    }
     ...
     */
    public void setPartialResult(DistributedPartialResultStep5 partialResult) {
     ...
     */
    @Override
    public DistributedStep5Local clone(DaalContext context) {
        return new DistributedStep5Local(context, this);
    }

    private native long cInit(int precision, int method, long blockIndex, long nBlocks, double epsilon);
