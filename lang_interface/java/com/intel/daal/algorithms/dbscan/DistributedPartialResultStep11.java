/* file: DistributedPartialResultStep11.java */
/*******************************************************************************
 ...
 *        DBSCAN algorithm in the eleventh step of the distributed processing mode
 */
public final class DistributedPartialResultStep11 extends com.intel.daal.algorithms.PartialResult {
    /** @private */
    static {
     ...
     */
    public DistributedPartialResultStep11(DaalContext context) {
        super(context);
        this.cObject = cNewDistributedPartialResultStep11();
    }

    DistributedPartialResultStep11(DaalContext context, long cObject) {
        super(context, cObject);
    }

    /**
     * Returns a partial result of the DBSCAN algorithm obtained in the eleventh step of the distributed processing mode
     * @param  id   Identifier of the input object, @ref DistributedPartialResultStep11NumericTableId
     * @return      Partial result that corresponds to the given identifier
     */
    public NumericTable get(DistributedPartialResultStep11NumericTableId id) {
        if (id != DistributedPartialResultStep11NumericTableId.step11ClusterStructure &&
            id != DistributedPartialResultStep11NumericTableId.step11FinishedFlag) {
    ...
    */
    public void set(DistributedPartialResultStep11NumericTableId id, NumericTable value) {
        if (id != DistributedPartialResultStep11NumericTableId.step11ClusterStructure &&
            id != DistributedPartialResultStep11NumericTableId.step11FinishedFlag) {
            throw new IllegalArgumentException("id unsupported");
        }
    ...
    /**
     * Returns a partial result of the DBSCAN algorithm obtained in the eleventh step of the distributed processing mode
     * @param  id   Identifier of the input object, @ref DistributedPartialResultStep11CollectionId
     * @return      Partial result that corresponds to the given identifier
     */
    public DataCollection get(DistributedPartialResultStep11CollectionId id) {
        if (id != DistributedPartialResultStep11CollectionId.step11Queries) {
            throw new IllegalArgumentException("id unsupported");
        }
    ...
    * @param value  Value of the input object
    */
    public void set(DistributedPartialResultStep11CollectionId id, DataCollection value) {
        if (id != DistributedPartialResultStep11CollectionId.step11Queries) {
            throw new IllegalArgumentException("id unsupported");
        }
