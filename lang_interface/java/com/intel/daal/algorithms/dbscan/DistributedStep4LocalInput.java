...
/**
 * <a name="DAAL-CLASS-ALGORITHMS__DBSCAN__DISTRIBUTEDSTEP4LOCALINPUT"></a>
 * @brief %Input objects for the DBSCAN algorithm in the fourth step of the distributed processing mode
 */
...
public final class DistributedStep4LocalInput extends com.intel.daal.algorithms.Input {
    ...
    /**
     * Sets an input object for the DBSCAN algorithm in the fourth step of the distributed processing mode
    ...
    /**
     * Adds an input object for the DBSCAN algorithm in the fourth step of the distributed processing mode
     * @param id            Identifier of the input object
     * @param val           Value of the input object
     */
    ...
    /**
     * Returns an input object for the DBSCAN algorithm in the fourth step of the distributed processing mode
     * @param id      Identifier of the input object
    ...
    public void set(Step4LocalCollectionInputId id, DataCollection val) {
        if (id == Step4LocalCollectionInputId.step4PartialSplits || id == Step4LocalCollectionInputId.step4PartialOrders) {
            cSetDataCollection(this.cObject, id.getValue(), val.getCObject());
        } else {
            throw new IllegalArgumentException("id unsupported");
        }
     ...
     * @param val           Value of the input object
     */
    public void add(Step4LocalCollectionInputId id, NumericTable val) {
        if (id == Step4LocalCollectionInputId.step4PartialSplits || id == Step4LocalCollectionInputId.step4PartialOrders) {
            cAddNumericTable(this.cObject, id.getValue(), val.getCObject());
        } else {
            throw new IllegalArgumentException("id unsupported");
