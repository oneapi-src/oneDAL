 ...
 *        DBSCAN algorithm in the second step of the distributed processing mode
 */
public final class DistributedPartialResultStep2 extends com.intel.daal.algorithms.PartialResult {
    ...
    /**
     * Returns a partial result of the DBSCAN algorithm obtained in the second step of the distributed processing mode
    ...
    public NumericTable get(DistributedPartialResultStep2Id id) {
        if (id != DistributedPartialResultStep2Id.boundingBox) {
    ...
    /**
    * Sets a partial result of the DBSCAN algorithm obtained in the second step of the distributed processing mode
