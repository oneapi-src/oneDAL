...
/**
 * <a name="DAAL-CLASS-ALGORITHMS__DBSCAN__DISTRIBUTEDSTEP3LOCAL"></a>
 * @brief Runs the DBSCAN algorithm in the third step of the distributed processing mode
 */
public class DistributedStep3Local extends AnalysisDistributed {
     ...
     */
    public DistributedStep3Local(DaalContext context, Class<? extends Number> cls, Method method, long leftBlocks, long rightBlocks) {
        super(context);
