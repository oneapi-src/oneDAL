/* file: DistributedStep9MasterInput.java */
/*******************************************************************************
...
/**
 * <a name="DAAL-CLASS-ALGORITHMS__DBSCAN__DISTRIBUTEDSTEP9MASTERINPUT"></a>
 * @brief %Input objects for the DBSCAN algorithm in the ninth step of the distributed processing mode
 */

public final class DistributedStep9MasterInput extends com.intel.daal.algorithms.Input {
    ...
    public DistributedStep9MasterInput(DaalContext context, long cObject) {
        super(context);
     ...
     */
    public void set(Step9MasterCollectionInputId id, DataCollection val) {
        if (id == Step9MasterCollectionInputId.partialNClusters) {
     ...
     * @param val           Value of the input object
     */
    public void add(Step9MasterCollectionInputId id, NumericTable val) {
        if (id == Step9MasterCollectionInputId.partialNClusters) {
     ...
     */
    public DataCollection get(Step9MasterCollectionInputId id) {
        if (id == Step9MasterCollectionInputId.partialNClusters) {
