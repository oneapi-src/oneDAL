/* file: DistributedStep11Local.java */
/*******************************************************************************
...
/**
 * <a name="DAAL-CLASS-ALGORITHMS__DBSCAN__DISTRIBUTEDSTEP11LOCAL"></a>
 * @brief Runs the DBSCAN algorithm in the eleventh step of the distributed processing mode
 */
public class DistributedStep11Local extends AnalysisDistributed {
    public  DistributedStep11LocalInput input;      /*!< %Input data */
     ...
     */
    public DistributedStep11Local(DaalContext context, DistributedStep11Local other) {
        super(context);
        ...
        input     = new DistributedStep11LocalInput(getContext(), cGetInput     (cObject, precision.getValue(), method.getValue()));
     ...
     */
    public DistributedStep11Local(DaalContext context, Class<? extends Number> cls, Method method, long blockIndex, long nBlocks) {
        super(context);
     ...
     */
    @Override
    public DistributedPartialResultStep11 compute() {
        super.compute();
        return new DistributedPartialResultStep11(getContext(), cGetPartialResult(cObject, precision.getValue(), method.getValue()));
    }
     ...
     */
    public void setPartialResult(DistributedPartialResultStep11 partialResult) {
     ...
     */
    @Override
    public DistributedStep11Local clone(DaalContext context) {
        return new DistributedStep11Local(context, this);
    }
