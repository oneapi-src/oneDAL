...
/**
 * <a name="DAAL-CLASS-ALGORITHMS__OPTIMIZATION_SOLVER__CROSS-ENTROPY_LOSS__PARAMETER"></a>
 * @brief Parameters of the cross-entropy loss objective function algorithm
 */
public class Parameter extends com.intel.daal.algorithms.optimization_solver.sum_of_functions.Parameter {
    ...
    /**
     * Constructs the parameter for the cross-entropy loss objective function algorithm
    ...
    /**
     * Returns the number of classes (different values of dependent variable)
     * @return NClasses
     */
    ...
    /**
     * Sets the number of classes (different values of dependent variable)
     * @param value
     */
    public void setNClasses(long value) {
        cSetNClasses(this.cObject, value);
    }
    ...
    private native void cSetNClasses(long parAddr, long value);
}
/** @} */
