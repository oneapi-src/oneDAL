 ...
 * @brief %Input objects for the cross-entropy loss objective function algorithm
 */
public class Input extends com.intel.daal.algorithms.optimization_solver.sum_of_functions.Input {
    ...
    /**
     * Constructs the input for the cross-entropy loss objective function algorithm
    ...
    /**
     * Sets an input object for the cross-entropy loss objective function algorithm
    ...
    /**
     * Returns an input object for the cross-entropy loss objective function algorithm
     * @param id Identifier of the input object
