 ...
 */
class DAAL_EXPORT KeyValueDataCollection : public SerializationIface
{
public:
    DECLARE_SERIALIZABLE_TAG();
    ...
    /** Copy constructor */
    KeyValueDataCollection(const KeyValueDataCollection& other) : _keys(other._keys), _values(other._values){}

    KeyValueDataCollection(const services::Collection<size_t> &keys, const DataCollection &values)
    {
...
protected:
    ...
    DataCollection _values;
    SerializationIfacePtr _nullPtr;
};
