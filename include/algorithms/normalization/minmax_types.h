...
public:
    ...
    Parameter(algorithmFPType lowerBound=0.0, algorithmFPType upperBound=1.0, const services::SharedPtr<low_order_moments::BatchIface> &moments =
        services::SharedPtr<low_order_moments::BatchIface>(new low_order_moments::Batch<algorithmFPType>()));

    algorithmFPType lowerBound;  /*!< The lower bound of the features value will be obtained during normalization. */
    algorithmFPType upperBound;  /*!< The upper bound of the features value will be obtained during normalization. */
...
public:
    ...
    int getSerializationTag() DAAL_C11_OVERRIDE  { return SERIALIZATION_NORMALIZATION_MINMAX_RESULT_ID; }
