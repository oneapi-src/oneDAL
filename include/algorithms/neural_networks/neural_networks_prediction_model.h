...
public:
    ...
    Model(const services::SharedPtr<neural_networks::ForwardLayers> &forwardLayers,
        ...
        ModelImpl(forwardLayers, nextLayers), _allocatedBatchSize(0)
    {}
    ...
    Model(const services::SharedPtr<neural_networks::ForwardLayers> &forwardLayers,
        ...
        ModelImpl(forwardLayers, nextLayers, storeWeightsInTable), _allocatedBatchSize(0)
    {
...
protected:
    ...
    {
        _forwardLayers->insert(layerDescriptor.index(), layerDescriptor.layer->clone());
