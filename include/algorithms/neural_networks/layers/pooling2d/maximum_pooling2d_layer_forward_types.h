...
public:
    ...
    /**
     * Returns the serialization tag of the forward maximum 2D pooling layer result
     * \return     Serialization tag of the forward maximum 2D pooling layer result
     */
    int getSerializationTag() DAAL_C11_OVERRIDE  { return SERIALIZATION_NEURAL_NETWORKS_LAYERS_MAXIMUM_POOLING2D_FORWARD_RESULT_ID; }
