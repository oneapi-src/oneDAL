...
public:
     ...
     * \DAAL_DEPRECATED
     */
    DAAL_DEPRECATED data_management::TensorPtr get(LayerDataTensorId id) const;
     ...
     * \DAAL_DEPRECATED
     */
    DAAL_DEPRECATED void set(LayerDataTensorId id, const data_management::TensorPtr &ptr);
...
protected:
     ...
     * \DAAL_DEPRECATED
     */
    DAAL_DEPRECATED_VIRTUAL data_management::NumericTablePtr getAuxInputDimensions() const DAAL_C11_OVERRIDE;
};
