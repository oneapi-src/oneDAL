...
public:
    /** Default constructor */
    Result() : pooling1d::backward::Result() {};
    virtual ~Result() {};
    ...
    /**
     * Returns the serialization tag of the backward 1D maximum pooling layer result
     * \return     Serialization tag of the backward 1D maximum pooling layer result
     */
    int getSerializationTag() DAAL_C11_OVERRIDE  { return SERIALIZATION_NEURAL_NETWORKS_LAYERS_MAXIMUM_POOLING1D_BACKWARD_RESULT_ID; }
