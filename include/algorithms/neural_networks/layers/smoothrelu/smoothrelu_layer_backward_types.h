...
{
/**
 * @defgroup smoothrelu_layers_backward Backward Smooth Rectifier Linear Unit (ReLU) Layer
...
public:
    ...
    /**
    * Returns the serialization tag of the backward smooth relu layer result
    * \return         Serialization tag of the backward smooth relu layer result
    */
    int getSerializationTag() DAAL_C11_OVERRIDE  { return SERIALIZATION_NEURAL_NETWORKS_LAYERS_SMOOTHRELU_BACKWARD_RESULT_ID; }
