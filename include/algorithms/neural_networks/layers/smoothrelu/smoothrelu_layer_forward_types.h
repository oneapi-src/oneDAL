...
{
/**
 * @defgroup smoothrelu_layers_forward Forward Smooth Rectifier Linear Unit (ReLU) Layer
...
public:
    ...
    /**
    * Returns the serialization tag of the forward smooth relu layer result
    * \return         Serialization tag of the forward smooth relu layer result
    */
    int getSerializationTag() DAAL_C11_OVERRIDE  { return SERIALIZATION_NEURAL_NETWORKS_LAYERS_SMOOTHRELU_FORWARD_RESULT_ID; }
