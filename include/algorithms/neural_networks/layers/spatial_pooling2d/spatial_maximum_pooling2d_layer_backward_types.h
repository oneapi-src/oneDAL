...
public:
    ...
    /**
     * Returns the serialization tag of the backward spatial pyramid maximum 2D pooling layer result
     * \return     Serialization tag of the backward spatial pyramid maximum 2D pooling layer result
     */
    int getSerializationTag() DAAL_C11_OVERRIDE  { return SERIALIZATION_NEURAL_NETWORKS_LAYERS_SPATIAL_MAXIMUM_POOLING2D_BACKWARD_RESULT_ID; }
