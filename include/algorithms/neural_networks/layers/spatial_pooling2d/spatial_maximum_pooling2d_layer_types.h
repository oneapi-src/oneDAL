...
struct Parameter: public spatial_pooling2d::Parameter
{
    Parameter(size_t pyramidHeight, size_t firstIndex, size_t secondIndex) : spatial_pooling2d::Parameter(pyramidHeight, firstIndex, secondIndex) {}
};
/* [Parameter source code] */
