 ...
 */
class Input : public spatial_pooling2d::backward::Input
{
public:
    /**
     * Default constructor
 ...
 */
class Result : public spatial_pooling2d::backward::Result
{
public:
    /**
     * Default constructor
    ...
    /**
     * Returns the serialization tag of the backward spatial pyramid stochastic 2D pooling layer result
     * \return     Serialization tag of the backward spatial pyramid stochastic 2D pooling layer result
     */
    int getSerializationTag() DAAL_C11_OVERRIDE  { return SERIALIZATION_NEURAL_NETWORKS_LAYERS_SPATIAL_STOCHASTIC_POOLING2D_BACKWARD_RESULT_ID; }
