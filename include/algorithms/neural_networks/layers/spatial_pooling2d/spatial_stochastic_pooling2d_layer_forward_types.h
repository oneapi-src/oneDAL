 ...
 */
class Input : public spatial_pooling2d::forward::Input
{};
 ...
 */
class Result : public spatial_pooling2d::forward::Result
{
public:
    /** Default constructor */
    Result() {}
    ...
    /**
     * Returns the serialization tag of the forward spatial pyramid stochastic 2D pooling layer result
     * \return     Serialization tag of the forward spatial pyramid stochastic 2D pooling layer result
     */
    int getSerializationTag() DAAL_C11_OVERRIDE  { return SERIALIZATION_NEURAL_NETWORKS_LAYERS_SPATIAL_STOCHASTIC_POOLING2D_FORWARD_RESULT_ID; }
