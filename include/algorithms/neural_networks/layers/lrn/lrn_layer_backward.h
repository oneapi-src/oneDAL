...
public:
     ...
     * \DAAL_DEPRECATED
     */
    DAAL_DEPRECATED Batch(const Batch<algorithmFPType, method> &other) : super(other),
    ...
    * \return Method of the layer
     * \DAAL_DEPRECATED
    */
    DAAL_DEPRECATED_VIRTUAL int getMethod() const DAAL_C11_OVERRIDE { return(int) method; }
...
protected:
     ...
     * \DAAL_DEPRECATED
     */
    DAAL_DEPRECATED void initialize()
    {
