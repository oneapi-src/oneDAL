...
{
/**
 * @defgroup locallyconnected2d_forward Forward Two-dimensional __onvolution Layer
...
public:
    ...
    */
    ...
    void DAAL_EXPORT allocate(const daal::algorithms::Parameter *parameter, const int method);
...
public:
    ...
    /**
     * Returns the serialization tag of the forward 2D locally connected layer result
     * \return     Serialization tag of the forward 2D locally connected layer result
     */
    int getSerializationTag() DAAL_C11_OVERRIDE  { return SERIALIZATION_NEURAL_NETWORKS_LAYERS_LOCALLYCONNECTED2D_FORWARD_RESULT_ID; }
