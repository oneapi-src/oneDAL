 ...
 */
class PredictionContainerIface : public AlgorithmContainerIface<batch> {};

class DistributedPredictionContainerIface : public AlgorithmContainerIface<distributed> {};
/**
