...
public:
    ...
    /**
     * Constructs decision_forest prediction algorithm
    ...
    /**
     * Constructs a decision_forest prediction algorithm by copying input objects and parameters
     * of another decision_forest prediction algorithm
    ...
    */
    ...
    /**
     * Returns a pointer to the newly allocated decision_forest prediction algorithm with a copy of input objects
     * and parameters of this decision_forest prediction algorithm
