...
protected:
    ...
    void initialize()
    {
        ...
        _in = &input;
        _par = &parameter;
        _partialResult = services::SharedPtr<PartialResult<correlationDense> >(new PartialResult<correlationDense>());
...
protected:
    ...
    void initialize()
    {
        ...
        _in = &input;
        _par = &parameter;
        _partialResult = services::SharedPtr<PartialResult<svdDense> >(
