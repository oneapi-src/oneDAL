...
/**
* <a name="DAAL-ENUM-ALGORITHMS__OPTIMIZATION_SOLVER__ITERATIVE_SOLVER__LBFGS_OPTIONALDATAID"></a>
...
public:
    ...
    */
    virtual int getSerializationTag() DAAL_C11_OVERRIDE{ return SERIALIZATION_LBFGS_RESULT_ID; }
