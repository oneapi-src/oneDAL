...
enum Method
{
    ...
    deterministicCSR   = 4, /*!< Uses first nClusters points as initial clusters for data in a CSR numeric table */
    randomCSR          = 5, /*!< Uses random nClusters points as initial clusters for data in a CSR numeric table */
