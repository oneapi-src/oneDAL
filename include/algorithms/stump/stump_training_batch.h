...
public:
     ...
     */
    Batch(const Batch<algorithmFPType, method> &other) : weak_learner::training::Batch(other), parameter(other.parameter)
    {
        initialize();
    }
    ...
    */
     ...
     */
    services::Status setResult(training::ResultPtr res)
    {
...
protected:
    ...
    {
        training::ResultPtr res = services::staticPointerCast<training::Result, classifier::training::Result>(_result);
    ...
    void initialize()
    {
        ...
        _par = &parameter;
        _result = stump::training::ResultPtr(new stump::training::Result());
    }
};
/** @} */
} // namespace interface1
