...
protected:
    ...
    void initialize()
    {
        ...
        _in = &input;
        _par = &parameter;
        _partialResult = DistributedPartialResultStep1Ptr(new DistributedPartialResultStep1());
    }
};
...
protected:
    ...
    void initialize()
    {
        ...
        _in = &input;
        _par = &parameter;
        _partialResult = DistributedPartialResultStep2Ptr(new DistributedPartialResultStep2());
    }
};
...
protected:
    ...
    void initialize()
    {
        ...
        _in = &input;
        _par = &parameter;
        _partialResult = DistributedPartialResultStep3Ptr(new DistributedPartialResultStep3());
    }
};
...
protected:
    ...
    void initialize()
    {
        ...
        _in = &input;
        _par = &parameter;
        _partialResult = DistributedPartialResultStep4Ptr(new DistributedPartialResultStep4());
    }
};
/** @} */
} // namespace interface1
