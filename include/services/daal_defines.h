...
const size_t DAAL_MALLOC_DEFAULT_ALIGNMENT = 8;
...
const int SERIALIZATION_GBT_REGRESSION_TRAINING_DISTRIBUTED_PARTIAL_RESULT_STEP1_ID = 107141;
const int SERIALIZATION_GBT_REGRESSION_TRAINING_DISTRIBUTED_PARTIAL_RESULT_STEP2_ID = 107142;
const int SERIALIZATION_GBT_REGRESSION_TRAINING_DISTRIBUTED_PARTIAL_RESULT_STEP3_ID = 107143;
const int SERIALIZATION_GBT_REGRESSION_TRAINING_DISTRIBUTED_PARTIAL_RESULT_STEP4_ID = 107144;
const int SERIALIZATION_GBT_REGRESSION_TRAINING_DISTRIBUTED_PARTIAL_RESULT_STEP5_ID = 107145;
const int SERIALIZATION_GBT_REGRESSION_TRAINING_DISTRIBUTED_PARTIAL_RESULT_STEP6_ID = 107146;
const int SERIALIZATION_GBT_REGRESSION_PREDICTION_RESULT_ID                         = 107150;
const int SERIALIZATION_GBT_DECISION_TREE_ID                                        = 107160;
const int SERIALIZATION_GBT_REGRESSION_TRAINING_INIT_PARTIAL_RESULT_STEP1_ID        = 107180;
const int SERIALIZATION_GBT_REGRESSION_TRAINING_INIT_PARTIAL_RESULT_STEP2_ID        = 107181;
const int SERIALIZATION_GBT_REGRESSION_TRAINING_INIT_PARTIAL_RESULT_STEP3_ID        = 107182;
