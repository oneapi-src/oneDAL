...
set_daal_env() {
    ...
    case $__daal_tmp_target_arch in
        ia32|intel64)
            ...
            if [ -z "$TBBROOT" ]; then
                export LIBRARY_PATH=$__daal_tmp_dir/lib/${__daal_tmp_target_arch}_lin:$__daal_tmp_dir/../tbb/lib/${__daal_tmp_target_arch}_lin/gcc4.4:$__daal_tmp_dir/../tbb/lib/${__daal_tmp_target_arch}_lin/gcc4.8${LIBRARY_PATH+:${LIBRARY_PATH}}
                export LD_LIBRARY_PATH=$__daal_tmp_dir/lib/${__daal_tmp_target_arch}_lin:$__daal_tmp_dir/../tbb/lib/${__daal_tmp_target_arch}_lin/gcc4.4:$__daal_tmp_dir/../tbb/lib/${__daal_tmp_target_arch}_lin/gcc4.8${LD_LIBRARY_PATH+:${LD_LIBRARY_PATH}}
            else
