...
if ( ${?LIBRARY_PATH} ) then
    if ( ${?TBBROOT} ) then
        ...
        setenv LIBRARY_PATH "${DAALROOT}/lib/${__daal_tmp_target_arch}_lin:${DAALROOT}/../tbb/lib/${__daal_tmp_target_arch}_lin/gcc4.4:${DAALROOT}/../tbb/lib/${__daal_tmp_target_arch}_lin/gcc4.8:${LIBRARY_PATH}"
    endif
else
    if ( ${?TBBROOT} ) then
        setenv LIBRARY_PATH "${DAALROOT}/lib/${__daal_tmp_target_arch}_lin"
    else
        setenv LIBRARY_PATH "${DAALROOT}/lib/${__daal_tmp_target_arch}_lin:${DAALROOT}/../tbb/lib/${__daal_tmp_target_arch}_lin/gcc4.4:${DAALROOT}/../tbb/lib/${__daal_tmp_target_arch}_lin/gcc4.8"
    endif
endif
...
if ( ${?LD_LIBRARY_PATH} ) then
    if ( ${?TBBROOT} ) then
        ...
        setenv LD_LIBRARY_PATH "${DAALROOT}/lib/${__daal_tmp_target_arch}_lin:${DAALROOT}/../tbb/lib/${__daal_tmp_target_arch}_lin/gcc4.4:${DAALROOT}/../tbb/lib/${__daal_tmp_target_arch}_lin/gcc4.8:${LD_LIBRARY_PATH}"
    endif
else
    if ( ${?TBBROOT} ) then
        setenv LD_LIBRARY_PATH "${DAALROOT}/lib/${__daal_tmp_target_arch}_lin"
    else
        setenv LD_LIBRARY_PATH "${DAALROOT}/lib/${__daal_tmp_target_arch}_lin:${DAALROOT}/../tbb/lib/${__daal_tmp_target_arch}_lin/gcc4.4:${DAALROOT}/../tbb/lib/${__daal_tmp_target_arch}_lin/gcc4.8"
    endif
endif
