...
JNIEXPORT jlong JNICALL Java_com_intel_daal_algorithms_brownboost_Model_cGetNumberOfWeakLearners
(JNIEnv *, jobject, jlong self)
{
    return (jlong)( unpackModel<brownboost::Model>(self)->getNumberOfWeakLearners() );
}

JNIEXPORT jlong JNICALL Java_com_intel_daal_algorithms_brownboost_Model_cGetWeakLearnerModel
(JNIEnv *, jobject, jlong self, jlong idx)
{
    return packModel( unpackModel<brownboost::Model>(self)->getWeakLearnerModel((size_t)idx) );
}

JNIEXPORT void JNICALL Java_com_intel_daal_algorithms_brownboost_Model_cAddWeakLearnerModel
...
JNIEXPORT void JNICALL Java_com_intel_daal_algorithms_brownboost_Model_cClearWeakLearnerModels
(JNIEnv *, jobject, jlong self)
{
    unpackModel<brownboost::Model>(self)->clearWeakLearnerModels();
}

JNIEXPORT jlong JNICALL Java_com_intel_daal_algorithms_brownboost_Model_cGetNumberOfFeatures
(JNIEnv *, jobject, jlong self)
{
