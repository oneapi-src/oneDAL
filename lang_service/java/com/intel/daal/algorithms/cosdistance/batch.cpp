...
#include "daal.h"
#include "com_intel_daal_algorithms_cosdistance_Batch.h"
 ...
 * Signature:(II)J
 */
JNIEXPORT jlong JNICALL Java_com_intel_daal_algorithms_cosdistance_Batch_cInit(JNIEnv * env, jobject thisObj, jint prec, jint method)
{
 ...
 * Signature:(JII)J
 */
JNIEXPORT jlong JNICALL Java_com_intel_daal_algorithms_cosdistance_Batch_cGetResult(JNIEnv * env, jobject thisObj, jlong algAddr, jint prec,
                                                                                    jint method)
{
 ...
 * Signature:(JIIJ)V
 */
JNIEXPORT void JNICALL Java_com_intel_daal_algorithms_cosdistance_Batch_cSetResult(JNIEnv * env, jobject thisObj, jlong algAddr, jint prec,
 ...
 * Signature:(JII)J
 */
JNIEXPORT jlong JNICALL Java_com_intel_daal_algorithms_cosdistance_Batch_cClone(JNIEnv * env, jobject thisObj, jlong algAddr, jint prec, jint method)
{
