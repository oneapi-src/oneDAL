...
JNIEXPORT jlong JNICALL Java_com_intel_daal_algorithms_cosdistance_Result_cNewResult(JNIEnv * env, jobject thisObj)
{
 ...
 * Signature:(J)J
 */
JNIEXPORT jlong JNICALL Java_com_intel_daal_algorithms_cosdistance_Result_cGetResultTable(JNIEnv * env, jobject thisObj, jlong resAddr, jint id)
{
    return jniArgument<cosine_distance::Result>::get<cosine_distance::ResultId, NumericTable>(resAddr, id);
}

JNIEXPORT void JNICALL Java_com_intel_daal_algorithms_cosdistance_Result_cSetResultTable(JNIEnv * env, jobject thisObj, jlong resAddr, jint id,
                                                                                         jlong ntAddr)
{
