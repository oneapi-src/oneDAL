...
{
    return jniDistributed<step2Local, gbtrt::Method, gbtrt::Distributed, gbtrt::defaultDense>::newObj(prec, method);
}
...
{
    return jniDistributed<step2Local, gbtrt::Method, gbtrt::Distributed, gbtrt::defaultDense>::getBaseParameter(prec, method, algAddr);
}

JNIEXPORT jlong JNICALL Java_com_intel_daal_algorithms_gbt_regression_training_DistributedStep2Local_cGetInput
(JNIEnv *env, jobject thisObj, jlong algAddr, jint prec, jint method)
{
    return jniDistributed<step2Local, gbtrt::Method, gbtrt::Distributed, gbtrt::defaultDense>::getInput(prec, method, algAddr);
}

JNIEXPORT jlong JNICALL Java_com_intel_daal_algorithms_gbt_regression_training_DistributedStep2Local_cGetPartialResult
(JNIEnv *env, jobject thisObj, jlong algAddr, jint prec, jint method)
{
    return jniDistributed<step2Local, gbtrt::Method, gbtrt::Distributed, gbtrt::defaultDense>::getPartialResult(prec, method, algAddr);
}
...
{
    jniDistributed<step2Local, gbtrt::Method, gbtrt::Distributed, gbtrt::defaultDense>::
        setPartialResult<gbtrt::DistributedPartialResultStep2>(prec, method, algAddr, partialResultAddr);
}

JNIEXPORT jlong JNICALL Java_com_intel_daal_algorithms_gbt_regression_training_DistributedStep2Local_cClone
(JNIEnv *env, jobject thisObj, jlong algAddr, jint prec, jint method)
{
    return jniDistributed<step2Local, gbtrt::Method, gbtrt::Distributed, gbtrt::defaultDense>::getClone(prec, method, algAddr);
}
