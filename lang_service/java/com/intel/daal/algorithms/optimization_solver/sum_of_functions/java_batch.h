...
public:
    ...
    JavaBatch(const JavaBatch & other) : sum_of_functions::Batch(other.sumOfFunctionsParameter->numberOfTerms, 0, 0)
    {
...
protected:
    ...
    virtual JavaBatch * cloneImpl() const DAAL_C11_OVERRIDE { return new JavaBatch(*this); }
};
