...
#include <jni.h>
#include "com_intel_daal_algorithms_neural_networks_prediction_PredictionResult.h"

#include "daal.h"

#include "lang_service/java/com/intel/daal/include/common_helpers.h"

#include "com_intel_daal_algorithms_neural_networks_prediction_PredictionResultId.h"
#define predictionId com_intel_daal_algorithms_neural_networks_prediction_PredictionResultId_predictionId
#include "com_intel_daal_algorithms_neural_networks_prediction_PredictionResultCollectionId.h"
 ...
 * Signature: (JI)J
 */
JNIEXPORT jlong JNICALL Java_com_intel_daal_algorithms_neural_1networks_prediction_PredictionResult_cGetValue(JNIEnv * env, jobject thisObj,
 ...
 * Signature: (JIJ)V
 */
JNIEXPORT void JNICALL Java_com_intel_daal_algorithms_neural_1networks_prediction_PredictionResult_cSetValue(JNIEnv * env, jobject thisObj,
 ...
 * Signature: (JIIJ)V
 */
JNIEXPORT void JNICALL Java_com_intel_daal_algorithms_neural_1networks_prediction_PredictionResult_cAddTensor(JNIEnv * env, jobject thisObj,
                                                                                                              jlong resAddr, jint id, jint key,
                                                                                                              jlong ntAddr)
{
    if (id == predictionCollectionId)
    {
        SerializationIfacePtr * collectionShPtr =
            (SerializationIfacePtr *)(jniArgument<prediction::Result>::get<prediction::ResultCollectionId, KeyValueDataCollection>(resAddr, id));
 ...
 * Signature: (JII)J
 */
JNIEXPORT jlong JNICALL Java_com_intel_daal_algorithms_neural_1networks_prediction_PredictionResult_cGetTensor(JNIEnv * env, jobject thisObj,
                                                                                                               jlong resAddr, jint id, jint key)
{
    if (id == predictionCollectionId)
    {
