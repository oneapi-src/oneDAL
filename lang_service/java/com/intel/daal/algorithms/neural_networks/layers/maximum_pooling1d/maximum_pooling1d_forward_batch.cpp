...
#include <jni.h>
#include "com_intel_daal_algorithms_neural_networks_layers_maximum_pooling1d_MaximumPooling1dForwardBatch.h"
...
{
    return jniBatch<maximum_pooling1d::Method, maximum_pooling1d::forward::Batch, maximum_pooling1d::defaultDense>::newObj(prec, method, nDim);
}
...
{
    return jniBatch<maximum_pooling1d::Method, maximum_pooling1d::forward::Batch, maximum_pooling1d::defaultDense>::getParameter(prec, method,
                                                                                                                                 algAddr);
}
...
JNIEXPORT jlong JNICALL Java_com_intel_daal_algorithms_neural_1networks_layers_maximum_1pooling1d_MaximumPooling1dForwardBatch_cGetInput(
    JNIEnv * env, jobject thisObj, jlong algAddr, jint prec, jint method)
{
    return jniBatch<maximum_pooling1d::Method, maximum_pooling1d::forward::Batch, maximum_pooling1d::defaultDense>::getInput(prec, method, algAddr);
}
...
JNIEXPORT jlong JNICALL Java_com_intel_daal_algorithms_neural_1networks_layers_maximum_1pooling1d_MaximumPooling1dForwardBatch_cGetResult(
    JNIEnv * env, jobject thisObj, jlong algAddr, jint prec, jint method)
{
    return jniBatch<maximum_pooling1d::Method, maximum_pooling1d::forward::Batch, maximum_pooling1d::defaultDense>::getResult(prec, method, algAddr);
}
...
{
    jniBatch<maximum_pooling1d::Method, maximum_pooling1d::forward::Batch,
             maximum_pooling1d::defaultDense>::setResult<maximum_pooling1d::forward::Result>(prec, method, algAddr, resAddr);
}
...
JNIEXPORT jlong JNICALL Java_com_intel_daal_algorithms_neural_1networks_layers_maximum_1pooling1d_MaximumPooling1dForwardBatch_cClone(
    JNIEnv * env, jobject thisObj, jlong algAddr, jint prec, jint method)
{
    return jniBatch<maximum_pooling1d::Method, maximum_pooling1d::forward::Batch, maximum_pooling1d::defaultDense>::getClone(prec, method, algAddr);
}
