...
#include <jni.h>
#include "com_intel_daal_algorithms_neural_networks_layers_batch_normalization_BatchNormalizationBackwardBatch.h"
...
{
    return jniBatch<batch_normalization::Method, batch_normalization::backward::Batch, batch_normalization::defaultDense>::newObj(prec, method);
}
...
{
    return jniBatch<batch_normalization::Method, batch_normalization::backward::Batch, batch_normalization::defaultDense>::getInput(prec, method,
                                                                                                                                    algAddr);
}
...
JNIEXPORT jlong JNICALL Java_com_intel_daal_algorithms_neural_1networks_layers_batch_1normalization_BatchNormalizationBackwardBatch_cInitParameter(
    JNIEnv * env, jobject thisObj, jlong algAddr, jint prec, jint method)
{
    return jniBatch<batch_normalization::Method, batch_normalization::backward::Batch, batch_normalization::defaultDense>::getParameter(prec, method,
                                                                                                                                        algAddr);
}
...
JNIEXPORT jlong JNICALL Java_com_intel_daal_algorithms_neural_1networks_layers_batch_1normalization_BatchNormalizationBackwardBatch_cGetResult(
    JNIEnv * env, jobject thisObj, jlong algAddr, jint prec, jint method)
{
    return jniBatch<batch_normalization::Method, batch_normalization::backward::Batch, batch_normalization::defaultDense>::getResult(prec, method,
                                                                                                                                     algAddr);
}
...
{
    jniBatch<batch_normalization::Method, batch_normalization::backward::Batch,
             batch_normalization::defaultDense>::setResult<batch_normalization::backward::Result>(prec, method, algAddr, resAddr);
}
...
JNIEXPORT jlong JNICALL Java_com_intel_daal_algorithms_neural_1networks_layers_batch_1normalization_BatchNormalizationBackwardBatch_cClone(
    JNIEnv * env, jobject thisObj, jlong algAddr, jint prec, jint method)
{
    return jniBatch<batch_normalization::Method, batch_normalization::backward::Batch, batch_normalization::defaultDense>::getClone(prec, method,
                                                                                                                                    algAddr);
}
