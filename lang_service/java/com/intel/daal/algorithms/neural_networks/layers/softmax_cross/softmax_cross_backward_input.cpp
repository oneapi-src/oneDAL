...
#include <jni.h>
#include "com_intel_daal_algorithms_neural_networks_layers_softmax_cross_SoftmaxCrossBackwardInput.h"
 ...
 * Signature: (JI)J
 */
JNIEXPORT jlong JNICALL Java_com_intel_daal_algorithms_neural_1networks_layers_softmax_1cross_SoftmaxCrossBackwardInput_cGetInput(JNIEnv * env,
                                                                                                                                  jobject thisObj,
                                                                                                                                  jlong inputAddr,
                                                                                                                                  jint id)
{
