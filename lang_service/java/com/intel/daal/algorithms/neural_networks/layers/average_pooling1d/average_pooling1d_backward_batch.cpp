...
#include <jni.h>
#include "com_intel_daal_algorithms_neural_networks_layers_average_pooling1d_AveragePooling1dBackwardBatch.h"
...
{
    return jniBatch<average_pooling1d::Method, average_pooling1d::backward::Batch, average_pooling1d::defaultDense>::newObj(prec, method, nDim);
}
...
{
    return jniBatch<average_pooling1d::Method, average_pooling1d::backward::Batch, average_pooling1d::defaultDense>::getInput(prec, method, algAddr);
}
...
JNIEXPORT jlong JNICALL Java_com_intel_daal_algorithms_neural_1networks_layers_average_1pooling1d_AveragePooling1dBackwardBatch_cInitParameter(
    JNIEnv * env, jobject thisObj, jlong algAddr, jint prec, jint method)
{
    return jniBatch<average_pooling1d::Method, average_pooling1d::backward::Batch, average_pooling1d::defaultDense>::getParameter(prec, method,
                                                                                                                                  algAddr);
}
...
JNIEXPORT jlong JNICALL Java_com_intel_daal_algorithms_neural_1networks_layers_average_1pooling1d_AveragePooling1dBackwardBatch_cGetResult(
    JNIEnv * env, jobject thisObj, jlong algAddr, jint prec, jint method)
{
    return jniBatch<average_pooling1d::Method, average_pooling1d::backward::Batch, average_pooling1d::defaultDense>::getResult(prec, method, algAddr);
}
...
{
    jniBatch<average_pooling1d::Method, average_pooling1d::backward::Batch,
             average_pooling1d::defaultDense>::setResult<average_pooling1d::backward::Result>(prec, method, algAddr, resAddr);
}
...
JNIEXPORT jlong JNICALL Java_com_intel_daal_algorithms_neural_1networks_layers_average_1pooling1d_AveragePooling1dBackwardBatch_cClone(
    JNIEnv * env, jobject thisObj, jlong algAddr, jint prec, jint method)
{
    return jniBatch<average_pooling1d::Method, average_pooling1d::backward::Batch, average_pooling1d::defaultDense>::getClone(prec, method, algAddr);
}
