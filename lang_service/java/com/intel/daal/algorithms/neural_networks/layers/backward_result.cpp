...
#include <jni.h>
#include "com_intel_daal_algorithms_neural_networks_layers_BackwardResult.h"

#include "daal.h"

#include "lang_service/java/com/intel/daal/include/common_helpers.h"

#include "com_intel_daal_algorithms_neural_networks_layers_BackwardResultId.h"
 ...
 * Signature: (JI)J
 */
JNIEXPORT jlong JNICALL Java_com_intel_daal_algorithms_neural_1networks_layers_BackwardResult_cGetValue(JNIEnv * env, jobject thisObj, jlong resAddr,
                                                                                                        jint id)
{
 ...
 * Signature: (JIJ)V
 */
JNIEXPORT void JNICALL Java_com_intel_daal_algorithms_neural_1networks_layers_BackwardResult_cSetValue(JNIEnv * env, jobject thisObj, jlong resAddr,
