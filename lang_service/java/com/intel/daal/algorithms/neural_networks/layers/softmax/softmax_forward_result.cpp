...
#include <jni.h>
#include "com_intel_daal_algorithms_neural_networks_layers_softmax_SoftmaxForwardResult.h"
 ...
 * Signature: ()J
 */
JNIEXPORT jlong JNICALL Java_com_intel_daal_algorithms_neural_1networks_layers_softmax_SoftmaxForwardResult_cNewResult(JNIEnv * env, jobject thisObj)
{
 ...
 * Signature: (JI)J
 */
JNIEXPORT jlong JNICALL Java_com_intel_daal_algorithms_neural_1networks_layers_softmax_SoftmaxForwardResult_cGetValue(JNIEnv * env, jobject thisObj,
 ...
 * Signature: (JIJ)V
 */
JNIEXPORT void JNICALL Java_com_intel_daal_algorithms_neural_1networks_layers_softmax_SoftmaxForwardResult_cSetValue(JNIEnv * env, jobject thisObj,
                                                                                                                     jlong resAddr, jint id,
                                                                                                                     jlong ntAddr)
{
    if (id == auxValueId)
