...
#include <jni.h>
#include "com_intel_daal_algorithms_neural_networks_layers_pooling3d_Pooling3dParameter.h"
 ...
 * Signature: (JD)V
 */
JNIEXPORT void JNICALL Java_com_intel_daal_algorithms_neural_1networks_layers_pooling3d_Pooling3dParameter_cSetStrides(JNIEnv * env, jobject thisObj,
                                                                                                                       jlong cParameter, jlong first,
                                                                                                                       jlong second, jlong third)
{
 ...
 * Signature: (JD)V
 */
JNIEXPORT void JNICALL Java_com_intel_daal_algorithms_neural_1networks_layers_pooling3d_Pooling3dParameter_cSetSD(JNIEnv * env, jobject thisObj,
                                                                                                                  jlong cParameter, jlong first,
                                                                                                                  jlong second, jlong third)
{
 ...
 * Signature: (JD)V
 */
JNIEXPORT void JNICALL Java_com_intel_daal_algorithms_neural_1networks_layers_pooling3d_Pooling3dParameter_cSetPaddings(JNIEnv * env, jobject thisObj,
                                                                                                                        jlong cParameter, jlong first,
                                                                                                                        jlong second, jlong third)
{
 ...
 * Signature: (J)J
 */
JNIEXPORT jlongArray JNICALL Java_com_intel_daal_algorithms_neural_1networks_layers_pooling3d_Pooling3dParameter_cGetKernelSizes(JNIEnv * env,
                                                                                                                                 jobject thisObj,
                                                                                                                                 jlong cParameter)
{
 ...
 * Signature: (J)J
 */
JNIEXPORT jlongArray JNICALL Java_com_intel_daal_algorithms_neural_1networks_layers_pooling3d_Pooling3dParameter_cGetStrides(JNIEnv * env,
                                                                                                                             jobject thisObj,
                                                                                                                             jlong cParameter)
{
    jlongArray sizeArray;
 ...
 * Signature: (J)J
 */
JNIEXPORT jlongArray JNICALL Java_com_intel_daal_algorithms_neural_1networks_layers_pooling3d_Pooling3dParameter_cGetPaddings(JNIEnv * env,
                                                                                                                              jobject thisObj,
                                                                                                                              jlong cParameter)
{
    jlongArray sizeArray;
 ...
 * Signature: (J)J
 */
JNIEXPORT jlongArray JNICALL Java_com_intel_daal_algorithms_neural_1networks_layers_pooling3d_Pooling3dParameter_cGetSD(JNIEnv * env, jobject thisObj,
                                                                                                                        jlong cParameter)
{
    jlongArray sizeArray;
    sizeArray = env->NewLongArray(3);
