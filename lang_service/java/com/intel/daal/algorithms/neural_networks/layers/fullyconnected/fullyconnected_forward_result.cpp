...
#include <jni.h>
#include "com_intel_daal_algorithms_neural_networks_layers_fullyconnected_FullyConnectedForwardResult.h"
 ...
 * Signature: ()J
 */
JNIEXPORT jlong JNICALL Java_com_intel_daal_algorithms_neural_1networks_layers_fullyconnected_FullyConnectedForwardResult_cNewResult(JNIEnv * env,
                                                                                                                                     jobject thisObj)
{
 ...
 * Signature: (JI)J
 */
JNIEXPORT jlong JNICALL Java_com_intel_daal_algorithms_neural_1networks_layers_fullyconnected_FullyConnectedForwardResult_cGetValue(JNIEnv * env,
                                                                                                                                    jobject thisObj,
                                                                                                                                    jlong resAddr,
                                                                                                                                    jint id)
{
