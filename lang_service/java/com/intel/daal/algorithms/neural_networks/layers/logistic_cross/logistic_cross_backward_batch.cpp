...
#include <jni.h>
#include "com_intel_daal_algorithms_neural_networks_layers_logistic_cross_LogisticCrossBackwardBatch.h"
 ...
 * Signature: (II)J
 */
JNIEXPORT jlong JNICALL Java_com_intel_daal_algorithms_neural_1networks_layers_logistic_1cross_LogisticCrossBackwardBatch_cInit(JNIEnv * env,
                                                                                                                                jobject thisObj,
                                                                                                                                jint prec,
                                                                                                                                jint method)
{
...
{
    return jniBatch<logistic_cross::Method, logistic_cross::backward::Batch, logistic_cross::defaultDense>::getParameter(prec, method, algAddr);
}
...
{
    jniBatch<logistic_cross::Method, logistic_cross::backward::Batch, logistic_cross::defaultDense>::setResult<logistic_cross::backward::Result>(
