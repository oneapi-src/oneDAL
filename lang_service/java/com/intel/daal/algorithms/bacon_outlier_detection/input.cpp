...
#include "daal.h"
#include "com_intel_daal_algorithms_bacon_outlier_detection_Input.h"
 ...
 * Signature: (JIJ)V
 */
JNIEXPORT void JNICALL Java_com_intel_daal_algorithms_bacon_1outlier_1detection_Input_cSetInput(JNIEnv * env, jobject thisObj, jlong inputAddr,
 ...
 * Signature: (JI)J
 */
JNIEXPORT jlong JNICALL Java_com_intel_daal_algorithms_bacon_1outlier_1detection_Input_cGetInputTable(JNIEnv * env, jobject thisObj, jlong inputAddr,
                                                                                                      jint id)
{
