...
public:
    ...
    virtual services::Status setResult(const services::SharedPtr<Result> &result) DAAL_C11_OVERRIDE
    {
        _result = result;
    ...
    virtual services::Status setPartialResult(const services::SharedPtr<PartialResult> &partialResult, bool _initFlag = false) DAAL_C11_OVERRIDE
    {
