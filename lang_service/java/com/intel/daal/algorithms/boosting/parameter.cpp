...
{
    services::SharedPtr<weak_learner::training::Batch> *shPtr = new services::SharedPtr<weak_learner::training::Batch>();
    *shPtr = *(services::SharedPtr<weak_learner::training::Batch> *)algAddr;
    (*(boosting::Parameter *)parAddr).weakLearnerTraining = *shPtr;
}
...
(JNIEnv *env, jobject thisObj, jlong parAddr, jlong algAddr)
{
    services::SharedPtr<weak_learner::prediction::Batch> *shPtr = new services::SharedPtr<weak_learner::prediction::Batch>();
    *shPtr = *(services::SharedPtr<weak_learner::prediction::Batch> *)algAddr;
    (*(boosting::Parameter *)parAddr).weakLearnerPrediction = *shPtr;
}
