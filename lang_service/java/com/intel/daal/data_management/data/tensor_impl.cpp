...
#include "com_intel_daal_data_management_data_TensorImpl.h"
#include "daal.h"
 ...
 * Signature: (J)V
 */
JNIEXPORT void JNICALL Java_com_intel_daal_data_1management_data_TensorImpl_cAllocateDataMemory(JNIEnv * env, jobject thisObject, jlong cObject)
{
 ...
 * Signature: (J)V
 */
JNIEXPORT void JNICALL Java_com_intel_daal_data_1management_data_TensorImpl_cFreeDataMemory(JNIEnv * env, jobject thisObject, jlong cObject)
{
    Tensor * tensor = static_cast<Tensor *>(((SerializationIfacePtr *)cObject)->get());
 ...
 * Signature: (J)[J
 */
JNIEXPORT jlongArray JNICALL Java_com_intel_daal_data_1management_data_TensorImpl_cGetDimensions(JNIEnv * env, jobject thisObject, jlong cObject)
{
    Tensor * tensor = static_cast<Tensor *>(((SerializationIfacePtr *)cObject)->get());
 ...
 * Signature: (J[J)V
 */
JNIEXPORT void JNICALL Java_com_intel_daal_data_1management_data_TensorImpl_cSetDimensions(JNIEnv * env, jobject thisObject, jlong cObject,
                                                                                           jlongArray jDims)
{
    Tensor * tensor = static_cast<Tensor *>(((SerializationIfacePtr *)cObject)->get());
 ...
 * Signature: ([JI)J
 */
JNIEXPORT jlong JNICALL Java_com_intel_daal_data_1management_data_TensorImpl_cNewJavaTensor(JNIEnv * env, jobject thisObj, jlongArray jDims, jint tag)
{
    JavaVM * jvm;
    ...
    switch (tag)
    {
    case SERIALIZATION_JAVANIO_HOMOGEN_TENSOR_ID: tnsr = new daal::JavaTensor<SERIALIZATION_JAVANIO_HOMOGEN_TENSOR_ID>(dims, jvm, thisObj); break;
    default: break;
    }
