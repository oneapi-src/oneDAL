...
mkdir inteldal.redist.linux-x64.%VER%
mkdir inteldal.redist.linux-x64.%VER%\runtimes
mkdir inteldal.redist.linux-x64.%VER%\runtimes\linux-x64
mkdir inteldal.redist.linux-x64.%VER%\runtimes\linux-x64\native

xcopy /S /Y /Q __release_lnx\daal\latest\include inteldal.devel.linux-x64.%VER%\lib\native\include\
...
xcopy /S /Y /Q __release_lnx\daal\latest\lib\intel64\libonedal*.so  inteldal.redist.linux-x64.%VER%\runtimes\linux-x64\native\

xcopy /Y /Q LICENSE inteldal.devel.linux-x64.%VER%\
xcopy /Y /Q LICENSE inteldal.redist.linux-x64.%VER%\
xcopy /Y /Q LICENSE inteldal.static.linux-x64.%VER%\

xcopy /Y /Q deploy\nuget\inteldal.devel.linux-x64.nuspec  inteldal.devel.linux-x64.%VER%\ 
xcopy /Y /Q deploy\nuget\inteldal.redist.linux-x64.nuspec inteldal.redist.linux-x64.%VER%\
