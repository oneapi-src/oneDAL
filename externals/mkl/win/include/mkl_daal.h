...
void fpk_blas_sse2_daxpy(const MKL_INT *n, const double *alpha, const double *x,
    const MKL_INT *incx, double *y, const MKL_INT *incy);
void fpk_blas_sse2_dcopy(const MKL_INT *n, const double *x, const MKL_INT *incx,
    double *y, const MKL_INT *incy);
double fpk_blas_sse2_ddot(const MKL_INT *n, const double *x, const MKL_INT *incx,
...
void fpk_blas_sse2_dgemmt(const char *uplo, const char *transa,
    ...
    const double *a, const MKL_INT *lda, const double *b, const MKL_INT *ldb,
    const double *beta, double *c, const MKL_INT *ldc);
void fpk_blas_sse2_dgemv(const char *trans, const MKL_INT *m, const MKL_INT *n,
...
void fpk_blas_sse2_dsymm(const char *side, const char *uplo, const MKL_INT *m,
    ...
    const MKL_INT *ldc);
void fpk_blas_sse2_dsyr(const char *uplo, const MKL_INT *n, const double *alpha,
    const double *x, const MKL_INT *incx, double *a, const MKL_INT *lda);
void fpk_blas_sse2_dsyrk(const char *uplo, const char *trans, const MKL_INT *n,
...
void fpk_blas_sse2_saxpy(const MKL_INT *n, const float *alpha, const float *x,
    const MKL_INT *incx, float *y, const MKL_INT *incy);
void fpk_blas_sse2_scopy(const MKL_INT *n, const float *x, const MKL_INT *incx,
    float *y, const MKL_INT *incy);
float fpk_blas_sse2_sdot(const MKL_INT *n, const float *x, const MKL_INT *incx,
...
void fpk_blas_sse2_sgemmt(const char *uplo, const char *transa,
    ...
    const float *a, const MKL_INT *lda, const float *b, const MKL_INT *ldb,
    const float *beta, float *c, const MKL_INT *ldc);
void fpk_blas_sse2_sgemv(const char *trans, const MKL_INT *m, const MKL_INT *n,
...
void fpk_blas_sse2_ssymm(const char *side, const char *uplo, const MKL_INT *m,
    ...
    const MKL_INT *ldc);
void fpk_blas_sse2_ssyr(const char *uplo, const MKL_INT *n, const float *alpha,
    const float *x, const MKL_INT *incx, float *a, const MKL_INT *lda);
void fpk_blas_sse2_ssyrk(const char *uplo, const char *trans, const MKL_INT *n,
...
void fpk_blas_sse2_xdaxpy(const MKL_INT *n, const double *alpha, const double *x,
    const MKL_INT *incx, double *y, const MKL_INT *incy);
void fpk_blas_sse2_xdcopy(const MKL_INT *n, const double *x, const MKL_INT *incx,
    double *y, const MKL_INT *incy);
double fpk_blas_sse2_xddot(const MKL_INT *n, const double *x,
...
void fpk_blas_sse2_xdgemmt(const char *uplo, const char *transa,
    ...
    const double *a, const MKL_INT *lda, const double *b, const MKL_INT *ldb,
    const double *beta, double *c, const MKL_INT *ldc);
void fpk_blas_sse2_xdgemv(const char *trans, const MKL_INT *m, const MKL_INT *n,
    const double *alpha, const double *a, const MKL_INT *lda, const double *x,
    const MKL_INT *incx, const double *beta, double *y, const MKL_INT *incy);
void fpk_blas_sse2_xdsymm(const char *side, const char *uplo, const MKL_INT *m,
    const MKL_INT *n, const double *alpha, const double *a, const MKL_INT *lda,
    const double *b, const MKL_INT *ldb, const double *beta, double *c,
    const MKL_INT *ldc);
void fpk_blas_sse2_xdsyr(const char *uplo, const MKL_INT *n, const double *alpha,
    const double *x, const MKL_INT *incx, double *a, const MKL_INT *lda);
void fpk_blas_sse2_xdsyrk(const char *uplo, const char *trans, const MKL_INT *n,
    const MKL_INT *k, const double *alpha, const double *a, const MKL_INT *lda,
    const double *beta, double *c, const MKL_INT *ldc);
void fpk_blas_sse2_xdtrmm(const char *side, const char *uplo, const char *transa,
    const char *diag, const MKL_INT *m, const MKL_INT *n, const double *alpha,
    const double *a, const MKL_INT *lda, double *b, const MKL_INT *ldb);
void fpk_blas_sse2_xsaxpy(const MKL_INT *n, const float *alpha, const float *x,
    const MKL_INT *incx, float *y, const MKL_INT *incy);
void fpk_blas_sse2_xscopy(const MKL_INT *n, const float *x, const MKL_INT *incx,
    float *y, const MKL_INT *incy);
float fpk_blas_sse2_xsdot(const MKL_INT *n, const float *x, const MKL_INT *incx,
    const float *y, const MKL_INT *incy);
...
void fpk_blas_sse2_xsgemmt(const char *uplo, const char *transa,
    ...
    const float *a, const MKL_INT *lda, const float *b, const MKL_INT *ldb,
    const float *beta, float *c, const MKL_INT *ldc);
void fpk_blas_sse2_xsgemv(const char *trans, const MKL_INT *m, const MKL_INT *n,
    const float *alpha, const float *a, const MKL_INT *lda, const float *x,
    const MKL_INT *incx, const float *beta, float *y, const MKL_INT *incy);
void fpk_blas_sse2_xssymm(const char *side, const char *uplo, const MKL_INT *m,
    const MKL_INT *n, const float *alpha, const float *a, const MKL_INT *lda,
    const float *b, const MKL_INT *ldb, const float *beta, float *c,
    const MKL_INT *ldc);
void fpk_blas_sse2_xssyr(const char *uplo, const MKL_INT *n, const float *alpha,
    const float *x, const MKL_INT *incx, float *a, const MKL_INT *lda);
void fpk_blas_sse2_xssyrk(const char *uplo, const char *trans, const MKL_INT *n,
    const MKL_INT *k, const float *alpha, const float *a, const MKL_INT *lda,
    const float *beta, float *c, const MKL_INT *ldc);
...
void fpk_blas_avx512_mic_daxpy(const MKL_INT *n, const double *alpha,
    const double *x, const MKL_INT *incx, double *y, const MKL_INT *incy);
void fpk_blas_avx512_mic_dcopy(const MKL_INT *n, const double *x,
    const MKL_INT *incx, double *y, const MKL_INT *incy);
double fpk_blas_avx512_mic_ddot(const MKL_INT *n, const double *x,
    const MKL_INT *incx, const double *y, const MKL_INT *incy);
...
void fpk_blas_avx512_mic_dgemmt(const char *uplo, const char *transa,
    ...
    const double *a, const MKL_INT *lda, const double *b, const MKL_INT *ldb,
    const double *beta, double *c, const MKL_INT *ldc);
void fpk_blas_avx512_mic_dgemv(const char *trans, const MKL_INT *m,
    const MKL_INT *n, const double *alpha, const double *a, const MKL_INT *lda,
    const double *x, const MKL_INT *incx, const double *beta, double *y,
    const MKL_INT *incy);
void fpk_blas_avx512_mic_dsymm(const char *side, const char *uplo,
    ...
    const MKL_INT *lda, const double *b, const MKL_INT *ldb, const double *beta,
    double *c, const MKL_INT *ldc);
void fpk_blas_avx512_mic_dsyr(const char *uplo, const MKL_INT *n,
    const double *alpha, const double *x, const MKL_INT *incx, double *a,
    const MKL_INT *lda);
...
void fpk_blas_avx512_mic_dtrmm(const char *side, const char *uplo,
    ...
    const double *alpha, const double *a, const MKL_INT *lda, double *b,
    const MKL_INT *ldb);
void fpk_blas_avx512_mic_saxpy(const MKL_INT *n, const float *alpha,
    const float *x, const MKL_INT *incx, float *y, const MKL_INT *incy);
void fpk_blas_avx512_mic_scopy(const MKL_INT *n, const float *x,
    const MKL_INT *incx, float *y, const MKL_INT *incy);
float fpk_blas_avx512_mic_sdot(const MKL_INT *n, const float *x,
    const MKL_INT *incx, const float *y, const MKL_INT *incy);
...
void fpk_blas_avx512_mic_sgemmt(const char *uplo, const char *transa,
    ...
    const float *a, const MKL_INT *lda, const float *b, const MKL_INT *ldb,
    const float *beta, float *c, const MKL_INT *ldc);
void fpk_blas_avx512_mic_sgemv(const char *trans, const MKL_INT *m,
    const MKL_INT *n, const float *alpha, const float *a, const MKL_INT *lda,
    const float *x, const MKL_INT *incx, const float *beta, float *y,
    const MKL_INT *incy);
void fpk_blas_avx512_mic_ssymm(const char *side, const char *uplo,
    ...
    const MKL_INT *lda, const float *b, const MKL_INT *ldb, const float *beta,
    float *c, const MKL_INT *ldc);
void fpk_blas_avx512_mic_ssyr(const char *uplo, const MKL_INT *n,
    const float *alpha, const float *x, const MKL_INT *incx, float *a,
    const MKL_INT *lda);
...
void fpk_blas_avx512_mic_strmm(const char *side, const char *uplo,
    ...
    const float *alpha, const float *a, const MKL_INT *lda, float *b,
    const MKL_INT *ldb);
void fpk_blas_avx512_mic_xdaxpy(const MKL_INT *n, const double *alpha,
    const double *x, const MKL_INT *incx, double *y, const MKL_INT *incy);
void fpk_blas_avx512_mic_xdcopy(const MKL_INT *n, const double *x,
    const MKL_INT *incx, double *y, const MKL_INT *incy);
double fpk_blas_avx512_mic_xddot(const MKL_INT *n, const double *x,
    const MKL_INT *incx, const double *y, const MKL_INT *incy);
...
void fpk_blas_avx512_mic_xdgemmt(const char *uplo, const char *transa,
    ...
    const double *a, const MKL_INT *lda, const double *b, const MKL_INT *ldb,
    const double *beta, double *c, const MKL_INT *ldc);
void fpk_blas_avx512_mic_xdgemv(const char *trans, const MKL_INT *m,
    const MKL_INT *n, const double *alpha, const double *a, const MKL_INT *lda,
    const double *x, const MKL_INT *incx, const double *beta, double *y,
    const MKL_INT *incy);
void fpk_blas_avx512_mic_xdsymm(const char *side, const char *uplo,
    ...
    const MKL_INT *lda, const double *b, const MKL_INT *ldb, const double *beta,
    double *c, const MKL_INT *ldc);
void fpk_blas_avx512_mic_xdsyr(const char *uplo, const MKL_INT *n,
    const double *alpha, const double *x, const MKL_INT *incx, double *a,
    const MKL_INT *lda);
...
void fpk_blas_avx512_mic_xdtrmm(const char *side, const char *uplo,
    ...
    const double *alpha, const double *a, const MKL_INT *lda, double *b,
    const MKL_INT *ldb);
void fpk_blas_avx512_mic_xsaxpy(const MKL_INT *n, const float *alpha,
    const float *x, const MKL_INT *incx, float *y, const MKL_INT *incy);
void fpk_blas_avx512_mic_xscopy(const MKL_INT *n, const float *x,
    const MKL_INT *incx, float *y, const MKL_INT *incy);
float fpk_blas_avx512_mic_xsdot(const MKL_INT *n, const float *x,
    const MKL_INT *incx, const float *y, const MKL_INT *incy);
...
void fpk_blas_avx512_mic_xsgemmt(const char *uplo, const char *transa,
    ...
    const float *a, const MKL_INT *lda, const float *b, const MKL_INT *ldb,
    const float *beta, float *c, const MKL_INT *ldc);
void fpk_blas_avx512_mic_xsgemv(const char *trans, const MKL_INT *m,
    const MKL_INT *n, const float *alpha, const float *a, const MKL_INT *lda,
    const float *x, const MKL_INT *incx, const float *beta, float *y,
    const MKL_INT *incy);
void fpk_blas_avx512_mic_xssymm(const char *side, const char *uplo,
    ...
    const MKL_INT *lda, const float *b, const MKL_INT *ldb, const float *beta,
    float *c, const MKL_INT *ldc);
void fpk_blas_avx512_mic_xssyr(const char *uplo, const MKL_INT *n,
    const float *alpha, const float *x, const MKL_INT *incx, float *a,
    const MKL_INT *lda);
...
void fpk_feast_sse2_cfeast_hbev(const char* uplo, const MKL_INT* n,
    ...
    MKL_INT* info);
void fpk_feast_sse2_cfeast_hbgv(const char* uplo, const MKL_INT* n,
    ...
    MKL_INT* m0, float* e, MKL_Complex8* x, MKL_INT* m, float* res,
    MKL_INT* info);
void fpk_feast_sse2_cfeast_hcsrev(const char* uplo, const MKL_INT* n,
    const MKL_Complex8* sa, const MKL_INT* isa, const MKL_INT* jsa, MKL_INT* fpm,
    float* epsout, MKL_INT* loop, const float* emin, const float* emax,
    MKL_INT* m0, float* e, MKL_Complex8* x, MKL_INT* m, float* res,
    MKL_INT* info);
void fpk_feast_sse2_cfeast_hcsrgv(const char* uplo, const MKL_INT* n,
    ...
    MKL_INT* m0, float* e, MKL_Complex8* x, MKL_INT* m, float* res,
    MKL_INT* info);
void fpk_feast_sse2_cfeast_heev(const char* uplo, const MKL_INT* n,
...
void fpk_feast_sse2_cfeast_hegv(const char* uplo, const MKL_INT* n,
...
void fpk_feast_sse2_cfeast_hrci(MKL_INT* ijob, const MKL_INT* n,
...
void fpk_feast_sse2_dfeast_sbev(const char* uplo, const MKL_INT* n,
...
void fpk_feast_sse2_dfeast_sbgv(const char* uplo, const MKL_INT* n,
...
void fpk_feast_sse2_dfeast_scsrev(const char* uplo, const MKL_INT* n,
    const double* sa, const MKL_INT* isa, const MKL_INT* jsa, MKL_INT* fpm,
    double* epsout, MKL_INT* loop, const double* emin, const double* emax,
    MKL_INT* m0, double* e, double* x, MKL_INT* m, double* res, MKL_INT* info);
void fpk_feast_sse2_dfeast_scsrgv(const char* uplo, const MKL_INT* n,
    ...
    MKL_INT* loop, const double* emin, const double* emax, MKL_INT* m0,
    double* e, double* x, MKL_INT* m, double* res, MKL_INT* info);
void fpk_feast_sse2_dfeast_srci(MKL_INT* ijob, const MKL_INT* n,
...
void fpk_feast_sse2_dfeast_syev(const char* uplo, const MKL_INT* n,
    const double* a, const MKL_INT* lda, MKL_INT* fpm, double* epsout,
    MKL_INT* loop, const double* emin, const double* emax, MKL_INT* m0,
    double* e, double* x, MKL_INT* m, double* res, MKL_INT* info);
void fpk_feast_sse2_dfeast_sygv(const char* uplo, const MKL_INT* n,
    const double* a, const MKL_INT* lda, const double* b, const MKL_INT* ldb,
    MKL_INT* fpm, double* epsout, MKL_INT* loop, const double* emin,
    const double* emax, MKL_INT* m0, double* e, double* x, MKL_INT* m,
    double* res, MKL_INT* info);
void fpk_feast_sse2_feastinit(MKL_INT* fpm);
void fpk_feast_sse2_sfeast_sbev(const char* uplo, const MKL_INT* n,
    const MKL_INT* kla, const float* a, const MKL_INT* lda, MKL_INT* fpm,
    float* epsout, MKL_INT* loop, const float* emin, const float* emax,
    MKL_INT* m0, float* e, float* x, MKL_INT* m, float* res, MKL_INT* info);
void fpk_feast_sse2_sfeast_sbgv(const char* uplo, const MKL_INT* n,
...
void fpk_feast_sse2_sfeast_scsrev(const char* uplo, const MKL_INT* n,
    const float* sa, const MKL_INT* isa, const MKL_INT* jsa, MKL_INT* fpm,
    float* epsout, MKL_INT* loop, const float* emin, const float* emax,
    MKL_INT* m0, float* e, float* x, MKL_INT* m, float* res, MKL_INT* info);
void fpk_feast_sse2_sfeast_scsrgv(const char* uplo, const MKL_INT* n,
    ...
    MKL_INT* loop, const float* emin, const float* emax, MKL_INT* m0, float* e,
    float* x, MKL_INT* m, float* res, MKL_INT* info);
void fpk_feast_sse2_sfeast_srci(MKL_INT* ijob, const MKL_INT* n,
...
void fpk_feast_sse2_sfeast_syev(const char* uplo, const MKL_INT* n,
    const float* a, const MKL_INT* lda, MKL_INT* fpm, float* epsout,
    MKL_INT* loop, const float* emin, const float* emax, MKL_INT* m0, float* e,
    float* x, MKL_INT* m, float* res, MKL_INT* info);
void fpk_feast_sse2_sfeast_sygv(const char* uplo, const MKL_INT* n,
    const float* a, const MKL_INT* lda, const float* b, const MKL_INT* ldb,
    MKL_INT* fpm, float* epsout, MKL_INT* loop, const float* emin,
    const float* emax, MKL_INT* m0, float* e, float* x, MKL_INT* m, float* res,
    MKL_INT* info);
void fpk_feast_sse2_zfeast_hbev(const char* uplo, const MKL_INT* n,
    ...
    MKL_INT* info);
void fpk_feast_sse2_zfeast_hbgv(const char* uplo, const MKL_INT* n,
    ...
    MKL_INT* m0, double* e, MKL_Complex16* x, MKL_INT* m, double* res,
    MKL_INT* info);
void fpk_feast_sse2_zfeast_hcsrev(const char* uplo, const MKL_INT* n,
    ...
    double* res, MKL_INT* info);
void fpk_feast_sse2_zfeast_hcsrgv(const char* uplo, const MKL_INT* n,
    const MKL_Complex16* sa, const MKL_INT* isa, const MKL_INT* jsa,
    const MKL_Complex16* sb, const MKL_INT* isb, const MKL_INT* jsb,
    MKL_INT* fpm, double* epsout, MKL_INT* loop, const double* emin,
    const double* emax, MKL_INT* m0, double* e, MKL_Complex16* x, MKL_INT* m,
    double* res, MKL_INT* info);
void fpk_feast_sse2_zfeast_heev(const char* uplo, const MKL_INT* n,
...
void fpk_feast_sse2_zfeast_hegv(const char* uplo, const MKL_INT* n,
...
void fpk_feast_sse2_zfeast_hrci(MKL_INT* ijob, const MKL_INT* n,
...
void fpk_feast_avx512_mic_cfeast_hbev(const char* uplo, const MKL_INT* n,
    const MKL_INT* kla, const MKL_Complex8* a, const MKL_INT* lda, MKL_INT* fpm,
    float* epsout, MKL_INT* loop, const float* emin, const float* emax,
    MKL_INT* m0, float* e, MKL_Complex8* x, MKL_INT* m, float* res,
    MKL_INT* info);
void fpk_feast_avx512_mic_cfeast_hbgv(const char* uplo, const MKL_INT* n,
    const MKL_INT* kla, const MKL_Complex8* a, const MKL_INT* lda,
    const MKL_INT* klb, const MKL_Complex8* b, const MKL_INT* ldb, MKL_INT* fpm,
    float* epsout, MKL_INT* loop, const float* emin, const float* emax,
    MKL_INT* m0, float* e, MKL_Complex8* x, MKL_INT* m, float* res,
    MKL_INT* info);
void fpk_feast_avx512_mic_cfeast_hcsrev(const char* uplo, const MKL_INT* n,
    const MKL_Complex8* sa, const MKL_INT* isa, const MKL_INT* jsa, MKL_INT* fpm,
    float* epsout, MKL_INT* loop, const float* emin, const float* emax,
    MKL_INT* m0, float* e, MKL_Complex8* x, MKL_INT* m, float* res,
    MKL_INT* info);
void fpk_feast_avx512_mic_cfeast_hcsrgv(const char* uplo, const MKL_INT* n,
    const MKL_Complex8* sa, const MKL_INT* isa, const MKL_INT* jsa,
    const MKL_Complex8* sb, const MKL_INT* isb, const MKL_INT* jsb, MKL_INT* fpm,
    float* epsout, MKL_INT* loop, const float* emin, const float* emax,
    MKL_INT* m0, float* e, MKL_Complex8* x, MKL_INT* m, float* res,
    MKL_INT* info);
void fpk_feast_avx512_mic_cfeast_heev(const char* uplo, const MKL_INT* n,
    const MKL_Complex8* a, const MKL_INT* lda, MKL_INT* fpm, float* epsout,
    MKL_INT* loop, const float* emin, const float* emax, MKL_INT* m0, float* e,
    MKL_Complex8* x, MKL_INT* m, float* res, MKL_INT* info);
void fpk_feast_avx512_mic_cfeast_hegv(const char* uplo, const MKL_INT* n,
    const MKL_Complex8* a, const MKL_INT* lda, const MKL_Complex8* b,
    const MKL_INT* ldb, MKL_INT* fpm, float* epsout, MKL_INT* loop,
    const float* emin, const float* emax, MKL_INT* m0, float* e, MKL_Complex8* x,
    MKL_INT* m, float* res, MKL_INT* info);
void fpk_feast_avx512_mic_cfeast_hrci(MKL_INT* ijob, const MKL_INT* n,
    MKL_Complex8* ze, MKL_Complex8* work, MKL_Complex8* workc, MKL_Complex8* zaq,
    MKL_Complex8* zsq, MKL_INT* fpm, float* epsout, MKL_INT* loop,
    const float* emin, const float* emax, MKL_INT* m0, float* lambda,
    MKL_Complex8* q, MKL_INT* m, float* res, MKL_INT* info);
void fpk_feast_avx512_mic_dfeast_sbev(const char* uplo, const MKL_INT* n,
    const MKL_INT* kla, const double* a, const MKL_INT* lda, MKL_INT* fpm,
    double* epsout, MKL_INT* loop, const double* emin, const double* emax,
    MKL_INT* m0, double* e, double* x, MKL_INT* m, double* res, MKL_INT* info);
void fpk_feast_avx512_mic_dfeast_sbgv(const char* uplo, const MKL_INT* n,
    const MKL_INT* kla, const double* a, const MKL_INT* lda, const MKL_INT* klb,
    const double* b, const MKL_INT* ldb, MKL_INT* fpm, double* epsout,
    MKL_INT* loop, const double* emin, const double* emax, MKL_INT* m0,
    double* e, double* x, MKL_INT* m, double* res, MKL_INT* info);
void fpk_feast_avx512_mic_dfeast_scsrev(const char* uplo, const MKL_INT* n,
    const double* sa, const MKL_INT* isa, const MKL_INT* jsa, MKL_INT* fpm,
    double* epsout, MKL_INT* loop, const double* emin, const double* emax,
    MKL_INT* m0, double* e, double* x, MKL_INT* m, double* res, MKL_INT* info);
void fpk_feast_avx512_mic_dfeast_scsrgv(const char* uplo, const MKL_INT* n,
    const double* sa, const MKL_INT* isa, const MKL_INT* jsa, const double* sb,
    const MKL_INT* isb, const MKL_INT* jsb, MKL_INT* fpm, double* epsout,
    MKL_INT* loop, const double* emin, const double* emax, MKL_INT* m0,
    double* e, double* x, MKL_INT* m, double* res, MKL_INT* info);
void fpk_feast_avx512_mic_dfeast_srci(MKL_INT* ijob, const MKL_INT* n,
    MKL_Complex16* ze, double* work, MKL_Complex16* workc, double* aq,
    double* sq, MKL_INT* fpm, double* epsout, MKL_INT* loop, const double* emin,
    const double* emax, MKL_INT* m0, double* lambda, double* q, MKL_INT* m,
    double* res, MKL_INT* info);
void fpk_feast_avx512_mic_dfeast_syev(const char* uplo, const MKL_INT* n,
    const double* a, const MKL_INT* lda, MKL_INT* fpm, double* epsout,
    MKL_INT* loop, const double* emin, const double* emax, MKL_INT* m0,
    double* e, double* x, MKL_INT* m, double* res, MKL_INT* info);
void fpk_feast_avx512_mic_dfeast_sygv(const char* uplo, const MKL_INT* n,
    const double* a, const MKL_INT* lda, const double* b, const MKL_INT* ldb,
    MKL_INT* fpm, double* epsout, MKL_INT* loop, const double* emin,
    const double* emax, MKL_INT* m0, double* e, double* x, MKL_INT* m,
    double* res, MKL_INT* info);
void fpk_feast_avx512_mic_feastinit(MKL_INT* fpm);
void fpk_feast_avx512_mic_sfeast_sbev(const char* uplo, const MKL_INT* n,
    const MKL_INT* kla, const float* a, const MKL_INT* lda, MKL_INT* fpm,
    float* epsout, MKL_INT* loop, const float* emin, const float* emax,
    MKL_INT* m0, float* e, float* x, MKL_INT* m, float* res, MKL_INT* info);
void fpk_feast_avx512_mic_sfeast_sbgv(const char* uplo, const MKL_INT* n,
    const MKL_INT* kla, const float* a, const MKL_INT* lda, const MKL_INT* klb,
    const float* b, const MKL_INT* ldb, MKL_INT* fpm, float* epsout,
    MKL_INT* loop, const float* emin, const float* emax, MKL_INT* m0, float* e,
    float* x, MKL_INT* m, float* res, MKL_INT* info);
void fpk_feast_avx512_mic_sfeast_scsrev(const char* uplo, const MKL_INT* n,
    const float* sa, const MKL_INT* isa, const MKL_INT* jsa, MKL_INT* fpm,
    float* epsout, MKL_INT* loop, const float* emin, const float* emax,
    MKL_INT* m0, float* e, float* x, MKL_INT* m, float* res, MKL_INT* info);
void fpk_feast_avx512_mic_sfeast_scsrgv(const char* uplo, const MKL_INT* n,
    const float* sa, const MKL_INT* isa, const MKL_INT* jsa, const float* sb,
    const MKL_INT* isb, const MKL_INT* jsb, MKL_INT* fpm, float* epsout,
    MKL_INT* loop, const float* emin, const float* emax, MKL_INT* m0, float* e,
    float* x, MKL_INT* m, float* res, MKL_INT* info);
void fpk_feast_avx512_mic_sfeast_srci(MKL_INT* ijob, const MKL_INT* n,
    MKL_Complex8* ze, float* work, MKL_Complex8* workc, float* aq, float* sq,
    MKL_INT* fpm, float* epsout, MKL_INT* loop, const float* emin,
    const float* emax, MKL_INT* m0, float* lambda, float* q, MKL_INT* m,
    float* res, MKL_INT* info);
void fpk_feast_avx512_mic_sfeast_syev(const char* uplo, const MKL_INT* n,
    const float* a, const MKL_INT* lda, MKL_INT* fpm, float* epsout,
    MKL_INT* loop, const float* emin, const float* emax, MKL_INT* m0, float* e,
    float* x, MKL_INT* m, float* res, MKL_INT* info);
void fpk_feast_avx512_mic_sfeast_sygv(const char* uplo, const MKL_INT* n,
    const float* a, const MKL_INT* lda, const float* b, const MKL_INT* ldb,
    MKL_INT* fpm, float* epsout, MKL_INT* loop, const float* emin,
    const float* emax, MKL_INT* m0, float* e, float* x, MKL_INT* m, float* res,
    MKL_INT* info);
void fpk_feast_avx512_mic_zfeast_hbev(const char* uplo, const MKL_INT* n,
    const MKL_INT* kla, const MKL_Complex16* a, const MKL_INT* lda, MKL_INT* fpm,
    double* epsout, MKL_INT* loop, const double* emin, const double* emax,
    MKL_INT* m0, double* e, MKL_Complex16* x, MKL_INT* m, double* res,
    MKL_INT* info);
void fpk_feast_avx512_mic_zfeast_hbgv(const char* uplo, const MKL_INT* n,
    const MKL_INT* kla, const MKL_Complex16* a, const MKL_INT* lda,
    const MKL_INT* klb, const MKL_Complex16* b, const MKL_INT* ldb, MKL_INT* fpm,
    double* epsout, MKL_INT* loop, const double* emin, const double* emax,
    MKL_INT* m0, double* e, MKL_Complex16* x, MKL_INT* m, double* res,
    MKL_INT* info);
void fpk_feast_avx512_mic_zfeast_hcsrev(const char* uplo, const MKL_INT* n,
    const MKL_Complex16* sa, const MKL_INT* isa, const MKL_INT* jsa,
    MKL_INT* fpm, double* epsout, MKL_INT* loop, const double* emin,
    const double* emax, MKL_INT* m0, double* e, MKL_Complex16* x, MKL_INT* m,
    double* res, MKL_INT* info);
void fpk_feast_avx512_mic_zfeast_hcsrgv(const char* uplo, const MKL_INT* n,
    const MKL_Complex16* sa, const MKL_INT* isa, const MKL_INT* jsa,
    const MKL_Complex16* sb, const MKL_INT* isb, const MKL_INT* jsb,
    MKL_INT* fpm, double* epsout, MKL_INT* loop, const double* emin,
    const double* emax, MKL_INT* m0, double* e, MKL_Complex16* x, MKL_INT* m,
    double* res, MKL_INT* info);
void fpk_feast_avx512_mic_zfeast_heev(const char* uplo, const MKL_INT* n,
    const MKL_Complex16* a, const MKL_INT* lda, MKL_INT* fpm, double* epsout,
    MKL_INT* loop, const double* emin, const double* emax, MKL_INT* m0,
    double* e, MKL_Complex16* x, MKL_INT* m, double* res, MKL_INT* info);
void fpk_feast_avx512_mic_zfeast_hegv(const char* uplo, const MKL_INT* n,
    const MKL_Complex16* a, const MKL_INT* lda, const MKL_Complex16* b,
    const MKL_INT* ldb, MKL_INT* fpm, double* epsout, MKL_INT* loop,
    const double* emin, const double* emax, MKL_INT* m0, double* e,
    MKL_Complex16* x, MKL_INT* m, double* res, MKL_INT* info);
void fpk_feast_avx512_mic_zfeast_hrci(MKL_INT* ijob, const MKL_INT* n,
    MKL_Complex16* ze, MKL_Complex16* work, MKL_Complex16* workc,
    MKL_Complex16* zaq, MKL_Complex16* zsq, MKL_INT* fpm, double* epsout,
    MKL_INT* loop, const double* emin, const double* emax, MKL_INT* m0,
    double* lambda, MKL_Complex16* q, MKL_INT* m, double* res, MKL_INT* info);
...
void fpk_lapack_sse2_dgels(const char* trans, const MKL_INT* m, const MKL_INT* n,
    const MKL_INT* nrhs, double* a, const MKL_INT* lda, double* b,
    const MKL_INT* ldb, double* work, const MKL_INT* lwork, MKL_INT* info );
void fpk_lapack_sse2_dgeqp3(const MKL_INT* m, const MKL_INT* n, double* a,
    const MKL_INT* lda, MKL_INT* jpvt, double* tau, double* work,
    const MKL_INT* lwork, MKL_INT* info );
void fpk_lapack_sse2_dgeqrf(const MKL_INT* m, const MKL_INT* n, double* a,
    const MKL_INT* lda, double* tau, double* work, const MKL_INT* lwork,
    MKL_INT* info );
void fpk_lapack_sse2_dgerqf(const MKL_INT* m, const MKL_INT* n, double* a,
    const MKL_INT* lda, double* tau, double* work, const MKL_INT* lwork,
    MKL_INT* info );
void fpk_lapack_sse2_dgesvd(const char* jobu, const char* jobvt,
    ...
    const MKL_INT* lwork, MKL_INT* info );
double fpk_lapack_sse2_dlange(const char* norm, const MKL_INT* m,
    const MKL_INT* n, const double* a, const MKL_INT* lda, double* work );
void fpk_lapack_sse2_dlarnv(const MKL_INT* idist, MKL_INT* iseed,
    const MKL_INT* n, double* x );
void fpk_lapack_sse2_dorgqr(const MKL_INT* m, const MKL_INT* n, const MKL_INT* k,
    double* a, const MKL_INT* lda, const double* tau, double* work,
    const MKL_INT* lwork, MKL_INT* info );
void fpk_lapack_sse2_dorgrq(const MKL_INT* m, const MKL_INT* n, const MKL_INT* k,
    double* a, const MKL_INT* lda, const double* tau, double* work,
    const MKL_INT* lwork, MKL_INT* info );
...
void fpk_lapack_sse2_dpotrf(const char* uplo, const MKL_INT* n, double* a,
    const MKL_INT* lda, MKL_INT* info );
void fpk_lapack_sse2_dpotri(const char* uplo, const MKL_INT* n, double* a,
    const MKL_INT* lda, MKL_INT* info );
void fpk_lapack_sse2_dpotrs(const char* uplo, const MKL_INT* n,
    const MKL_INT* nrhs, const double* a, const MKL_INT* lda, double* b,
    const MKL_INT* ldb, MKL_INT* info );
void fpk_lapack_sse2_dpptrf(const char* uplo, const MKL_INT* n, double* ap,
    MKL_INT* info );
void fpk_lapack_sse2_dpstrf(const char* uplo, const MKL_INT* n, double* a,
    const MKL_INT* lda, MKL_INT* piv, MKL_INT* rank, const double* tol,
    double* work, MKL_INT* info );
void fpk_lapack_sse2_dspevd(const char* jobz, const char* uplo, const MKL_INT* n,
...
void fpk_lapack_sse2_dsyev(const char* jobz, const char* uplo, const MKL_INT* n,
    double* a, const MKL_INT* lda, double* w, double* work, const MKL_INT* lwork,
    MKL_INT* info );
void fpk_lapack_sse2_dsyevd(const char* jobz, const char* uplo, const MKL_INT* n,
    double* a, const MKL_INT* lda, double* w, double* work, const MKL_INT* lwork,
...
void fpk_lapack_sse2_sgels(const char* trans, const MKL_INT* m, const MKL_INT* n,
    const MKL_INT* nrhs, float* a, const MKL_INT* lda, float* b,
    const MKL_INT* ldb, float* work, const MKL_INT* lwork, MKL_INT* info );
void fpk_lapack_sse2_sgeqp3(const MKL_INT* m, const MKL_INT* n, float* a,
    const MKL_INT* lda, MKL_INT* jpvt, float* tau, float* work,
    const MKL_INT* lwork, MKL_INT* info );
void fpk_lapack_sse2_sgeqrf(const MKL_INT* m, const MKL_INT* n, float* a,
    const MKL_INT* lda, float* tau, float* work, const MKL_INT* lwork,
    MKL_INT* info );
void fpk_lapack_sse2_sgerqf(const MKL_INT* m, const MKL_INT* n, float* a,
    const MKL_INT* lda, float* tau, float* work, const MKL_INT* lwork,
    MKL_INT* info );
void fpk_lapack_sse2_sgesvd(const char* jobu, const char* jobvt,
    ...
    const MKL_INT* lwork, MKL_INT* info );
float fpk_lapack_sse2_slange(const char* norm, const MKL_INT* m,
    const MKL_INT* n, const float* a, const MKL_INT* lda, float* work );
void fpk_lapack_sse2_slarnv(const MKL_INT* idist, MKL_INT* iseed,
    const MKL_INT* n, float* x );
void fpk_lapack_sse2_sorgqr(const MKL_INT* m, const MKL_INT* n, const MKL_INT* k,
    float* a, const MKL_INT* lda, const float* tau, float* work,
    const MKL_INT* lwork, MKL_INT* info );
void fpk_lapack_sse2_sorgrq(const MKL_INT* m, const MKL_INT* n, const MKL_INT* k,
    float* a, const MKL_INT* lda, const float* tau, float* work,
    const MKL_INT* lwork, MKL_INT* info );
...
void fpk_lapack_sse2_spotrf(const char* uplo, const MKL_INT* n, float* a,
    const MKL_INT* lda, MKL_INT* info );
void fpk_lapack_sse2_spotri(const char* uplo, const MKL_INT* n, float* a,
    const MKL_INT* lda, MKL_INT* info );
void fpk_lapack_sse2_spotrs(const char* uplo, const MKL_INT* n,
    const MKL_INT* nrhs, const float* a, const MKL_INT* lda, float* b,
    const MKL_INT* ldb, MKL_INT* info );
void fpk_lapack_sse2_spptrf(const char* uplo, const MKL_INT* n, float* ap,
    MKL_INT* info );
void fpk_lapack_sse2_spstrf(const char* uplo, const MKL_INT* n, float* a,
    const MKL_INT* lda, MKL_INT* piv, MKL_INT* rank, const float* tol,
    float* work, MKL_INT* info );
void fpk_lapack_sse2_sspevd(const char* jobz, const char* uplo, const MKL_INT* n,
    float* ap, float* w, float* z, const MKL_INT* ldz, float* work,
    const MKL_INT* lwork, MKL_INT* iwork, const MKL_INT* liwork, MKL_INT* info );
void fpk_lapack_sse2_ssyev(const char* jobz, const char* uplo, const MKL_INT* n,
    float* a, const MKL_INT* lda, float* w, float* work, const MKL_INT* lwork,
    MKL_INT* info );
void fpk_lapack_sse2_ssyevd(const char* jobz, const char* uplo, const MKL_INT* n,
    float* a, const MKL_INT* lda, float* w, float* work, const MKL_INT* lwork,
    MKL_INT* iwork, const MKL_INT* liwork, MKL_INT* info );
...
void fpk_lapack_avx512_mic_dgels(const char* trans, const MKL_INT* m,
    const MKL_INT* n, const MKL_INT* nrhs, double* a, const MKL_INT* lda,
    double* b, const MKL_INT* ldb, double* work, const MKL_INT* lwork,
    MKL_INT* info );
void fpk_lapack_avx512_mic_dgeqp3(const MKL_INT* m, const MKL_INT* n, double* a,
    const MKL_INT* lda, MKL_INT* jpvt, double* tau, double* work,
    const MKL_INT* lwork, MKL_INT* info );
void fpk_lapack_avx512_mic_dgeqrf(const MKL_INT* m, const MKL_INT* n, double* a,
    const MKL_INT* lda, double* tau, double* work, const MKL_INT* lwork,
    MKL_INT* info );
void fpk_lapack_avx512_mic_dgerqf(const MKL_INT* m, const MKL_INT* n, double* a,
    const MKL_INT* lda, double* tau, double* work, const MKL_INT* lwork,
    MKL_INT* info );
void fpk_lapack_avx512_mic_dgesvd(const char* jobu, const char* jobvt,
    ...
    double* u, const MKL_INT* ldu, double* vt, const MKL_INT* ldvt, double* work,
    const MKL_INT* lwork, MKL_INT* info );
double fpk_lapack_avx512_mic_dlange(const char* norm, const MKL_INT* m,
    const MKL_INT* n, const double* a, const MKL_INT* lda, double* work );
void fpk_lapack_avx512_mic_dlarnv(const MKL_INT* idist, MKL_INT* iseed,
    const MKL_INT* n, double* x );
void fpk_lapack_avx512_mic_dorgqr(const MKL_INT* m, const MKL_INT* n,
    const MKL_INT* k, double* a, const MKL_INT* lda, const double* tau,
    double* work, const MKL_INT* lwork, MKL_INT* info );
void fpk_lapack_avx512_mic_dorgrq(const MKL_INT* m, const MKL_INT* n,
    const MKL_INT* k, double* a, const MKL_INT* lda, const double* tau,
    double* work, const MKL_INT* lwork, MKL_INT* info );
...
void fpk_lapack_avx512_mic_dpftrf(const char* transr, const char* uplo,
    const MKL_INT* n, double* a, MKL_INT* info );
void fpk_lapack_avx512_mic_dpotrf(const char* uplo, const MKL_INT* n, double* a,
    const MKL_INT* lda, MKL_INT* info );
void fpk_lapack_avx512_mic_dpotri(const char* uplo, const MKL_INT* n, double* a,
    const MKL_INT* lda, MKL_INT* info );
void fpk_lapack_avx512_mic_dpotrs(const char* uplo, const MKL_INT* n,
    const MKL_INT* nrhs, const double* a, const MKL_INT* lda, double* b,
    const MKL_INT* ldb, MKL_INT* info );
void fpk_lapack_avx512_mic_dpptrf(const char* uplo, const MKL_INT* n, double* ap,
    MKL_INT* info );
void fpk_lapack_avx512_mic_dpstrf(const char* uplo, const MKL_INT* n, double* a,
    const MKL_INT* lda, MKL_INT* piv, MKL_INT* rank, const double* tol,
    double* work, MKL_INT* info );
...
void fpk_lapack_avx512_mic_dtrtrs(const char* uplo, const char* trans,
    const char* diag, const MKL_INT* n, const MKL_INT* nrhs, const double* a,
    const MKL_INT* lda, double* b, const MKL_INT* ldb, MKL_INT* info );
void fpk_lapack_avx512_mic_sgels(const char* trans, const MKL_INT* m,
    const MKL_INT* n, const MKL_INT* nrhs, float* a, const MKL_INT* lda,
    float* b, const MKL_INT* ldb, float* work, const MKL_INT* lwork,
    MKL_INT* info );
void fpk_lapack_avx512_mic_sgeqp3(const MKL_INT* m, const MKL_INT* n, float* a,
    const MKL_INT* lda, MKL_INT* jpvt, float* tau, float* work,
    const MKL_INT* lwork, MKL_INT* info );
void fpk_lapack_avx512_mic_sgeqrf(const MKL_INT* m, const MKL_INT* n, float* a,
    const MKL_INT* lda, float* tau, float* work, const MKL_INT* lwork,
    MKL_INT* info );
void fpk_lapack_avx512_mic_sgerqf(const MKL_INT* m, const MKL_INT* n, float* a,
    const MKL_INT* lda, float* tau, float* work, const MKL_INT* lwork,
    MKL_INT* info );
void fpk_lapack_avx512_mic_sgesvd(const char* jobu, const char* jobvt,
    ...
    float* u, const MKL_INT* ldu, float* vt, const MKL_INT* ldvt, float* work,
    const MKL_INT* lwork, MKL_INT* info );
float fpk_lapack_avx512_mic_slange(const char* norm, const MKL_INT* m,
    const MKL_INT* n, const float* a, const MKL_INT* lda, float* work );
void fpk_lapack_avx512_mic_slarnv(const MKL_INT* idist, MKL_INT* iseed,
    const MKL_INT* n, float* x );
void fpk_lapack_avx512_mic_sorgqr(const MKL_INT* m, const MKL_INT* n,
    const MKL_INT* k, float* a, const MKL_INT* lda, const float* tau,
    float* work, const MKL_INT* lwork, MKL_INT* info );
void fpk_lapack_avx512_mic_sorgrq(const MKL_INT* m, const MKL_INT* n,
    const MKL_INT* k, float* a, const MKL_INT* lda, const float* tau,
    float* work, const MKL_INT* lwork, MKL_INT* info );
...
void fpk_lapack_avx512_mic_spftrf(const char* transr, const char* uplo,
    const MKL_INT* n, float* a, MKL_INT* info );
void fpk_lapack_avx512_mic_spotrf(const char* uplo, const MKL_INT* n, float* a,
    const MKL_INT* lda, MKL_INT* info );
void fpk_lapack_avx512_mic_spotri(const char* uplo, const MKL_INT* n, float* a,
    const MKL_INT* lda, MKL_INT* info );
void fpk_lapack_avx512_mic_spotrs(const char* uplo, const MKL_INT* n,
    const MKL_INT* nrhs, const float* a, const MKL_INT* lda, float* b,
    const MKL_INT* ldb, MKL_INT* info );
void fpk_lapack_avx512_mic_spptrf(const char* uplo, const MKL_INT* n, float* ap,
    MKL_INT* info );
void fpk_lapack_avx512_mic_spstrf(const char* uplo, const MKL_INT* n, float* a,
    const MKL_INT* lda, MKL_INT* piv, MKL_INT* rank, const float* tol,
    float* work, MKL_INT* info );
...
void fpk_pds_sse2_pardiso(_MKL_DSS_HANDLE_t, const MKL_INT *, const MKL_INT *,
...
MKL_INT fpk_pds_sse2_pardiso_getenv(const _MKL_DSS_HANDLE_t,
    const enum PARDISO_ENV_PARAM*, char* );
MKL_INT fpk_pds_sse2_pardiso_setenv(_MKL_DSS_HANDLE_t,
...
void fpk_pds_avx512_mic_pardiso(_MKL_DSS_HANDLE_t, const MKL_INT *,
    const MKL_INT *, const MKL_INT *, const MKL_INT *, const MKL_INT *,
    const void *, const MKL_INT *, const MKL_INT *, MKL_INT *, const MKL_INT *,
    MKL_INT *, const MKL_INT *, void *, void *, MKL_INT * );
MKL_INT fpk_pds_avx512_mic_pardiso_getenv(const _MKL_DSS_HANDLE_t,
    const enum PARDISO_ENV_PARAM*, char* );
MKL_INT fpk_pds_avx512_mic_pardiso_setenv(_MKL_DSS_HANDLE_t,
    const enum PARDISO_ENV_PARAM*, const char* );
...
void fpk_spblas_sse2_mkl_dcsrmm(const char *transa, const MKL_INT *m,
...
void fpk_spblas_sse2_mkl_dcsrmultd(const char *transa, const MKL_INT *m,
    const MKL_INT *n, const MKL_INT *k, double *a, MKL_INT *ja, MKL_INT *ia,
    double *b, MKL_INT *jb, MKL_INT *ib, double *c, MKL_INT *ldc);
void fpk_spblas_sse2_mkl_dcsrmv(const char *transa, const MKL_INT *m,
...
void fpk_spblas_sse2_mkl_ddnscsr(const MKL_INT *job, const MKL_INT *m,
    const MKL_INT *n, double *Adns, const MKL_INT *lda, double *Acsr,
    MKL_INT *AJ, MKL_INT *AI, MKL_INT *info);
void fpk_spblas_sse2_mkl_scsrmm(const char *transa, const MKL_INT *m,
...
void fpk_spblas_sse2_mkl_scsrmultd(const char *transa, const MKL_INT *m,
    const MKL_INT *n, const MKL_INT *k, float *a, MKL_INT *ja, MKL_INT *ia,
    float *b, MKL_INT *jb, MKL_INT *ib, float *c, MKL_INT *ldc);
void fpk_spblas_sse2_mkl_scsrmv(const char *transa, const MKL_INT *m,
...
void fpk_spblas_sse2_mkl_sdnscsr(const MKL_INT *job, const MKL_INT *m,
...
void fpk_spblas_avx512_mic_mkl_dcsrmm(const char *transa, const MKL_INT *m,
    const MKL_INT *n, const MKL_INT *k, const double *alpha,
    const char *matdescra, const double *val, const MKL_INT *indx,
    const MKL_INT *pntrb, const MKL_INT *pntre, const double *b,
    const MKL_INT *ldb, const double *beta, double *c, const MKL_INT *ldc);
void fpk_spblas_avx512_mic_mkl_dcsrmultd(const char *transa, const MKL_INT *m,
    const MKL_INT *n, const MKL_INT *k, double *a, MKL_INT *ja, MKL_INT *ia,
    double *b, MKL_INT *jb, MKL_INT *ib, double *c, MKL_INT *ldc);
void fpk_spblas_avx512_mic_mkl_dcsrmv(const char *transa, const MKL_INT *m,
    const MKL_INT *k, const double *alpha, const char *matdescra,
    const double *val, const MKL_INT *indx, const MKL_INT *pntrb,
    const MKL_INT *pntre, const double *x, const double *beta, double *y);
void fpk_spblas_avx512_mic_mkl_ddnscsr(const MKL_INT *job, const MKL_INT *m,
    const MKL_INT *n, double *Adns, const MKL_INT *lda, double *Acsr,
    MKL_INT *AJ, MKL_INT *AI, MKL_INT *info);
void fpk_spblas_avx512_mic_mkl_scsrmm(const char *transa, const MKL_INT *m,
    const MKL_INT *n, const MKL_INT *k, const float *alpha,
    const char *matdescra, const float *val, const MKL_INT *indx,
    const MKL_INT *pntrb, const MKL_INT *pntre, const float *b,
    const MKL_INT *ldb, const float *beta, float *c, const MKL_INT *ldc);
void fpk_spblas_avx512_mic_mkl_scsrmultd(const char *transa, const MKL_INT *m,
    const MKL_INT *n, const MKL_INT *k, float *a, MKL_INT *ja, MKL_INT *ia,
    float *b, MKL_INT *jb, MKL_INT *ib, float *c, MKL_INT *ldc);
void fpk_spblas_avx512_mic_mkl_scsrmv(const char *transa, const MKL_INT *m,
    const MKL_INT *k, const float *alpha, const char *matdescra,
    const float *val, const MKL_INT *indx, const MKL_INT *pntrb,
    const MKL_INT *pntre, const float *x, const float *beta, float *y);
void fpk_spblas_avx512_mic_mkl_sdnscsr(const MKL_INT *job, const MKL_INT *m,
    const MKL_INT *n, float *Adns, const MKL_INT *lda, float *Acsr, MKL_INT *AJ,
    MKL_INT *AI, MKL_INT *info);
