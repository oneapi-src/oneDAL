...
#define   ippCPUID_SSE        0x00000002   /* Intel(R) SSE                                 */
#define   ippCPUID_SSE2       0x00000004   /* Intel(R) SSE2                                */
#define   ippCPUID_SSE3       0x00000008   /* Intel(R) SSE3                                */
#define   ippCPUID_SSSE3      0x00000010   /* Intel(R) SSSE3                               */
#define   ippCPUID_MOVBE      0x00000020   /* The processor supports MOVBE instruction     */
#define   ippCPUID_SSE41      0x00000040   /* Intel(R) SSE4.1                              */
#define   ippCPUID_SSE42      0x00000080   /* Intel(R) SSE4.2                              */
#define   ippCPUID_AVX        0x00000100   /* Intel(R) AVX instruction set                 */
#define   ippAVX_ENABLEDBYOS  0x00000200   /* The operating system supports Intel(R) AVX   */
...
#define   ippCPUID_AVX2       0x00008000   /* Intel(R) AVX2 instruction set                */
