...
CALL_RET_FUNC_FROM_DLL(dnnError_t, fpk_dnn_, ConcatCreate_F32,
...
CALL_RET_FUNC_FROM_DLL(dnnError_t, fpk_dnn_, ConcatCreate_F64,
                       (dnnPrimitive_t * pConcat, dnnPrimitiveAttributes_t attributes, const size_t nSrcTensors, dnnLayout_t * src),
                       (pConcat, attributes, nSrcTensors, src));
...
CALL_RET_FUNC_FROM_DLL(dnnError_t, fpk_dnn_, ConversionCreate_F64, (dnnPrimitive_t * pConversion, const dnnLayout_t from, const dnnLayout_t to),
                       (pConversion, from, to));
CALL_RET_FUNC_FROM_DLL(dnnError_t, fpk_dnn_, ConversionExecute_F32, (dnnPrimitive_t conversion, void * from, void * to), (conversion, from, to));
CALL_RET_FUNC_FROM_DLL(dnnError_t, fpk_dnn_, ConversionExecute_F64, (dnnPrimitive_t conversion, void * from, void * to), (conversion, from, to));
...
CALL_RET_FUNC_FROM_DLL(dnnError_t, fpk_dnn_, ExecuteAsync_F32, (dnnPrimitive_t primitive, void * resources[]), (primitive, resources));
CALL_RET_FUNC_FROM_DLL(dnnError_t, fpk_dnn_, ExecuteAsync_F64, (dnnPrimitive_t primitive, void * resources[]), (primitive, resources));
...
CALL_RET_FUNC_FROM_DLL(dnnError_t, fpk_dnn_, GroupsConvolutionCreateBackwardBias_F32,
                       (dnnPrimitive_t * pConvolution, dnnPrimitiveAttributes_t attributes, dnnAlgorithm_t algorithm, size_t groups, size_t dimension,
...
CALL_RET_FUNC_FROM_DLL(dnnError_t, fpk_dnn_, GroupsConvolutionCreateBackwardData_F32,
                       (dnnPrimitive_t * pConvolution, dnnPrimitiveAttributes_t attributes, dnnAlgorithm_t algorithm, size_t groups, size_t dimension,
                        const size_t srcSize[], const size_t dstSize[], const size_t filterSize[], const size_t convolutionStrides[],
                        const int inputOffset[], const dnnBorder_t borderType),
                       (pConvolution, attributes, algorithm, groups, dimension, srcSize, dstSize, filterSize, convolutionStrides, inputOffset,
                        borderType));
...
CALL_RET_FUNC_FROM_DLL(dnnError_t, fpk_dnn_, LRNCreateBackward_F32,
                       (dnnPrimitive_t * pLrn, dnnPrimitiveAttributes_t attributes, const dnnLayout_t diffLayout, const dnnLayout_t dataLayout,
                        size_t kernel_size, float alpha, float beta, float k),
                       (pLrn, attributes, diffLayout, dataLayout, kernel_size, alpha, beta, k));
CALL_RET_FUNC_FROM_DLL(dnnError_t, fpk_dnn_, LRNCreateBackward_F64,
                       (dnnPrimitive_t * pLrn, dnnPrimitiveAttributes_t attributes, const dnnLayout_t diffLayout, const dnnLayout_t dataLayout,
                        size_t kernel_size, double alpha, double beta, double k),
                       (pLrn, attributes, diffLayout, dataLayout, kernel_size, alpha, beta, k));
CALL_RET_FUNC_FROM_DLL(dnnError_t, fpk_dnn_, LRNCreateForward_F32,
                       (dnnPrimitive_t * pLrn, dnnPrimitiveAttributes_t attributes, const dnnLayout_t dataLayout, size_t kernel_size, float alpha,
                        float beta, float k),
                       (pLrn, attributes, dataLayout, kernel_size, alpha, beta, k));
CALL_RET_FUNC_FROM_DLL(dnnError_t, fpk_dnn_, LRNCreateForward_F64,
                       (dnnPrimitive_t * pLrn, dnnPrimitiveAttributes_t attributes, const dnnLayout_t dataLayout, size_t kernel_size, double alpha,
...
CALL_RET_FUNC_FROM_DLL(dnnError_t, fpk_dnn_, LayoutCreateFromPrimitive_F32,
                       (dnnLayout_t * pLayout, const dnnPrimitive_t primitive, dnnResourceType_t type), (pLayout, primitive, type));
CALL_RET_FUNC_FROM_DLL(dnnError_t, fpk_dnn_, LayoutCreateFromPrimitive_F64,
                       (dnnLayout_t * pLayout, const dnnPrimitive_t primitive, dnnResourceType_t type), (pLayout, primitive, type));

CALL_RET_FUNC_FROM_DLL(dnnError_t, fpk_dnn_, LayoutCreate_F32, (dnnLayout_t * pLayout, size_t dimension, const size_t size[], const size_t strides[]),
                       (pLayout, dimension, size, strides));
CALL_RET_FUNC_FROM_DLL(dnnError_t, fpk_dnn_, LayoutCreate_F64, (dnnLayout_t * pLayout, size_t dimension, const size_t size[], const size_t strides[]),
                       (pLayout, dimension, size, strides));
...
CALL_RET_FUNC_FROM_DLL(dnnError_t, fpk_dnn_, PoolingCreateBackward_F32,
                       (dnnPrimitive_t * pPooling, dnnPrimitiveAttributes_t attributes, dnnAlgorithm_t op, const dnnLayout_t srcLayout,
                        const size_t kernelSize[], const size_t kernelStride[], const int inputOffset[], const dnnBorder_t borderType),
                       (pPooling, attributes, op, srcLayout, kernelSize, kernelStride, inputOffset, borderType));
CALL_RET_FUNC_FROM_DLL(dnnError_t, fpk_dnn_, PoolingCreateBackward_F64,
                       (dnnPrimitive_t * pPooling, dnnPrimitiveAttributes_t attributes, dnnAlgorithm_t op, const dnnLayout_t srcLayout,
                        const size_t kernelSize[], const size_t kernelStride[], const int inputOffset[], const dnnBorder_t borderType),
                       (pPooling, attributes, op, srcLayout, kernelSize, kernelStride, inputOffset, borderType));
CALL_RET_FUNC_FROM_DLL(dnnError_t, fpk_dnn_, PoolingCreateForward_F32,
                       (dnnPrimitive_t * pPooling, dnnPrimitiveAttributes_t attributes, dnnAlgorithm_t op, const dnnLayout_t srcLayout,
                        const size_t kernelSize[], const size_t kernelStride[], const int inputOffset[], const dnnBorder_t borderType),
                       (pPooling, attributes, op, srcLayout, kernelSize, kernelStride, inputOffset, borderType));
CALL_RET_FUNC_FROM_DLL(dnnError_t, fpk_dnn_, PoolingCreateForward_F64,
                       (dnnPrimitive_t * pPooling, dnnPrimitiveAttributes_t attributes, dnnAlgorithm_t op, const dnnLayout_t srcLayout,
                        const size_t kernelSize[], const size_t kernelStride[], const int inputOffset[], const dnnBorder_t borderType),
                       (pPooling, attributes, op, srcLayout, kernelSize, kernelStride, inputOffset, borderType));

CALL_RET_FUNC_FROM_DLL(dnnError_t, fpk_dnn_, ReLUCreateBackward_F32,
                       (dnnPrimitive_t * pRelu, dnnPrimitiveAttributes_t attributes, const dnnLayout_t diffLayout, const dnnLayout_t dataLayout,
                        float negativeSlope),
                       (pRelu, attributes, diffLayout, dataLayout, negativeSlope));
CALL_RET_FUNC_FROM_DLL(dnnError_t, fpk_dnn_, ReLUCreateBackward_F64,
                       (dnnPrimitive_t * pRelu, dnnPrimitiveAttributes_t attributes, const dnnLayout_t diffLayout, const dnnLayout_t dataLayout,
                        double negativeSlope),
                       (pRelu, attributes, diffLayout, dataLayout, negativeSlope));
CALL_RET_FUNC_FROM_DLL(dnnError_t, fpk_dnn_, ReLUCreateForward_F32,
                       (dnnPrimitive_t * pRelu, dnnPrimitiveAttributes_t attributes, const dnnLayout_t dataLayout, float negativeSlope),
                       (pRelu, attributes, dataLayout, negativeSlope));
CALL_RET_FUNC_FROM_DLL(dnnError_t, fpk_dnn_, ReLUCreateForward_F64,
                       (dnnPrimitive_t * pRelu, dnnPrimitiveAttributes_t attributes, const dnnLayout_t dataLayout, double negativeSlope),
                       (pRelu, attributes, dataLayout, negativeSlope));
...
CALL_RET_FUNC_FROM_DLL(dnnError_t, fpk_dnn_, SplitCreate_F32,
                       (dnnPrimitive_t * pSplit, dnnPrimitiveAttributes_t attributes, const size_t nDstTensors, dnnLayout_t layout,
                        size_t dstChannelSize[]),
                       (pSplit, attributes, nDstTensors, layout, dstChannelSize));
CALL_RET_FUNC_FROM_DLL(dnnError_t, fpk_dnn_, SplitCreate_F64,
                       (dnnPrimitive_t * pSplit, dnnPrimitiveAttributes_t attributes, const size_t nDstTensors, dnnLayout_t layout,
                        size_t dstChannelSize[]),
                       (pSplit, attributes, nDstTensors, layout, dstChannelSize));
