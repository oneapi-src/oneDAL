...
CALL_RET_FUNC_FROM_DLL(double, fpk_blas_, xddot,  (const DAAL_INT *n, const double *x, const DAAL_INT *incx, const double *y, const DAAL_INT *incy), (n, x, incx, y, incy));
CALL_RET_FUNC_FROM_DLL(float, fpk_blas_, xsdot,   (const DAAL_INT *n, const float  *x, const DAAL_INT *incx, const float  *y, const DAAL_INT *incy), (n, x, incx, y, incy));
