...
struct MklSpBlas<double, cpu>
{
    ...
    static void xcsrmultd(const char *transa, const MKL_INT *m,
    ...
    static void xcsrmv(const char *transa, const MKL_INT *m,
    ...
    static void xcsrmm(const char *transa, const MKL_INT *m, const MKL_INT *n, const MKL_INT *k,
                const double *alpha, const char *matdescra, const double *val, const MKL_INT *indx,
                const MKL_INT *pntrb, const double *b, const MKL_INT *ldb, const double *beta, double *c, const MKL_INT *ldc)
    {
        __DAAL_MKLFN_CALL(spblas_, mkl_dcsrmm, (transa, m, n, k, alpha, matdescra, val, indx, pntrb, pntrb+1, b, ldb, beta, c, ldc));
    }

    static void xxcsrmm(const char *transa, const MKL_INT *m, const MKL_INT *n, const MKL_INT *k,
                 const double *alpha, const char *matdescra, const double *val, const MKL_INT *indx,
                 const MKL_INT *pntrb, const double *b, const MKL_INT *ldb, const double *beta, double *c, const MKL_INT *ldc)
    {
...
struct MklSpBlas<float, cpu>
{
    ...
    static void xcsrmm(const char *transa, const MKL_INT *m, const MKL_INT *n, const MKL_INT *k,
                const float *alpha, const char *matdescra, const float *val, const MKL_INT *indx,
                const MKL_INT *pntrb, const float *b, const MKL_INT *ldb, const float *beta, float *c, const MKL_INT *ldc)
    {
