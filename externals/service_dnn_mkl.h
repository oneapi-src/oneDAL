...
struct MklDnn<double, cpu>
{
    ...
    static dnnError_t xConvolutionCreateForwardBias(dnnPrimitive_t * pConvolution, dnnAlgorithm_t algorithm, size_t nGroups, size_t dimension,
    ...
    {
        __DAAL_DNNFN_CALL(
            dnn_, GroupsConvolutionCreateForwardBias_F64,
            (pConvolution, NULL, algorithm, nGroups, dimension, srcSize, dstSize, filterSize, convolutionStrides, inputOffset, border_type));
    }
    static dnnError_t xConvolutionCreateBackwardData(dnnPrimitive_t * pConvolution, dnnAlgorithm_t algorithm, size_t nGroups, size_t dimension,
                                                     const size_t srcSize[], const size_t dstSize[], const size_t filterSize[],
                                                     const size_t convolutionStrides[], const int inputOffset[], const dnnBorder_t border_type)
    {
        __DAAL_DNNFN_CALL(
            dnn_, GroupsConvolutionCreateBackwardData_F64,
            (pConvolution, NULL, algorithm, nGroups, dimension, srcSize, dstSize, filterSize, convolutionStrides, inputOffset, border_type));
    }
    static dnnError_t xConvolutionCreateBackwardFilter(dnnPrimitive_t * pConvolution, dnnAlgorithm_t algorithm, size_t nGroups, size_t dimension,
                                                       const size_t srcSize[], const size_t dstSize[], const size_t filterSize[],
                                                       const size_t convolutionStrides[], const int inputOffset[], const dnnBorder_t border_type)
    {
        __DAAL_DNNFN_CALL(
            dnn_, GroupsConvolutionCreateBackwardFilter_F64,
            (pConvolution, NULL, algorithm, nGroups, dimension, srcSize, dstSize, filterSize, convolutionStrides, inputOffset, border_type));
    }
    static dnnError_t xConvolutionCreateBackwardBias(dnnPrimitive_t * pConvolution, dnnAlgorithm_t algorithm, size_t nGroups, size_t dimension,
                                                     const size_t dstSize[])
    {
        __DAAL_DNNFN_CALL(dnn_, GroupsConvolutionCreateBackwardBias_F64, (pConvolution, NULL, algorithm, nGroups, dimension, dstSize));
    }

    static dnnError_t xSplitCreate(PrimitiveType * pSplit, size_t nDstTensors, const LayoutType dataLayout, size_t dstChannelSize[])
    {
        __DAAL_DNNFN_CALL(dnn_, SplitCreate_F64, (pSplit, NULL, nDstTensors, dataLayout, dstChannelSize));
    }

    static dnnError_t xConcatCreate(PrimitiveType * pConcat, const size_t nSrcTensors, LayoutType src[])
    {
        __DAAL_DNNFN_CALL(dnn_, ConcatCreate_F64, (pConcat, NULL, nSrcTensors, src));
    }

    static dnnError_t xReLUCreateForward(dnnPrimitive_t * pRelu, const dnnLayout_t dataLayout, double negativeSlope)
    {
        __DAAL_DNNFN_CALL(dnn_, ReLUCreateForward_F64, (pRelu, NULL, dataLayout, negativeSlope));
    }

    static dnnError_t xReLUCreateBackward(dnnPrimitive_t * pRelu, const dnnLayout_t diffLayout, const dnnLayout_t dataLayout, double negativeSlope)
    {
        __DAAL_DNNFN_CALL(dnn_, ReLUCreateBackward_F64, (pRelu, NULL, diffLayout, dataLayout, negativeSlope));
    }

    static ErrorType xLRNCreateForward(PrimitiveType * pLrn, const LayoutType dataLayout, size_t kernelSize, double alpha, double beta, double k)
    {
    ...
    static dnnError_t xExecute(dnnPrimitive_t primitive, void * resources[]) { __DAAL_DNNFN_CALL(dnn_, Execute_F64, (primitive, resources)); }
    ...
    static dnnError_t xAllocateBuffer(void ** pPtr, dnnLayout_t layout) { __DAAL_DNNFN_CALL(dnn_, AllocateBuffer_F64, (pPtr, layout)); }
    static dnnError_t xReleaseBuffer(void * ptr) { __DAAL_DNNFN_CALL(dnn_, ReleaseBuffer_F64, (ptr)); }
    static int xLayoutCompare(const dnnLayout_t l1, const dnnLayout_t l2) { __DAAL_DNNFN_CALL(dnn_, LayoutCompare_F64, (l1, l2)); }
    ...
    static dnnError_t xDelete(dnnPrimitive_t primitive) { __DAAL_DNNFN_CALL(dnn_, Delete_F64, (primitive)); }
    static dnnError_t xLayoutDelete(dnnLayout_t layout) { __DAAL_DNNFN_CALL(dnn_, LayoutDelete_F64, (layout)); }
    static size_t xLayoutGetMemorySize(const dnnLayout_t layout) { __DAAL_DNNFN_CALL(dnn_, LayoutGetMemorySize_F64, (layout)); }
};
...
struct MklDnn<float, cpu>
{
    ...
    {
        __DAAL_DNNFN_CALL(
            dnn_, GroupsConvolutionCreateForwardBias_F32,
            (pConvolution, NULL, algorithm, nGroups, dimension, srcSize, dstSize, filterSize, convolutionStrides, inputOffset, border_type));
    }
    static dnnError_t xConvolutionCreateBackwardData(dnnPrimitive_t * pConvolution, dnnAlgorithm_t algorithm, size_t nGroups, size_t dimension,
                                                     const size_t srcSize[], const size_t dstSize[], const size_t filterSize[],
    ...
    {
        __DAAL_DNNFN_CALL(
            dnn_, GroupsConvolutionCreateBackwardData_F32,
            (pConvolution, NULL, algorithm, nGroups, dimension, srcSize, dstSize, filterSize, convolutionStrides, inputOffset, border_type));
    }
    static dnnError_t xConvolutionCreateBackwardFilter(dnnPrimitive_t * pConvolution, dnnAlgorithm_t algorithm, size_t nGroups, size_t dimension,
                                                       const size_t srcSize[], const size_t dstSize[], const size_t filterSize[],
    ...
    {
        __DAAL_DNNFN_CALL(
            dnn_, GroupsConvolutionCreateBackwardFilter_F32,
            (pConvolution, NULL, algorithm, nGroups, dimension, srcSize, dstSize, filterSize, convolutionStrides, inputOffset, border_type));
    }
    static dnnError_t xConvolutionCreateBackwardBias(dnnPrimitive_t * pConvolution, dnnAlgorithm_t algorithm, size_t nGroups, size_t dimension,
                                                     const size_t dstSize[])
    ...
    static dnnError_t xReLUCreateForward(dnnPrimitive_t * pRelu, const dnnLayout_t dataLayout, float negativeSlope)
    {
        __DAAL_DNNFN_CALL(dnn_, ReLUCreateForward_F32, (pRelu, NULL, dataLayout, negativeSlope));
    }

    static dnnError_t xReLUCreateBackward(dnnPrimitive_t * pRelu, const dnnLayout_t diffLayout, const dnnLayout_t dataLayout, float negativeSlope)
    {
        __DAAL_DNNFN_CALL(dnn_, ReLUCreateBackward_F32, (pRelu, NULL, diffLayout, dataLayout, negativeSlope));
    }

    static ErrorType xLRNCreateForward(PrimitiveType * pLrn, const LayoutType dataLayout, size_t kernelSize, float alpha, float beta, float k)
    {
    ...
    static dnnError_t xExecute(dnnPrimitive_t primitive, void * resources[]) { __DAAL_DNNFN_CALL(dnn_, Execute_F32, (primitive, resources)); }
    static dnnError_t xConversionExecute(dnnPrimitive_t conversion, void * from, void * to)
    {
        if (!conversion) return E_SUCCESS;
    ...
    static dnnError_t xAllocateBuffer(void ** pPtr, dnnLayout_t layout) { __DAAL_DNNFN_CALL(dnn_, AllocateBuffer_F32, (pPtr, layout)); }
    static dnnError_t xReleaseBuffer(void * ptr) { __DAAL_DNNFN_CALL(dnn_, ReleaseBuffer_F32, (ptr)); }
    static int xLayoutCompare(const dnnLayout_t l1, const dnnLayout_t l2) { __DAAL_DNNFN_CALL(dnn_, LayoutCompare_F32, (l1, l2)); }
    static dnnError_t xConversionCreate(dnnPrimitive_t * pConversion, const dnnLayout_t from, const dnnLayout_t to)
    {
        __DAAL_DNNFN_CALL(dnn_, ConversionCreate_F32, (pConversion, from, to));
    }
    static dnnError_t xDelete(dnnPrimitive_t primitive) { __DAAL_DNNFN_CALL(dnn_, Delete_F32, (primitive)); }
    static dnnError_t xLayoutDelete(dnnLayout_t layout) { __DAAL_DNNFN_CALL(dnn_, LayoutDelete_F32, (layout)); }
    static size_t xLayoutGetMemorySize(const dnnLayout_t layout) { __DAAL_DNNFN_CALL(dnn_, LayoutGetMemorySize_F32, (layout)); }
};
