...
public:
    ...
    int uniformWithoutReplacement(const SizeType n, DstType* r, void *state, const Type a, const Type b, const int method = __DAAL_RNG_METHOD_UNIFORM_STD)
    {
    ...
    template<typename DstType = Type>
    int uniformWithoutReplacement(const SizeType n, DstType* r, Type* buffer, void *state, const Type a, const Type b, const int method = __DAAL_RNG_METHOD_UNIFORM_STD)
    {
        int errorcode = 0;
