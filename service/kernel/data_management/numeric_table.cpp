...
IMPLEMENT_SERIALIZABLE_TAG(KeyValueDataCollection,SERIALIZATION_KEYVALUEDATACOLLECTION_ID)
...
Status createSparseTableImpl(const NumericTablePtr &inTable, CSRNumericTablePtr &resTable)
{
    ...
    SharedPtr<CSRNumericTableIface> inputTable = dynamicPointerCast<CSRNumericTableIface, NumericTable>(inTable);
