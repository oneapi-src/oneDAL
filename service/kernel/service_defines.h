...
#define IMPLEMENT_SERIALIZABLE_TAG1(Class,T1,Tag) \
    int Class<T1>::serializationTag() { return data_feature_utils::getIndexNumType<T1>() + Tag; } \
    int Class<T1>::getSerializationTag() const { return Class<T1>::serializationTag(); }
...
#define IMPLEMENT_SERIALIZABLE_TAG2(Class,T1,T2,Tag) \
    int Class<T1,T2>::serializationTag() { return data_feature_utils::getIndexNumType<T2>() + Tag; } \
    int Class<T1,T2>::getSerializationTag() const { return Class<T1,T2>::serializationTag(); }
