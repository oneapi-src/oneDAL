...
void partition_by_values( __global  algorithmFPType *values,
...
__kernel void quick_select_group(__global  algorithmFPType           *in_values,
                                 __global  int                       *in_indices,
                                 __global  algorithmFPType           *out_values,
                                 __global  int                       *out_indices,
                                 __global  const algorithmFPType     *rnd_seq,
                                 int RndPeriod,
                                 int N,
                                 int NLast,
                                 int K,
...
__kernel void direct_select_group(__global  const algorithmFPType  *values_in,
                                  __global  algorithmFPType  *values_out,
                                  __global int               *indices_out,
                                  int N,
                                  int NL,
                                  int BlockOffset,
                                  algorithmFPType FPMax)
{
    const int local_size    = get_sub_group_size();
