...
COMPILER.mac.clang = clang++ -D__int64="long long" -D__int32="int" -m64 -fgnu-runtime -mmacosx-version-min=10.11
...
p4_OPT.clang   = $(-Q)march=core2
mc_OPT.clang   = $(-Q)march=core2
mc3_OPT.clang  = $(-Q)march=corei7
avx_OPT.clang  = $(-Q)march=corei7-avx
avx2_OPT.clang = $(-Q)march=corei7-avx
knl_OPT.clang  = $(-Q)march=corei7-avx
skx_OPT.clang  = $(-Q)march=corei7-avx
