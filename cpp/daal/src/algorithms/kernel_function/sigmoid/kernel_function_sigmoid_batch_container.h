/* file: kernel_function_sigmoid_batch_container.h */
/*******************************************************************************
...
{
    __DAAL_INITIALIZE_KERNELS(internal::KernelImplSigmoid, method, algorithmFPType);
}
...
services::Status BatchContainer<algorithmFPType, method, cpu>::compute()
{
    ...
    kernelPar.kernelType      = KernelType::sigmoid;

    __DAAL_CALL_KERNEL(env, internal::KernelImplSigmoid, __DAAL_KERNEL_ARGUMENTS(method, algorithmFPType), compute, a[0], a[1], r[0], &kernelPar);
}
