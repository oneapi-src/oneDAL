/* file: kernel_function_types_sigmoid.h */
/*******************************************************************************
...
#ifndef __KERNEL_FUNCTION_TYPES_SIGMOID_H__
#define __KERNEL_FUNCTION_TYPES_SIGMOID_H__
...
enum Method
{
    defaultDense = 0, /*!< Default method for computing sigmoid kernel functions */
