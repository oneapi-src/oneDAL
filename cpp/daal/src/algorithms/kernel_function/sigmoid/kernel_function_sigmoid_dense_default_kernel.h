/* file: kernel_function_sigmoid_dense_default_kernel.h */
/*******************************************************************************
...
#ifndef __KERNEL_FUNCTION_SIGMOID_DENSE_KERNEL_H__
#define __KERNEL_FUNCTION_SIGMOID_DENSE_KERNEL_H__

#include "src/algorithms/kernel_function/kernel_function_dense_base.h"
#include "src/algorithms/kernel_function/sigmoid/kernel_function_sigmoid_base.h"
...
struct KernelImplSigmoid<defaultDense, algorithmFPType, cpu>
