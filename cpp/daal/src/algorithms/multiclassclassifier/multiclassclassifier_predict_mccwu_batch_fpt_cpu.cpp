...
namespace internal
{
template class DAAL_EXPORT MultiClassClassifierPredictKernel<multiClassClassifierWu, training::oneAgainstOne, DAAL_FPTYPE,
                                                             classifier::prediction::Batch, multi_class_classifier::Parameter, DAAL_CPU>;
} // namespace internal
} // namespace prediction
} // namespace multi_class_classifier
} // namespace algorithms
