...
class BatchImpl : public algorithms::engines::mcg59::Batch<algorithmFPType, method>, public algorithms::engines::internal::BatchBaseImpl
{
public:
    typedef algorithms::engines::mcg59::Batch<algorithmFPType, method> super1;
