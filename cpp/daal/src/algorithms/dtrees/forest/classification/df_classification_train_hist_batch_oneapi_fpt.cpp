...
#include "src/algorithms/dtrees/forest/classification/oneapi/df_classification_train_hist_oneapi_impl.i"
...
namespace internal
{
template class DAAL_EXPORT ClassificationTrainBatchKernelOneAPI<DAAL_FPTYPE, hist>;
}
