...
{
protected:
    void computeSquares(const services::Buffer<algorithmFPType> & data, services::internal::sycl::UniversalBuffer & dataSq, uint32_t nRows,
    ...
    void computeAssignments(const services::internal::sycl::UniversalBuffer & assignments, uint32_t blockSize, uint32_t nClusters, services::Status * st);

    void computePartialCandidates(const services::internal::sycl::UniversalBuffer & assignments, uint32_t blockSize, uint32_t nClusters, uint32_t reset,
                                  services::Status * st);

    void mergePartialCandidates(uint32_t nClusters, services::Status * st);

    void partialReduceCentroids(const services::Buffer<algorithmFPType> & data, const services::internal::sycl::UniversalBuffer & assignments,
