/* file: kmeans_dense_lloyd_batch_fpt_dispatcher_v1.cpp */
/*******************************************************************************
...
{
__DAAL_INSTANTIATE_DISPATCH_CONTAINER_SYCL(kmeans::interface1::BatchContainer, batch, DAAL_FPTYPE, kmeans::lloydDense);
} // namespace algorithms
} // namespace daal
