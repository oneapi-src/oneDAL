...
DECLARE_SOURCE_DAAL(
    ...
    __kernel void logLoss(const __global algorithmFPType * const y, const __global algorithmFPType * const sigma, __global algorithmFPType * result) {
    ...
    __kernel void sigmoid(const __global algorithmFPType * const xb, const algorithmFPType expThreshold, const uint calculateInverse,
    ...
    __kernel void hessian(const __global algorithmFPType * const x, const uint ldx, const __global algorithmFPType * const sigma, const uint n,
                          __global algorithmFPType * h, const uint ldh, const uint offset, const algorithmFPType alpha) {
    ...
    __kernel void hessianIntercept(const __global algorithmFPType * const x, const uint ldx, const __global algorithmFPType * const sigma,
                                   const uint n, __global algorithmFPType * h, const uint ldh, const algorithmFPType alpha) {
        const uint row            = get_global_id(0);
        const algorithmFPType one = (algorithmFPType)1.0;
    ...
    __kernel void hessianInterceptH0(const __global algorithmFPType * const sigma, const uint n, __global algorithmFPType * partialSums) {
    ...
    __kernel void hessianRegulization(__global algorithmFPType * h, const uint ldh, const algorithmFPType beta) {
        // not regulated b0
