/* file: mse_dense_default_batch_task_v1_impl.i */
/*******************************************************************************
...
#include "src/algorithms/objective_function/mse/inner/mse_dense_default_batch_kernel_v1.h"
...
I1MSETask<algorithmFPType, cpu>::I1MSETask(NumericTable * data, NumericTable * dependentVariables, NumericTable * argument, NumericTable * value,
                                           NumericTable * hessian, NumericTable * gradient, interface1::Parameter * parameter)
...
template <typename algorithmFPType, CpuType cpu>
Status I1MSETask<algorithmFPType, cpu>::init(algorithmFPType *& pArgumentArray)
{
...
template <typename algorithmFPType, CpuType cpu>
I1MSETask<algorithmFPType, cpu>::~I1MSETask()
{
    ntArgument->releaseBlockOfRows(argumentBlock);
}

template <typename algorithmFPType, CpuType cpu>
Status I1MSETask<algorithmFPType, cpu>::getResultValues(algorithmFPType *& value, algorithmFPType *& gradient, algorithmFPType *& hessian)
{
    Status s;
    if (valueFlag)
    {
...
template <typename algorithmFPType, CpuType cpu>
I1MSETaskAll<algorithmFPType, cpu>::I1MSETaskAll(NumericTable * data, NumericTable * dependentVariables, NumericTable * argument,
...
template <typename algorithmFPType, CpuType cpu>
Status I1MSETaskAll<algorithmFPType, cpu>::init(algorithmFPType *& pArgumentArray)
{
...
template <typename algorithmFPType, CpuType cpu>
I1MSETaskAll<algorithmFPType, cpu>::~I1MSETaskAll()
{}

template <typename algorithmFPType, CpuType cpu>
Status I1MSETaskAll<algorithmFPType, cpu>::getCurrentBlock(size_t startIdx, size_t blockSize, algorithmFPType *& pBlockData,
...
template <typename algorithmFPType, CpuType cpu>
void I1MSETaskAll<algorithmFPType, cpu>::releaseCurrentBlock()
{
...
template <typename algorithmFPType, CpuType cpu>
I1MSETaskSample<algorithmFPType, cpu>::I1MSETaskSample(NumericTable * data, NumericTable * dependentVariables, NumericTable * argument,
                                                       NumericTable * value, NumericTable * hessian, NumericTable * gradient,
                                                       interface1::Parameter * parameter, size_t blockSizeDefault)
    : I1MSETask<algorithmFPType, cpu>(data, dependentVariables, argument, value, hessian, gradient, parameter),
...
template <typename algorithmFPType, CpuType cpu>
Status I1MSETaskSample<algorithmFPType, cpu>::init(algorithmFPType *& pArgumentArray)
{
    Status s = super::init(pArgumentArray);
...
template <typename algorithmFPType, CpuType cpu>
I1MSETaskSample<algorithmFPType, cpu>::~I1MSETaskSample()
{
    ntIndices->releaseBlockOfRows(indicesBlock);
}

template <typename algorithmFPType, CpuType cpu>
Status I1MSETaskSample<algorithmFPType, cpu>::getCurrentBlock(size_t startIdx, size_t blockSize, algorithmFPType *& pBlockData,
                                                              algorithmFPType *& pBlockDependentVariables)
{
    Status s;
...
template <typename algorithmFPType, CpuType cpu>
void I1MSETaskSample<algorithmFPType, cpu>::releaseCurrentBlock()
{}
