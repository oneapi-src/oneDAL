...
struct MklLapack<double, cpu>
{
    ...
    static void xgetrs(char * trans, DAAL_INT * n, DAAL_INT * nrhs, double * a, DAAL_INT * lda, DAAL_INT * ipiv, double * b, DAAL_INT * ldb,
                       DAAL_INT * info)
    {
        __DAAL_MKLFN_CALL(lapack_, dgetrs, (trans, (MKL_INT*)n, (MKL_INT*)nrhs, a, (MKL_INT*)lda, (MKL_INT*)ipiv, b, (MKL_INT*)ldb, (MKL_INT*)info));
    }
    ...
    {
        __DAAL_MKLFN_CALL(lapack_, dpotrf, (uplo, (MKL_INT*)p, ata, (MKL_INT*)ldata, (MKL_INT*)info));
    }
    ...
    {
        __DAAL_MKLFN_CALL(lapack_, dpotrs, (uplo, (MKL_INT*)p, (MKL_INT*)ny, ata, (MKL_INT*)ldata, beta, (MKL_INT*)ldaty, (MKL_INT*)info));
    }
    ...
    {
        __DAAL_MKLFN_CALL(lapack_, dpotri, (uplo, (MKL_INT*)p, ata, (MKL_INT*)ldata, (MKL_INT*)info));
    }
    ...
    {
        __DAAL_MKLFN_CALL(lapack_, dormrq, (side, trans, (MKL_INT*)m, (MKL_INT*)n, (MKL_INT*)k, a, (MKL_INT*)lda, tau, c, (MKL_INT*)ldc, work, (MKL_INT*)lwork, (MKL_INT*)info));
    }
    ...
    static void xtrtrs(char * uplo, char * trans, char * diag, DAAL_INT * n, DAAL_INT * nrhs, double * a, DAAL_INT * lda, double * b, DAAL_INT * ldb,
                       DAAL_INT * info)
    {
        __DAAL_MKLFN_CALL(lapack_, dtrtrs, (uplo, trans, diag, (MKL_INT*)n, (MKL_INT*)nrhs, a, (MKL_INT*)lda, b, (MKL_INT*)ldb, (MKL_INT*)info));
    }
    ...
    static void xpptrf(char * uplo, DAAL_INT * n, double * ap, DAAL_INT * info) { __DAAL_MKLFN_CALL(lapack_, dpptrf, (uplo, (MKL_INT*)n, ap, (MKL_INT*)info)); }

    static void xxpptrf(char * uplo, DAAL_INT * n, double * ap, DAAL_INT * info)
    {
        int old_threads = fpk_serv_set_num_threads_local(1);
        __DAAL_MKLFN_CALL(lapack_, dpptrf, (uplo, (MKL_INT*)n, ap, (MKL_INT*)info));
        fpk_serv_set_num_threads_local(old_threads);
    }
    ...
    {
        __DAAL_MKLFN_CALL(lapack_, dgeqp3, ((MKL_INT*)(&m), (MKL_INT*)(&n), a, (MKL_INT*)(&lda), (MKL_INT*)jpvt, tau, work, (MKL_INT*)(&lwork), (MKL_INT*)info));
    }
    ...
    static void xorgqr(const DAAL_INT m, const DAAL_INT n, const DAAL_INT k, double * a, const DAAL_INT lda, const double * tau, double * work,
                       const DAAL_INT lwork, DAAL_INT * info)
    {
        __DAAL_MKLFN_CALL(lapack_, dorgqr, ((MKL_INT*)(&m), (MKL_INT*)(&n), (MKL_INT*)(&k), a, (MKL_INT*)(&lda), tau, work, (MKL_INT*)(&lwork), (MKL_INT*)info));
    }
    ...
    {
        __DAAL_MKLFN_CALL(lapack_, dgesvd, (&jobu, &jobvt, (MKL_INT*)(&m), (MKL_INT*)(&n), a, (MKL_INT*)(&lda), s, u, (MKL_INT*)(&ldu), vt, (MKL_INT*)(&ldvt), work, (MKL_INT*)(&lwork), (MKL_INT*)info));
    }
    ...
    {
        __DAAL_MKLFN_CALL(lapack_, dsyevd, (jobz, uplo, (MKL_INT*)n, a, (MKL_INT*)lda, w, work, (MKL_INT*)lwork, (MKL_INT*)iwork, (MKL_INT*)liwork, (MKL_INT*)info));
    }
    ...
    static void xormqr(char * side, char * trans, DAAL_INT * m, DAAL_INT * n, DAAL_INT * k, double * a, DAAL_INT * lda, double * tau, double * c,
                       DAAL_INT * ldc, double * work, DAAL_INT * lwork, DAAL_INT * info)
    {
        __DAAL_MKLFN_CALL(lapack_, dormqr, (side, trans, (MKL_INT*)m, (MKL_INT*)n, (MKL_INT*)k, a, (MKL_INT*)lda, tau, c, (MKL_INT*)ldc, work, (MKL_INT*)lwork, (MKL_INT*)info));
    }
...
struct MklLapack<float, cpu>
{
    ...
    static void xgetrs(char * trans, DAAL_INT * n, DAAL_INT * nrhs, float * a, DAAL_INT * lda, DAAL_INT * ipiv, float * b, DAAL_INT * ldb,
                       DAAL_INT * info)
    {
        __DAAL_MKLFN_CALL(lapack_, sgetrs, (trans, (MKL_INT*)n, (MKL_INT*)nrhs, a, (MKL_INT*)lda, (MKL_INT*)ipiv, b, (MKL_INT*)ldb, (MKL_INT*)info));
    }
    ...
    {
        __DAAL_MKLFN_CALL(lapack_, spotrf, (uplo, (MKL_INT*)p, ata, (MKL_INT*)ldata, (MKL_INT*)info));
    }
    ...
    {
        __DAAL_MKLFN_CALL(lapack_, spotrs, (uplo, (MKL_INT*)p, (MKL_INT*)ny, ata, (MKL_INT*)ldata, beta, (MKL_INT*)ldaty, (MKL_INT*)info));
    }
    ...
    {
        __DAAL_MKLFN_CALL(lapack_, spotri, (uplo, (MKL_INT*)p, ata, (MKL_INT*)ldata, (MKL_INT*)info));
    }
    ...
    {
        __DAAL_MKLFN_CALL(lapack_, sormrq, (side, trans, (MKL_INT*)m, (MKL_INT*)n, (MKL_INT*)k, a, (MKL_INT*)lda, tau, c, (MKL_INT*)ldc, work, (MKL_INT*)lwork, (MKL_INT*)info));
    }
    ...
    static void xtrtrs(char * uplo, char * trans, char * diag, DAAL_INT * n, DAAL_INT * nrhs, float * a, DAAL_INT * lda, float * b, DAAL_INT * ldb,
                       DAAL_INT * info)
    {
        __DAAL_MKLFN_CALL(lapack_, strtrs, (uplo, trans, diag, (MKL_INT*)n, (MKL_INT*)nrhs, a, (MKL_INT*)lda, b, (MKL_INT*)ldb, (MKL_INT*)info));
    }
    ...
    static void xpptrf(char * uplo, DAAL_INT * n, float * ap, DAAL_INT * info) { __DAAL_MKLFN_CALL(lapack_, spptrf, (uplo, (MKL_INT*)n, ap, (MKL_INT*)info)); }

    static void xxpptrf(char * uplo, DAAL_INT * n, float * ap, DAAL_INT * info)
    {
        int old_threads = fpk_serv_set_num_threads_local(1);
        __DAAL_MKLFN_CALL(lapack_, spptrf, (uplo, (MKL_INT*)n, ap, (MKL_INT*)info));
        fpk_serv_set_num_threads_local(old_threads);
    }
    ...
    static void xgeqp3(const DAAL_INT m, const DAAL_INT n, float * a, const DAAL_INT lda, DAAL_INT * jpvt, float * tau, float * work,
                       const DAAL_INT lwork, DAAL_INT * info)
    {
        __DAAL_MKLFN_CALL(lapack_, sgeqp3, ((MKL_INT*)(&m), (MKL_INT*)(&n), a, (MKL_INT*)(&lda), (MKL_INT*)jpvt, tau, work, (MKL_INT*)(&lwork), (MKL_INT*)info));
    }
    ...
    static void xorgqr(const DAAL_INT m, const DAAL_INT n, const DAAL_INT k, float * a, const DAAL_INT lda, const float * tau, float * work,
                       const DAAL_INT lwork, DAAL_INT * info)
    {
        __DAAL_MKLFN_CALL(lapack_, sorgqr, ((MKL_INT*)(&m), (MKL_INT*)(&n), (MKL_INT*)(&k), a, (MKL_INT*)(&lda), tau, work, (MKL_INT*)(&lwork), (MKL_INT*)info));
    }
    ...
    {
        __DAAL_MKLFN_CALL(lapack_, sgesvd, (&jobu, &jobvt, (MKL_INT*)(&m), (MKL_INT*)(&n), a, (MKL_INT*)(&lda), s, u, (MKL_INT*)(&ldu), vt, (MKL_INT*)(&ldvt), work, (MKL_INT*)(&lwork), (MKL_INT*)info));
    }
    ...
    {
        __DAAL_MKLFN_CALL(lapack_, ssyevd, (jobz, uplo, (MKL_INT*)n, a, (MKL_INT*)lda, w, work, (MKL_INT*)lwork, (MKL_INT*)iwork, (MKL_INT*)liwork, (MKL_INT*)info));
    }
    ...
    static void xormqr(char * side, char * trans, DAAL_INT * m, DAAL_INT * n, DAAL_INT * k, float * a, DAAL_INT * lda, float * tau, float * c,
                       DAAL_INT * ldc, float * work, DAAL_INT * lwork, DAAL_INT * info)
    {
        __DAAL_MKLFN_CALL(lapack_, sormqr, (side, trans, (MKL_INT*)m, (MKL_INT*)n, (MKL_INT*)k, a, (MKL_INT*)lda, tau, c, (MKL_INT*)ldc, work, (MKL_INT*)lwork, (MKL_INT*)info));
    }
