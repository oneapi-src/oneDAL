...
#define __DAAL_VSLFN_CALL(f_pref, f_name, f_args, errcode) errcode = f_name f_args;
...
struct MklStatistics<double, cpu>
{
                   ...
                   __int64 method)
    {
        ...
        __DAAL_VSLFN_CALL(fpk_vsl_sub_kernel, vsldSSNewTask, (&task, (const MKL_INT*)&nFeatures, (const MKL_INT*)&nVectors, (const MKL_INT*)&dataStorage, data, 0, 0), errcode);
    ...
    static int xSort(double * data, __int64 nFeatures, __int64 nVectors, double * sortedData)
    {
        ...
        __DAAL_VSLFN_CALL(fpk_vsl_sub_kernel, vsldSSNewTask, (&task, (const MKL_INT*)&nFeatures, (const MKL_INT*)&nVectors, (const MKL_INT*)&inputStorage, data, 0, 0), errcode);
        if (errcode)
        {
            return errcode;
        }
        ...
        __DAAL_VSLFN_CALL(fpk_vsl_sub_kernel, vsliSSEditTask, (task, __DAAL_VSL_SS_ED_SORTED_OBSERV_STORAGE, (const MKL_INT*)&outputStorage), errcode);
        if (errcode)
        {
            __DAAL_VSLFN_CALL(fpk_vsl_sub_kernel, vslSSDeleteTask, (&task), errcode);
            return errcode;
...
struct MklStatistics<float, cpu>
{
                   ...
                   __int64 method)
    {
        ...
        __DAAL_VSLFN_CALL(fpk_vsl_sub_kernel, vslsSSNewTask, (&task, (const MKL_INT*)&nFeatures, (const MKL_INT*)&nVectors, (MKL_INT*)&dataStorage, data, 0, 0), errcode);
                           ...
                           __int64 method)
    {
        ...
        __DAAL_VSLFN_CALL(fpk_vsl_sub_kernel, vslsSSNewTask, (&task, (const MKL_INT*)&nFeatures, (const MKL_INT*)&nVectors, (const MKL_INT*)&dataStorage, data, 0, 0), errcode);
        __DAAL_VSLFN_CALL(fpk_vsl_sub_kernel, vslsSSEditTask, (task, __DAAL_VSL_SS_ED_SUM, sum), errcode);
        __DAAL_VSLFN_CALL(fpk_vsl_sub_kernel, vslsSSEditTask, (task, __DAAL_VSL_SS_ED_MEAN, mean), errcode);
    ...
    static int xSort(float * data, __int64 nFeatures, __int64 nVectors, float * sortedData)
    {
        ...
        __DAAL_VSLFN_CALL(fpk_vsl_sub_kernel, vslsSSNewTask, (&task, (const MKL_INT*)&nFeatures, (const MKL_INT*)&nVectors, (const MKL_INT*)&inputStorage, data, 0, 0), errcode);
        if (errcode)
        {
            return errcode;
        }
