...
#define DAAL_DISPATCH_FUNCTION_BY_CPU(func, ...)                                                                            \
    ...
    {                                                                                                                       \
        ...
        DAAL_KERNEL_AVX512_MIC_ONLY_CODE(case daal::CpuType::avx512_mic : func(daal::CpuType::avx2, __VA_ARGS__); break;) \
...
#define DAAL_DISPATCH_FUNCTION_BY_CPU_SAFE(func, ...)                                                                            \
    ...
    {                                                                                                                            \
        ...
        DAAL_KERNEL_AVX512_MIC_ONLY_CODE(case daal::CpuType::avx512_mic : st = func(daal::CpuType::avx2, __VA_ARGS__); break;) \
