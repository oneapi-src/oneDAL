...
inline String getKeyFPType()
{
    ...
    {
        return String(" -D algorithmFPType=float -D algorithmFPType2=float2 -D algorithmFPType4=float4 -D MAX_FPTYPE=FLT_MAX");
    }
    if (IsSameType<algorithmFPType, double>::value)
    {
        return String(" -D algorithmFPType=double -D algorithmFPType2=double2  -D algorithmFPType4=double4 -D MAX_FPTYPE=DBL_MAX");
    }
