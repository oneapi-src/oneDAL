...
#ifndef __SVM_CLASSIFICATION_PREDICT_H__
#define __SVM_CLASSIFICATION_PREDICT_H__
 ...
 *      - \ref regression::prediction::NumericTableInputId  Input Numeric Table objects
 *                                                          for the SVM prediction algorithm
 *      - \ref regression::prediction::ModelInputId         Identifiers of input Model objects
 *                                                          for the SVM prediction algorithm
 *      - \ref regression::prediction::ResultId             Identifiers of prediction results
 *
 * \par References
...
{
public:
    typedef regression::prediction::Batch super;
