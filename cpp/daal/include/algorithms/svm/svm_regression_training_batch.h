/* file: svm_regression_training_batch.h */
/*******************************************************************************
 ...
 *
 *  \par Enumerations
 *      - \ref regression::training::InputId Identifiers of SVM training input objects
 *      - \ref regression::training::ResultId Identifiers of SVM training results
...
{
public:
    typedef regression::training::Batch super;
