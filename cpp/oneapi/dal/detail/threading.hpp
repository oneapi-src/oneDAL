...
#define ONEDAL_PARALLEL_SORT_DECL(TYPE, NAMESUFFIX) \
    ONEDAL_EXPORT void _onedal_parallel_sort_##NAMESUFFIX(TYPE *begin_ptr, TYPE *end_ptr);

ONEDAL_PARALLEL_SORT_DECL(std::int32_t, int32)
ONEDAL_PARALLEL_SORT_DECL(std::uint64_t, uint64)
...
#define ONEDAL_PARALLEL_SORT_SPECIALIZATION(TYPE, NAMESUFFIX)                 \
    template <>                                                               \
    inline ONEDAL_EXPORT void parallel_sort(TYPE *begin_ptr, TYPE *end_ptr) { \
        _onedal_parallel_sort_##NAMESUFFIX(begin_ptr, end_ptr);               \
    }

ONEDAL_PARALLEL_SORT_SPECIALIZATION(std::int32_t, int32)
ONEDAL_PARALLEL_SORT_SPECIALIZATION(std::uint64_t, uint64)
