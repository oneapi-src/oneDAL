...
#define _TE_PAIR_00(x, y) (_TE_GET_0(x), _TE_GET_0(y))
#define _TE_PAIR_01(x, y) (_TE_GET_0(x), _TE_GET_1(y))
#define _TE_PAIR_02(x, y) (_TE_GET_0(x), _TE_GET_2(y))
#define _TE_PAIR_10(x, y) (_TE_GET_1(x), _TE_GET_0(y))
#define _TE_PAIR_11(x, y) (_TE_GET_1(x), _TE_GET_1(y))
#define _TE_PAIR_12(x, y) (_TE_GET_1(x), _TE_GET_2(y))
#define _TE_PAIR_20(x, y) (_TE_GET_2(x), _TE_GET_0(y))
#define _TE_PAIR_21(x, y) (_TE_GET_2(x), _TE_GET_1(y))
#define _TE_PAIR_22(x, y) (_TE_GET_2(x), _TE_GET_2(y))

#define _TE_COMB_11(x, y) _TE_PAIR_00(x, y)
#define _TE_COMB_12(x, y) _TE_PAIR_00(x, y), _TE_PAIR_01(x, y)
#define _TE_COMB_13(x, y) _TE_PAIR_00(x, y), _TE_PAIR_01(x, y), _TE_PAIR_02(x, y)

#define _TE_COMB_21(x, y) \
    _TE_PAIR_00(x, y),    \
    _TE_PAIR_10(x, y)

#define _TE_COMB_22(x, y)                 \
    _TE_PAIR_00(x, y), _TE_PAIR_01(x, y), \
    _TE_PAIR_10(x, y), _TE_PAIR_11(x, y)

#define _TE_COMB_23(x, y)                                    \
    _TE_PAIR_00(x, y), _TE_PAIR_01(x, y), _TE_PAIR_02(x, y), \
    _TE_PAIR_10(x, y), _TE_PAIR_11(x, y), _TE_PAIR_12(x, y)

#define _TE_COMB_31(x, y) \
    _TE_PAIR_00(x, y),    \
    _TE_PAIR_10(x, y),    \
    _TE_PAIR_20(x, y)

#define _TE_COMB_32(x, y)                 \
    _TE_PAIR_00(x, y), _TE_PAIR_01(x, y), \
    _TE_PAIR_10(x, y), _TE_PAIR_11(x, y), \
    _TE_PAIR_20(x, y), _TE_PAIR_21(x, y)

#define _TE_COMB_33(x, y)                                    \
    _TE_PAIR_00(x, y), _TE_PAIR_01(x, y), _TE_PAIR_02(x, y), \
    _TE_PAIR_10(x, y), _TE_PAIR_11(x, y), _TE_PAIR_12(x, y), \
    _TE_PAIR_20(x, y), _TE_PAIR_21(x, y), _TE_PAIR_22(x, y)

#define _TE_COMB_(N, M, x, y) _TE_CONCAT_3(_TE_COMB_, N, M)(x, y)

#define _TE_COMB(x, y) \
    _TE_COMB_(_TE_NARGS(_TE_UNPACK(x)), _TE_NARGS(_TE_UNPACK(y)), x, y)
