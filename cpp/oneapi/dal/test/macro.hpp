...
#define _TS_COMB_21(x, y) _TS_GET_00(x, y), _TS_GET_10(x, y)

#define _TS_COMB_22(x, y) _TS_GET_00(x, y), _TS_GET_01(x, y), _TS_GET_10(x, y), _TS_GET_11(x, y)

#define _TS_COMB_23(x, y)                                                                     \
    _TS_GET_00(x, y), _TS_GET_01(x, y), _TS_GET_02(x, y), _TS_GET_10(x, y), _TS_GET_11(x, y), \
        _TS_GET_12(x, y)

#define _TS_COMB_31(x, y) _TS_GET_00(x, y), _TS_GET_10(x, y), _TS_GET_20(x, y)

#define _TS_COMB_32(x, y)                                                                     \
    _TS_GET_00(x, y), _TS_GET_01(x, y), _TS_GET_10(x, y), _TS_GET_11(x, y), _TS_GET_20(x, y), \
        _TS_GET_21(x, y)

#define _TS_COMB_33(x, y)                                                                     \
    _TS_GET_00(x, y), _TS_GET_01(x, y), _TS_GET_02(x, y), _TS_GET_10(x, y), _TS_GET_11(x, y), \
        _TS_GET_12(x, y), _TS_GET_20(x, y), _TS_GET_21(x, y), _TS_GET_22(x, y)
