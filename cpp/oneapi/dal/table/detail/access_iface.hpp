...
public:
    DEFINE_TEMPLATE_PULL_ROWS_HOST(float)
    DEFINE_TEMPLATE_PULL_ROWS_HOST(double)
    DEFINE_TEMPLATE_PULL_ROWS_HOST(std::int32_t)

#ifdef ONEDAL_DATA_PARALLEL
    DEFINE_TEMPLATE_PULL_ROWS_DPC(float)
    DEFINE_TEMPLATE_PULL_ROWS_DPC(double)
    DEFINE_TEMPLATE_PULL_ROWS_DPC(std::int32_t)
#endif
};
...
public:
    DEFINE_TEMPLATE_PULL_COLUMN_HOST(float)
    DEFINE_TEMPLATE_PULL_COLUMN_HOST(double)
    DEFINE_TEMPLATE_PULL_COLUMN_HOST(std::int32_t)

#ifdef ONEDAL_DATA_PARALLEL
    DEFINE_TEMPLATE_PULL_COLUMN_DPC(float)
    DEFINE_TEMPLATE_PULL_COLUMN_DPC(double)
    DEFINE_TEMPLATE_PULL_COLUMN_DPC(std::int32_t)
#endif
};
...
public:
    DEFINE_TEMPLATE_PUSH_ROWS_HOST(float)
    DEFINE_TEMPLATE_PUSH_ROWS_HOST(double)
    DEFINE_TEMPLATE_PUSH_ROWS_HOST(std::int32_t)

#ifdef ONEDAL_DATA_PARALLEL
    DEFINE_TEMPLATE_PUSH_ROWS_DPC(float)
    DEFINE_TEMPLATE_PUSH_ROWS_DPC(double)
    DEFINE_TEMPLATE_PUSH_ROWS_DPC(std::int32_t)
#endif
};
...
public:
    DEFINE_TEMPLATE_PUSH_COLUMN_HOST(float)
    DEFINE_TEMPLATE_PUSH_COLUMN_HOST(double)
    DEFINE_TEMPLATE_PUSH_COLUMN_HOST(std::int32_t)

#ifdef ONEDAL_DATA_PARALLEL
    DEFINE_TEMPLATE_PUSH_COLUMN_DPC(float)
    DEFINE_TEMPLATE_PUSH_COLUMN_DPC(double)
    DEFINE_TEMPLATE_PUSH_COLUMN_DPC(std::int32_t)
#endif
};
