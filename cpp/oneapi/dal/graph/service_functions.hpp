...
template <typename Graph>
constexpr auto get_vertex_inward_degree(const Graph &graph, vertex_type<Graph> vertex)
    -> vertex_inward_edge_size_type<Graph>;
...
template <typename Graph>
constexpr auto get_vertex_inward_neighbors(const Graph &graph, vertex_type<Graph> vertex)
    -> const_vertex_inward_edge_range_type<Graph>;
...
constexpr auto get_vertex_inward_degree(const Graph &graph, vertex_type<Graph> vertex)
    ...
    return detail::get_vertex_inward_degree_impl(graph, vertex);
}
...
constexpr auto get_vertex_inward_neighbors(const Graph &graph, vertex_type<Graph> vertex)
    ...
    return detail::get_vertex_inward_neighbors_impl(graph, vertex);
}
