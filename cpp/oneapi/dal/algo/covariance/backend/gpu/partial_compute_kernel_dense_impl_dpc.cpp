...
result_t partial_compute_kernel_dense_impl<Float>::operator()(const descriptor_t& desc,
                                                              const input_t& input) {
...
template class partial_compute_kernel_dense_impl<float>;
template class partial_compute_kernel_dense_impl<double>;
} // namespace oneapi::dal::covariance::backend
