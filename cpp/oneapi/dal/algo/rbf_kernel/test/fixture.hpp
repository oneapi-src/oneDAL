...
class rbf_kernel_test : public te::crtp_algo_fixture<TestType, Derived> {
public:
    using Float = std::tuple_element_t<0, TestType>;
    using Method = std::tuple_element_t<1, TestType>;
    using input_t = rbf_kernel::compute_input<>;
    using result_t = rbf_kernel::compute_result<>;
    using descriptor_t = rbf_kernel::descriptor<Float, Method>;
