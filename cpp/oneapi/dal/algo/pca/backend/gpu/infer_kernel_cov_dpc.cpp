...
struct infer_kernel_gpu<Float, method::cov, task::dim_reduction> {
...
template struct infer_kernel_gpu<float, method::cov, task::dim_reduction>;
template struct infer_kernel_gpu<double, method::cov, task::dim_reduction>;
