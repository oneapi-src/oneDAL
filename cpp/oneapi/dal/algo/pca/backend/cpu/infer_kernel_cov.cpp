...
struct infer_kernel_cpu<Float, method::cov, task::dim_reduction> {
...
template struct infer_kernel_cpu<float, method::cov, task::dim_reduction>;
template struct infer_kernel_cpu<double, method::cov, task::dim_reduction>;
