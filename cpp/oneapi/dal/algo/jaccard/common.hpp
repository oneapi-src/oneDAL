...
protected:
    void set_row_range_impl(const std::int64_t& begin, const std::int64_t& end);
    void set_column_range_impl(const std::int64_t& begin, const std::int64_t& end);
...
public:
    ...
    auto& set_row_range(const std::int64_t& begin, const std::int64_t& end) {
    ...
    auto& set_column_range(const std::int64_t& begin, const std::int64_t& end) {
