...
struct train_parameters_cpu<Float, method::newton_cg, Task> {
...
template struct ONEDAL_EXPORT
    train_parameters_cpu<float, method::newton_cg, task::binary_classification>;
template struct ONEDAL_EXPORT
    train_parameters_cpu<double, method::newton_cg, task::binary_classification>;
