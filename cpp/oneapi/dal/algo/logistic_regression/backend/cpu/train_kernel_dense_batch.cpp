...
template struct train_kernel_cpu<float, method::dense_batch, task::binary_classification>;
template struct train_kernel_cpu<double, method::dense_batch, task::binary_classification>;
