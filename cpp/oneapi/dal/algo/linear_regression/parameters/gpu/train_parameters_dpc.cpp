...
ONEDAL_EXPORT template struct train_parameters_gpu<float, method::norm_eq, task::regression>;
ONEDAL_EXPORT template struct train_parameters_gpu<double, method::norm_eq, task::regression>;
