...
struct finalize_train_ops_dispatcher<Policy, Float, Method, Task> {
    ...
    train_parameters<Task> select_parameters(const Policy& ctx,
        ...
        using kernel_dispatcher_t = dal::backend::kernel_dispatcher<
            KERNEL_SINGLE_NODE_CPU(parameters::finalize_train_parameters_cpu<Float, Method, Task>),
            KERNEL_SINGLE_NODE_GPU(parameters::finalize_train_parameters_gpu<Float, Method, Task>)>;
