...
template <typename Cpu>
void order_component_ids_labels(const std::int64_t &vertex_count,
                         std::int64_t &component_count,
                         std::atomic<std::int32_t> *components,
                         std::int32_t *labels) {
    std::int32_t ordered_comp_id = 0;
...
struct afforest {
    vertex_partitioning_result<task::vertex_partitioning> operator()(
        ...
        std::int64_t component_count = 0;
        order_component_ids_labels<Cpu>(vertex_count, component_count, components, labels);
