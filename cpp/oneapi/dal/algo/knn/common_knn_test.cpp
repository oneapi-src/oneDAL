...
TEST(knn_bad_arg_tests, set_class_count) {
    ASSERT_THROW(
        (nn::descriptor<float, nn::task::classification, nn::method::kd_tree>{}.set_class_count(
            -1)),
        dal::domain_error);
    ASSERT_THROW(
        (nn::descriptor<float, nn::task::classification, nn::method::kd_tree>{}.set_class_count(1)),
        dal::domain_error);
    ASSERT_NO_THROW(
        (nn::descriptor<float, nn::task::classification, nn::method::kd_tree>{}.set_class_count(2)),
        dal::domain_error);
    ASSERT_THROW(
        (nn::descriptor<float, nn::task::classification, nn::method::brute_force>{}.set_class_count(
            -1)),
        dal::domain_error);
    ASSERT_THROW(
        (nn::descriptor<float, nn::task::classification, nn::method::brute_force>{}.set_class_count(
...
TEST(knn_bad_arg_tests, set_neighbor_count) {
    ASSERT_THROW(
        (nn::descriptor<float, nn::task::classification, nn::method::kd_tree>{}.set_neighbor_count(
            -1)),
        dal::domain_error);
    ASSERT_THROW(
        (nn::descriptor<float, nn::task::classification, nn::method::kd_tree>{}.set_neighbor_count(
    ...
    ASSERT_NO_THROW(
        (nn::descriptor<float, nn::task::classification, nn::method::kd_tree>{}.set_neighbor_count(
            1)),
        dal::domain_error);
    ASSERT_THROW((nn::descriptor<float, nn::task::classification, nn::method::brute_force>{}
                      .set_neighbor_count(-1)),
                 dal::domain_error);
    ASSERT_THROW((nn::descriptor<float, nn::task::classification, nn::method::brute_force>{}
                      .set_neighbor_count(0)),
                 dal::domain_error);
    ASSERT_NO_THROW((nn::descriptor<float, nn::task::classification, nn::method::brute_force>{}
                         .set_neighbor_count(1)),
                    dal::domain_error);
}
...
TEST(knn_bad_arg_tests, set_train_data_kd_tree) {
    ...
    const auto knn_desc = nn::descriptor<float, nn::task::classification, nn::method::kd_tree>{};
...
TEST(knn_bad_arg_tests, set_train_data_brute_force) {
    ...
    const auto knn_desc =
        nn::descriptor<float, nn::task::classification, nn::method::brute_force>{};
...
TEST(knn_bad_arg_tests, set_infer_data_brute_force) {
    constexpr std::int64_t row_count_train = 6;
    constexpr std::int64_t column_count = 2;
