...
sycl::event distance<Float, cosine_metric<Float>>::operator()(
...
sycl::event distance<Float, cosine_metric<Float>>::operator()(
    ...
    return this->operator()(inp1,
                            inp2,
                            out,
                              inv_norms1_array, inv_norms2_array,
...
#define INSTANTIATE_B(F, A)                                                                       \
    ...
    template std::tuple<ndarray<F, 1>, sycl::event> distance<F, cosine_metric<F>>::get_inversed_norms( \
...
} // namespace oneapi::dal::backend::primitives#define INSTANTIATE(F, A, B)
