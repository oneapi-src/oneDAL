...
template <typename Float>
template<ndorder order1, ndorder order2>
sycl::event distance<Float, squared_l2_metric<Float>>::operator()(const ndview<Float, 2, order1>& inp1,
                                                                  const ndview<Float, 2, order2>& inp2,
                                                                  ndview<Float, 2>& out,
                                                                  const event_vector& deps) const {
...
template sycl::event distance<F, squared_l2_metric<F>>::operator()(                     \
                                                          const ndview<F, 2, A>&,       \
                                                          const ndview<F, 2, B>&,       \
                                                          ndview<F, 2>&,                \
                                                          const ndview<F, 1>&,          \
