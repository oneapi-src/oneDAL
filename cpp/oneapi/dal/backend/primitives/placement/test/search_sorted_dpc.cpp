...
public:
    ...
    void generate() {
        this->m_ = GENERATE(5, 9, 511, 1027);
        this->n_ = GENERATE(511, 512, 513, 1025, 
                            2047, 4097, 8191, 16385);
        this->generate_input();
    }
    ...
    void generate_input() {
        ...
        const auto input_dataframe = GENERATE_DATAFRAME(
            te::dataframe_builder{ 1, this->n_ }.fill_uniform(0.5, 2.5, 7777));
