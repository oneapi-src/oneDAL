...
ONEDAL_EXPORT void _onedal_threader_for_blocked_size(std::size_t count, std::size_t block, const void* a,
                                                     oneapi::dal::preview::functype_blocked_size func) {
    _daal_threader_for_blocked_size(count, block, a, static_cast<daal::functype_blocked_size>(func));
}
