...
#define FUNC_AVX512(...) EXPAND_(FUNC_CPU(avx512, avx512, __VA_ARGS__))
#define FUNC_AVX2(...)   EXPAND_(FUNC_CPU(avx2, avx2, __VA_ARGS__))
#elif defined(TARGET_ARM)
#define FUNC_A8SVE(...) EXPAND_(FUNC_CPU(sve, sve, __VA_ARGS__))
#elif defined(TARGET_RISCV64)
#define FUNC_RV64(...) EXPAND_(FUNC_CPU(rv64, rv64, __VA_ARGS__))
#endif

#ifdef __APPLE__
#define FUNC_SSE42(...) EXPAND_(FUNC_CPU(sse42, avx2, __VA_ARGS__))
#define FUNC_SSE2(...)  EXPAND_(FUNC_CPU(sse2, avx2, __VA_ARGS__))
#else
#define FUNC_SSE42(...) EXPAND_(FUNC_CPU(sse42, sse42, __VA_ARGS__))
#define FUNC_SSE2(...)  EXPAND_(FUNC_CPU(sse2, sse2, __VA_ARGS__))
#endif
...
#define INSTANTIATE_A8SVE(...) EXPAND_(INSTANTIATE_CPU(sve, __VA_ARGS__))
#else
#define INSTANTIATE_A8SVE(...)
#endif

#ifdef ONEDAL_CPU_DISPATCH_AVX512
#define INSTANTIATE_AVX512(...) EXPAND_(INSTANTIATE_CPU(avx512, __VA_ARGS__))
#else
...
#define INSTANTIATE_SSE42(...) EXPAND_(INSTANTIATE_CPU(sse42, __VA_ARGS__))
#else
#define INSTANTIATE_SSE42(...)
#endif

#ifdef ONEDAL_CPU_DISPATCH_RV64
#define INSTANTIATE_RV64(...) EXPAND_(INSTANTIATE_CPU(rv64, __VA_ARGS__))
#else
#define INSTANTIATE_RV64(...)
#endif

#define INSTANTIATE_SSE2(...) EXPAND_(INSTANTIATE_CPU(sse2, __VA_ARGS__))
