   ...
   .. tabs::
      ...
      .. group-tab:: Linux
         ...
         .. code-block:: bash
           ...
           cmake -G "Unix Makefiles⁮" -DEXAMPLES=svm_two_class_thunder #This would generate makefiles for all svm examples matching passed name
      ...
      .. group-tab:: Windows
         ...
         .. code-block:: bash
            ...
            # Navigate to examples directory and build examples
            cd /examples/oneapi/dpc
           cmake  -G "NMake Makefiles" -DEXAMPLES=svm_two_class_thunder #This would generate makefiles for all svm examples matching passed name
