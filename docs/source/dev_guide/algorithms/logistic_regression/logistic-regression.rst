...
.. list-table::
   ...
   * - probabilities
     - Numeric table of size:
       ...
       - :math:`n \times 1`, if nClasses = 2
       - :math:`n \times nClasses`, if nClasses > 2

       containing probabilities of classes computed when computeClassesProbabilities option is enabled. 
       If nClasses = 2, the table contains probabilities of class "1". 
   ...
   * - logProbabilities
     - Numeric table of size: 
       ...
       containing logarithms of classes' probabilities computed when computeClassesLogProbabilities option is enabled. 
       If nClasses = 2, the table contains logarithms probabilities of class "1". 
