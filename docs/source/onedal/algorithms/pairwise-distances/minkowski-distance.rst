...
\ldots, u_n = (u_{n1}, \ldots, u_{nk})` of dimension :math:`k` and :math:`V` of :math:`n`
...
---------------------------
The method defines Minkowski distance metric which would be used inside other algorithms
