...
ONEDAL_PARAM_DISPATCH_SECTION_START(std::string, method) {
    ONEDAL_PARAM_DISPATCH_VALUE("dense", linear_kernel::method::dense)
...
TYPE2STR(linear_kernel::compute_result<linear_kernel::task::compute>, "");
TYPE2STR(linear_kernel::compute_input<linear_kernel::task::compute>, "");
TYPE2STR(dal::detail::host_policy, "");
TYPE2STR(dal::detail::data_parallel_policy, "");

void init_linear_kernel(py::module_& m) {
    using namespace dal::detail;
    using namespace dal::linear_kernel;
