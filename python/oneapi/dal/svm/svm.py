...
class BaseSVM(BaseEstimator, metaclass=ABCMeta):
    ...
    def _get_onedal_params(self, data):
        ...
        return {
            ...
            'max_iteration_count': max_iter, 'scale': self._scale_,
    ...
    def _fit(self, X, y, sample_weight, module):
        ...
        self.n_features_in_ = Xt.column_count
        self.shape_fit_ = (Xt.row_count, Xt.column_count)
    ...
    def _create_model(self, module):
        ...
        if self.svm_type is SVMtype.c_svc or self.svm_type is SVMtype.nu_svc:
            m.first_class_label, m.second_class_label = 0, 1
        return m
    ...
    def _predict(self, X, module):
        ...
        if self.break_ties and self.decision_function_shape == 'ovr' and \
            ...
            y = backend.to_numpy(result.labels)
        return y
