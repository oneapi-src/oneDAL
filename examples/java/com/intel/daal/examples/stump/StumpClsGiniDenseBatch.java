/* file: StumpClsGiniDenseBatch.java */
/*******************************************************************************
...
/**
 * <a name="DAAL-EXAMPLE-JAVA-STUMP_CLS_GINI_DENSE_BATCH">
 * @example StumpClsGiniDenseBatch.java
 */
...
class StumpClsGiniDenseBatch {
    ...
    private static void trainModel() {
        ...
        algorithm.parameter.setSplitCriterion(SplitCriterionId.gini);
    ...
    private static void printResults() {
        ...
        Service.printNumericTables(testGroundTruth, probabilitiesResults,
                                   "Ground truth", "Classification results",
                                   "Stump classification results (first 20 observations):", 20);
    }
}
