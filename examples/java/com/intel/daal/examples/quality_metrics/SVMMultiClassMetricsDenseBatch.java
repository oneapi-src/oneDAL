...
class SVMMultiClassMetricsDenseBatch {
    ...
    private static void trainModel() {
        ...
        TrainingBatch algorithm = new TrainingBatch(context, Float.class, TrainingMethod.oneAgainstOne);
    ...
    private static void testModel() {
        ...
        PredictionBatch algorithm = new PredictionBatch(context, Float.class, PredictionMethod.multiClassClassifierWu);
