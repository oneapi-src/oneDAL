...
## <a name="DAAL-EXAMPLE-PY-ADABOOST_BATCH"></a>
## \example adaboost_dense_batch.py
...
trainDatasetFileName = os.path.join(DAAL_PREFIX, 'batch', 'adaboost_train.csv')

testDatasetFileName = os.path.join(DAAL_PREFIX, 'batch', 'adaboost_test.csv')
...
def printResults():
    printNumericTables(
        ...
        "AdaBoost classification results (first 20 observations):", 20, flt64=False
    )
