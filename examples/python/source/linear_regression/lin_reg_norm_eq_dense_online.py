# file: lin_reg_norm_eq_dense_online.py
#===============================================================================
...
## <a name="DAAL-EXAMPLE-PY-LINEAR_REGRESSION_NORM_EQ_ONLINE"></a>
## \example lin_reg_norm_eq_dense_online.py
...
def trainModel():
    ...
    # Finalize the multiple linear regression model and retrieve the results
