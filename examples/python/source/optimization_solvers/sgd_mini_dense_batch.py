...
#
## <a name="DAAL-EXAMPLE-PY-SGD_MINI_BATCH"></a>
##  \example sgd_mini_dense_batch.py
#
...
if __name__ == "__main__":
    ...
    sgdMiniBatchAlgorithm = optimization_solver.sgd.Batch(mseObjectiveFunction, method=optimization_solver.sgd.miniBatch)

    # Set input objects for the the Stochastic gradient descent algorithm
    sgdMiniBatchAlgorithm.input.setInput(optimization_solver.iterative_solver.inputArgument,
                                         HomogenNumericTable(initialPoint))
    sgdMiniBatchAlgorithm.parameter.learningRateSequence = HomogenNumericTable(1, 1, NumericTableIface.doAllocate,
                                                                               learningRate)
    ...
    res = sgdMiniBatchAlgorithm.compute()
