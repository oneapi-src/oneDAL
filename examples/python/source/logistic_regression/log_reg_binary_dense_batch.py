# file: log_reg_binary_dense_batch.py
#===============================================================================
...
## <a name="DAAL-EXAMPLE-PY-LOG_REG_BINARY_DENSE_BATCH"></a>
## \example log_reg_binary_dense_batch.py
...
trainDatasetFileName = os.path.join(DAAL_PREFIX, 'batch', 'binary_cls_train.csv')
testDatasetFileName = os.path.join(DAAL_PREFIX, 'batch', 'binary_cls_test.csv')
