# file: mn_naive_bayes_dense_online.py
#===============================================================================
...
## <a name="DAAL-EXAMPLE-PY-MULTINOMIAL_NAIVE_BAYES_DENSE_ONLINE"></a>
## \example mn_naive_bayes_dense_online.py
...
def trainModel():
    ...
    algorithm = training.Online(nClasses)
    ...
    trainingResult = algorithm.finalizeCompute()  # Retrieve the algorithm results
