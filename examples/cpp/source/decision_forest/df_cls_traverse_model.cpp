...
int main(int argc, char *argv[])
{
    ...
    services::SharedPtr<training::Result> trainingResult = trainModel();
    printModel(*trainingResult->get(classifier::training::model));
    return 0;
}

services::SharedPtr<training::Result> trainModel()
{
...
class PrintNodeVisitor : public daal::algorithms::decision_forest::classification::NodeVisitor
{
public:
