...
decision_forest::classification::ModelPtr buildModel()
{
    ...
    modelBuilder.addLeafNode(tree1, root1, 1, 4);
    double proba11[]             = { 0.8, 0.1, 0.0, 0.1, 0.0 };
    modelBuilder.addLeafNodeByProba(tree1, root1, 0, proba11);
    ...
    modelBuilder.addLeafNode(tree2, root2, 1, 4);
    modelBuilder.addLeafNode(tree2, root2, 0, 2);
    ...
    modelBuilder.addLeafNodeByProba(tree3, root3, 1, proba32);
    modelBuilder.addLeafNode(tree3, root3, 0, 2);
