...
int main(int argc, char * argv[])
{
    ...
    for (size_t i = 0; i < nParameters; ++i) initialPoint[i] = 0.001f;
    ...
    DAAL_DATA_TYPE expectedPoint[nParameters] = { -2.277f,  2.836f, 14.985f, 0.511f,   7.510f,  -2.831f, -5.814f, -0.033f, 13.227f,
    ...
    printNumericTable(algorithm.getResult()->get(optimization_solver::iterative_solver::minimum), "Resulting coefficients:");
