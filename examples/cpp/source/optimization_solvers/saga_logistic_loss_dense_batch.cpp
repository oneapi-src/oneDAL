...
int main(int argc, char * argv[])
{
    ...
    for (int i = 0; i < nParameters; i++) argument[i] = 0;
    argument[0] = 0;
    argument[1] = 0;
    ...
    sagaAlgorithm.input.set(optimization_solver::iterative_solver::inputArgument, HomogenNumericTable<float>::create(argument, 1, nParameters));
    ...
    FileDataSource<CSVFeatureManager> groundTruthDS(groundTruthFileName, DataSource::notAllocateNumericTable, DataSource::doDictionaryFromContext);
