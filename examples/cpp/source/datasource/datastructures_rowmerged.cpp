...
int main()
{
    ...
    NumericTablePtr table1 (new HomogenNumericTable<>(DictionaryIface::equal, data1, nFeatures, nObservations1));
    NumericTablePtr table2 (new HomogenNumericTable<>(DictionaryIface::equal, data2, nFeatures, nObservations2));
