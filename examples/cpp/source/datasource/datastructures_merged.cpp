...
int main()
{
    ...
    services::SharedPtr<HomogenNumericTable<> > dataTable1(new HomogenNumericTable<>(data1, nFeatures1, nObservations));
    services::SharedPtr<HomogenNumericTable<> > dataTable2(new HomogenNumericTable<>(data2, nFeatures2, nObservations));
