...
void trainModel()
{
    ...
    for(size_t i = 0; i < nBlocks; i++)
    {
        ...
        trainData[i] = services::SharedPtr<CSRNumericTable>(createSparseTable<float>(trainDatasetFileNames[i]));
...
void testModel()
{
    ...
    testData = services::SharedPtr<CSRNumericTable>(createSparseTable<float>(testDatasetFileName));
