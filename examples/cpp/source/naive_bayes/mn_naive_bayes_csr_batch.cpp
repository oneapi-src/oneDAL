...
void trainModel()
{
    ...
    services::SharedPtr<CSRNumericTable> trainData(createSparseTable<float>(trainDatasetFileName));
...
void testModel()
{
    ...
    services::SharedPtr<CSRNumericTable> testData(createSparseTable<float>(testDatasetFileName));
