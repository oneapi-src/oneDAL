...
int main(int argc, char * argv[])
{
    ...
    printTensor3d(forwardResult->get(forward::value), "Forward maximum pooling layer result:");
    printTensor3d(forwardResult->get(maximum_pooling3d::auxSelectedIndices), "Forward maximum pooling layer selected indices:");
    ...
    printTensor3d(backwardResult->get(backward::gradient), "Backward maximum pooling layer result:");
