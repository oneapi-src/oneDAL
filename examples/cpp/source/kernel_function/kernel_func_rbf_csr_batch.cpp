...
int main(int argc, char *argv[])
{
    ...
    services::SharedPtr<CSRNumericTable> leftData(createSparseTable<float>(leftDatasetFileName));
    services::SharedPtr<CSRNumericTable> rightData(createSparseTable<float>(rightDatasetFileName));
