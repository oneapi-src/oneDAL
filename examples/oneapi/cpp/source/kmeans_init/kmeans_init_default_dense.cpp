...
int main(int argc, char const *argv[]) {
    ...
    const auto x_compute_table =
        dal::homogen_table{ x_compute, row_count, column_count, dal::empty_delete<const float>() };
    const auto x_test_table =
        dal::homogen_table{ x_test, cluster_count, column_count, dal::empty_delete<const float>() };
