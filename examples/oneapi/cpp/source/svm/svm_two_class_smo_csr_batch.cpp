...
int main(int argc, char const *argv[]) {
    const auto train_data_file_name = get_data_path("svm_cls_synthetic_3k_train_sparse_data.csv");
    const auto train_response_file_name = get_data_path("svm_cls_synthetic_3k_train_sparse_labels.csv");
    const auto test_data_file_name = get_data_path("svm_cls_synthetic_3k_test_sparse_data.csv");
    const auto test_response_file_name = get_data_path("svm_cls_synthetic_3k_test_sparse_labels.csv");
