...
void run(sycl::queue &queue) {
    ...
    const auto x_table = dal::homogen_table{ queue, row_count_x, column_count, x, dal::make_default_delete<const float>(queue) };
    const auto y_table = dal::homogen_table{ queue, row_count_y, column_count, y, dal::make_default_delete<const float>(queue) };
