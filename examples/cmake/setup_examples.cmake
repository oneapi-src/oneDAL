...
function (add_examples examples_paths)
    foreach(example_file_path ${examples_paths})
        ...
        if (UNIX AND NOT APPLE)
            ONEDAL_link_libraries(${example} PRIVATE -Wl,--start-group ${oneDAL_IMPORTED_TARGETS} -Wl,--end-group)
        else()
            ONEDAL_link_libraries(${example} PRIVATE ${oneDAL_IMPORTED_TARGETS})
        endif()
        target_compile_options(${example} PRIVATE ${ONEDAL_CUSTOM_COMPILE_OPTIONS})
        ONEDAL_link_options(${example} PRIVATE ${ONEDAL_CUSTOM_LINK_OPTIONS})
