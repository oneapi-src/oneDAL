...
/**
 * <a name="DAAL-EXAMPLE-JAVA-DfClsHistDenseBatch">
 * @example DfClsHistDenseBatch.java
 */
...
class DfClsHistDenseBatch {
    ...
    private static TrainingResult trainModel() {
        ...
        TrainingBatch algorithm = new TrainingBatch(context, Float.class, TrainingMethod.hist, nClasses);
