/* file: svm_two_class_a9a_thunder_csr_batch.cpp */
/*******************************************************************************
...
string trainDatasetFileName = "../data/csr_svm_bench/a9a_csr_train.csv";
string trainLabelsFileName  = "../data/csr_svm_bench/a9a_csr_train_label.csv";

string testDatasetFileName = "../data/csr_svm_bench/a9a_csr_train.csv";
string testLabelsFileName  = "../data/csr_svm_bench/a9a_csr_train_label.csv";
...
void trainModel()
{
   ...
   * from a .csv file */
    ...
    auto linearkernel = services::SharedPtr<kernel_function::linear::Batch<float, kernel_function::linear::fastCSR> >(
