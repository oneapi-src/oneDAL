...
const string initDataset = "/nfs/inn/disks/nn-ssg_spd_numerics_users/agorshk/DAAL/tsne/sklearn_tests/X_square_distances_futurewarning.csv";
const string pDataset   = "/nfs/inn/disks/nn-ssg_spd_numerics_users/agorshk/DAAL/tsne/sklearn_tests/P_square_distances_futurewarning.csv";
...
int main(int argc, char * argv[])
{
	...
	int sizeIter[4] = { 5, 20, 300, 1000 }; // nSamples, nnz, nIterWithoutProgress, maxIter
