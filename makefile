...
$(CORE.objs_a): COPT += -D__TBB_NO_IMPLICIT_LINKAGE -DDAAL_NOTHROW_EXCEPTIONS \
                        -DDAAL_HIDE_DEPRECATED -DDAAL_INTERNAL_INTERFACE -DTBB_USE_ASSERT=0
...
$(CORE.objs_y): COPT += -D__DAAL_IMPLEMENTATION -D__TBB_NO_IMPLICIT_LINKAGE -DDAAL_NOTHROW_EXCEPTIONS \
                        -DDAAL_HIDE_DEPRECATED -DDAAL_INTERNAL_INTERFACE \
						$(if $(CHECK_DLL_SIG),-DDAAL_CHECK_DLL_SIG) -DTBB_USE_ASSERT=0
