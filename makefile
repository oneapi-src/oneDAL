...
daaldep.win32e.vml :=
daaldep.win32e.ipp :=
daaldep.win32e.rt.thr  := -LIBPATH:$(RELEASEDIR.tbb.libia) tbb.lib tbbmalloc.lib $(if $(CHECK_DLL_SIG),Wintrust.lib)
daaldep.win32e.rt.seq  := $(if $(CHECK_DLL_SIG),Wintrust.lib)
