...
TBBDIR.libia.win.vc1  := $(if $(OS_is_win),$(if $(wildcard $(call frompf1,$(TBBDIR.libia.prefix))/$(_IA)/vc_14),$(TBBDIR.libia.prefix)/$(_IA)/vc_14),$(if $(wildcard $(call frompf1,$(TBBDIR.libia.prefix))/$(_IA)/vc14),$(TBBDIR.libia.prefix)/$(_IA)/vc14))
...
$(error VC1 is $(TBBDIR.libia.win.vc1))
