...
- Graph Analytics:
  ...
  - Directed graph with and without edge weights (`directed_adjacency_vector_graph`), where vertex indices can only be of type int32, edge weights can be int32 and double
