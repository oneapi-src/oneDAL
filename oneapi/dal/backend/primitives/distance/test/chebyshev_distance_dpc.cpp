...
class chebyshev_distance_test_random : public te::float_algo_fixture<Float> {
public:
    void generate() {
    ...
    void test_distance() {
        ...
        chebyshev_distance<Float> distance(this->get_queue());
...
TEMPLATE_LIST_TEST_M(chebyshev_distance_test_random,
                     "Randomly filled chebyshev-distance computation",
                     "[chebyshev][distance][small]",
                     distance_types) {
