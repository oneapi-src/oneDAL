...
services::Status BatchContainer<algorithmFPType, method, cpu>::compute()
{
    ...
    __DAAL_CALL_KERNEL(env, internal::ZScoreKernel, __DAAL_KERNEL_ARGUMENTS(algorithmFPType, defaultDense),
                       compute, *inputTable, *resultTable, *resultMeans, *resultVariances, internalPar);
    }
    else
    {
    ...
    __DAAL_CALL_KERNEL(env, internal::ZScoreKernel, __DAAL_KERNEL_ARGUMENTS(algorithmFPType, sumDense),
                       compute, *inputTable, *resultTable, *resultMeans, *resultVariances, internalPar);
    }
}
} // interface 2
