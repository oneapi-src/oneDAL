...
protected:
    Status initializeBase(Tensor * data, Model * nnModel, const KeyValueDataCollectionPtr & groundTruthCollectionPtr,
                          const neural_networks::training::Parameter * parameter);

    Status computeBase(Tensor * data, Model * model, const KeyValueDataCollectionPtr & groundTruthCollectionPtr);
...
{
public:
    Status initialize(Tensor * data, Model * nnModel, const KeyValueDataCollectionPtr & groundTruthCollectionPtr,
                      const neural_networks::training::Parameter * parameter);
...
public:
    ...
    Status compute(Tensor * data, Model * nnModel, const KeyValueDataCollectionPtr & groundTruthCollectionPtr, PartialResult * partialResult,
                   const neural_networks::training::Parameter * parameter);
