...
services::Status DistributedContainer<step1Local, algorithmFPType, method, cpu>::compute()
{
    ...
    __DAAL_CALL_KERNEL(env, internal::TrainingKernelDistributed, __DAAL_KERNEL_ARGUMENTS(algorithmFPType, method), compute, data, nnModel,
                       groundTruthCollectionPtr, partialResult, parameter);
}
...
services::Status DistributedContainer<step1Local, algorithmFPType, method, cpu>::setupCompute()
{
    ...
    __DAAL_CALL_KERNEL(env, internal::TrainingKernelDistributed, __DAAL_KERNEL_ARGUMENTS(algorithmFPType, method), initialize, data, nnModel,
...
services::Status DistributedContainer<step2Master, algorithmFPType, method, cpu>::compute()
{
    ...
    __DAAL_CALL_KERNEL(env, internal::TrainingKernelDistributedStep2, __DAAL_KERNEL_ARGUMENTS(algorithmFPType, method), compute, collection,
                       parameter, nnModel);
}
