...
#include "algorithms/kernel/neural_networks/layers/concat_layer/backward/concat_layer_backward_kernel.h"
...
services::Status BatchContainer<algorithmFPType, method, cpu>::compute()
{
    ...
    __DAAL_CALL_KERNEL(env, internal::ConcatKernel, __DAAL_KERNEL_ARGUMENTS(algorithmFPType, method), compute, inputTensor, forwardOutputTable,
                       parameter, resultTensors);
}
} // namespace interface1
} // namespace backward
