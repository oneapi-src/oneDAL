...
services::Status LCNKernel<algorithmFPType, method, cpu>::initialize(Tensor *inputTensor, Tensor *cTensor, Tensor *invMaxTensor,
...
template<typename algorithmFPType, Method method, CpuType cpu>
services::Status LCNKernel<algorithmFPType, method, cpu>::compute(Tensor *inputTensor,  Tensor *sigmaTensor, Tensor *cTensor, Tensor *resultTensor, Tensor *centeredDataTensor,
