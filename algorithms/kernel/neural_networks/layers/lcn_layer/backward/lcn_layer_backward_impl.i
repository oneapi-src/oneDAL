...
template<typename algorithmFPType, Method method, CpuType cpu>
services::Status LCNKernel<algorithmFPType, method, cpu>::initialize(Tensor *auxCenteredDataTensor, Tensor *auxSigmaTensor, Tensor *auxCTensor,
...
*/
template<typename algorithmFPType, Method method, CpuType cpu>
services::Status LCNKernel<algorithmFPType, method, cpu>::compute(Tensor *auxCenteredDataTensor, Tensor *auxSigmaTensor, Tensor *auxCTensor,
                                                      ...
                                                      Tensor *gradientTensor, const lcn::Parameter *parameter)
{
    ...
    __DAAL_MAKE_TENSOR_THREADSAFE(inGradTensor)
    __DAAL_MAKE_TENSOR_THREADSAFE(auxCenteredDataTensor)
    __DAAL_MAKE_TENSOR_THREADSAFE(gradientTensor)
    __DAAL_MAKE_TENSOR_THREADSAFE(auxSigmaTensor)
    __DAAL_MAKE_TENSOR_THREADSAFE(auxInvMaxTensor)
...
template<typename algorithmFPType, Method method, CpuType cpu>
services::Status LCNKernel<algorithmFPType, method, cpu>::reset()
{
    dataDims.clear();
    kernelDims.clear();
    sigmaDims.clear();
