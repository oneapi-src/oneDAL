...
Status ELUKernel<algorithmFPType, method, cpu>::compute(const Parameter & parameter, const Tensor & dataTensor, Tensor & valueTensor,
...
template <typename algorithmFPType, Method method, CpuType cpu>
Status ELUKernel<algorithmFPType, method, cpu>::computeLayoutAgnostic(const Tensor & dataTensor, Tensor & valueTensor, Tensor * auxValueTensor,
                                                                      algorithmFPType alpha)
{
    ...
    if (auxValueTensor)
    {
        ...
        computeInRawLayout(dataBlock.get(), valueBlock.get(), auxValueBlock.get(), alpha, dataTensor.getSize());
    }
    else
    {
        computeInRawLayoutPrediction(dataBlock.get(), valueBlock.get(), alpha, dataTensor.getSize());
    }
...
template <typename algorithmFPType, Method method, CpuType cpu>
Status ELUKernel<algorithmFPType, method, cpu>::computeInMKLLayout(const Tensor & dataTensor, Tensor & valueTensor, Tensor * auxValueTensor,
                                                                   algorithmFPType alpha)
{
...
template <typename algorithmFPType, Method method, CpuType cpu>
void ELUKernel<algorithmFPType, method, cpu>::computeInRawLayout(const algorithmFPType * data, algorithmFPType * value, algorithmFPType * auxValue,
                                                                 algorithmFPType alpha, size_t dataSize)
{
    elu::internal::computeThreaded<algorithmFPType, cpu>(
        dataSize, [&](size_t offset, size_t blockSize) { computeBlock(data + offset, value + offset, auxValue + offset, alpha, blockSize); });
}

template <typename algorithmFPType, Method method, CpuType cpu>
void ELUKernel<algorithmFPType, method, cpu>::computeInRawLayoutPrediction(const algorithmFPType * data, algorithmFPType * value,
                                                                           algorithmFPType alpha, size_t dataSize)
{
    elu::internal::computeThreaded<algorithmFPType, cpu>(
        dataSize, [&](size_t offset, size_t blockSize) { computeBlockPrediction(data + offset, value + offset, alpha, blockSize); });
}

template <typename algorithmFPType, Method method, CpuType cpu>
void ELUKernel<algorithmFPType, method, cpu>::computeBlock(const algorithmFPType * data, algorithmFPType * value, algorithmFPType * auxValue,
...
template <typename algorithmFPType, Method method, CpuType cpu>
void ELUKernel<algorithmFPType, method, cpu>::computeBlockPrediction(const algorithmFPType * data, algorithmFPType * value, algorithmFPType alpha,
                                                                     size_t blockSize)
{
