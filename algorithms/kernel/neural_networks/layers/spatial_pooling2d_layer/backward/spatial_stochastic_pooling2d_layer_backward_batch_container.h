...
services::Status BatchContainer<algorithmFPType, defaultDense, cpu>::compute()
{
    ...
    __DAAL_CALL_KERNEL(env, spatial_pooling2d::backward::internal::PoolingKernel,
                       __DAAL_KERNEL_ARGUMENTS(algorithmFPType, spatial_pooling2d::internal::stochastic), compute, *inputGradTensor, *gradTensor,
