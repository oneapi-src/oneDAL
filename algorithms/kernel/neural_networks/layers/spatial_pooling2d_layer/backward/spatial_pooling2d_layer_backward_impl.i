...
services::Status DAAL_EXPORT BasePoolingKernel<algorithmFPType, cpu>::compute(Tensor *inputGradientTensor, Tensor *gradientTensor, NumericTable *inputDimensions,
...
void DAAL_EXPORT PoolingKernel<algorithmFPType, spatial_pooling2d::internal::maximum, cpu>::computePooling(BasePoolingTask<algorithmFPType, cpu> *taskBase)
{
    ...
    backwardMaxPoolLayer.input.set(layers::backward::inputFromForward, LayerDataPtr(new LayerData()));
    ...
    maximum_pooling2d::backward::ResultPtr maxPoolingResult(new maximum_pooling2d::backward::Result());
...
void DAAL_EXPORT PoolingKernel<algorithmFPType, spatial_pooling2d::internal::average, cpu>::computePooling(BasePoolingTask<algorithmFPType, cpu> *taskBase)
{
    ...
    backwardAveragePoolLayer.input.set(layers::backward::inputFromForward, LayerDataPtr(new LayerData()));
    ...
    average_pooling2d::backward::ResultPtr averagePoolingResult(new average_pooling2d::backward::Result());
...
void DAAL_EXPORT PoolingKernel<algorithmFPType, spatial_pooling2d::internal::stochastic, cpu>::computePooling(BasePoolingTask<algorithmFPType, cpu> *taskBase)
{
    ...
    backwardStochasticPoolLayer.input.set(layers::backward::inputFromForward, LayerDataPtr(new LayerData()));
    ...
    stochastic_pooling2d::backward::ResultPtr stochasticPoolingResult(new stochastic_pooling2d::backward::Result());
