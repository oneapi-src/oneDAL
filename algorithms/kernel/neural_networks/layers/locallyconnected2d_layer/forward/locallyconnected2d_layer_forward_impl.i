...
services::Status LocallyConnected2dKernel<algorithmFPType, method, cpu>::compute(const Tensor & inputTensor, const Tensor & weightsTensor,
                                                                                 const Tensor & biasesTensor, Tensor & valueTensor,
