...
services::Status Input::check(const daal::algorithms::Parameter * parameter, int method) const
{
    ...
    DAAL_CHECK_EX(dataDims[algParameter->groupDimension] % algParameter->nGroups == 0 || algParameter->nKernels % algParameter->nGroups == 0,
                  ErrorIncorrectParameter, ParameterName, nGroupsStr());
