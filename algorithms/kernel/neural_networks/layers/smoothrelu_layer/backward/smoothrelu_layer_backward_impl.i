...
services::Status SmoothReLUKernel<algorithmFPType, method, cpu>::compute(Tensor *inputTensor, Tensor *forwardValueTensor, Tensor *resultTensor)
{
    __DAAL_MAKE_TENSOR_THREADSAFE(forwardValueTensor)
