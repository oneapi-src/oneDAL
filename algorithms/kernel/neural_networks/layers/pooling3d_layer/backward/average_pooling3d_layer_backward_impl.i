...
services::Status PoolingKernel<algorithmFPType, method, cpu>::compute(const Tensor & inputTensor, const average_pooling3d::Parameter & parameter,
                                                                      Tensor & gradTensor)
{
...
void PoolingKernel<algorithmFPType, method, cpu>::recurrentCompute(size_t d, DAAL_INT * ii, DAAL_INT * ik, DAAL_INT * iv, const DAAL_INT * padding,
                                                                   ...
                                                                   algorithmFPType gradMultiplier)
{
    const algorithmFPType zero = 0.0;
    if (d < nKernelDims)
    {
