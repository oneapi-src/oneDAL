...
{
public:
    services::Status compute(Tensor *inputGradientTable, Tensor *maskTable, Tensor *resultTable, const dropout::Parameter *parameter);

private:
    const size_t _nRowsInBlock = 5000;

    inline services::Status processBlock(Tensor *inputTable,
                                         Tensor *maskTable,
