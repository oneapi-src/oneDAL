...
services::Status BatchContainer<algorithmFPType, method, cpu>::compute()
{
    ...
    __DAAL_CALL_KERNEL(env, internal::Convolution2dKernel, __DAAL_KERNEL_ARGUMENTS(algorithmFPType, method), compute, inputTensor, wTensor, bTensor,
...
services::Status BatchContainer<algorithmFPType, method, cpu>::setupCompute()
{
    ...
    __DAAL_CALL_KERNEL(env, internal::Convolution2dKernel, __DAAL_KERNEL_ARGUMENTS(algorithmFPType, method), initialize, inDimsFull, wDims,
                       *parameter, outDimsFull);
}
