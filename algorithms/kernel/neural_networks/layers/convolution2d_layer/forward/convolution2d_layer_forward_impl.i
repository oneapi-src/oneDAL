...
services::Status Convolution2dKernel<algorithmFPType, method, cpu>::initialize(const services::Collection<size_t>& inDimsFull, const services::Collection<size_t>& wDims,
...
template<typename algorithmFPType, Method method, CpuType cpu>
services::Status Convolution2dKernel<algorithmFPType, method, cpu>::compute(Tensor *inputTensor, Tensor *wTensor, Tensor *bTensor,
