...
services::Status Convolution2dKernel<algorithmFPType, method, cpu>::initialize(bool resultFlag, bool wDerFlag, bool bDerFlag)
{
...
template<typename algorithmFPType, Method method, CpuType cpu>
services::Status Convolution2dKernel<algorithmFPType, method, cpu>::compute(Tensor *inGradTensor, Tensor *xTensor, Tensor *wTensor,
