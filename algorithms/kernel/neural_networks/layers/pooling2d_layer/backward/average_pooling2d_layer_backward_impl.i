...
services::Status PoolingKernel<algorithmFPType, method, cpu>::initialize(const services::Collection<size_t>& inDims, const average_pooling2d::Parameter *parameter,
...
template<typename algorithmFPType, Method method, CpuType cpu>
services::Status PoolingKernel<algorithmFPType, method, cpu>::compute(Tensor *inputGradTensor, const average_pooling2d::Parameter *parameter, Tensor *gradTensor, Tensor *dataTensor)
{
    ...
    else
    {
        ...
        inputGradTensor->getSubtensor(0, 0, 0, inputGradDims[0], readOnly, inputBlock);
        ...
        inputGradTensor->releaseSubtensor(inputBlock);
