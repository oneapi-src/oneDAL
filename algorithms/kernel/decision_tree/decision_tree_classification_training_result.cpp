 ...
 */
daal::algorithms::decision_tree::classification::interface1::ModelPtr Result::get(classifier::training::ResultId id) const
{
    return services::staticPointerCast<daal::algorithms::decision_tree::classification::interface1::Model,
