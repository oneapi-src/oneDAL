/* file: adaboost_predict_batch_v1.cpp */
/*******************************************************************************
 ...
 * \return          %Input object that corresponds to the given identifier
 */
adaboost::interface1::ModelPtr Input::get(classifier::prediction::ModelInputId id) const
{
    return staticPointerCast<adaboost::interface1::Model, SerializationIface>(Argument::get(id));
}
