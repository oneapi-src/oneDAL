...
services::Status RidgeRegressionTrainDistributedKernel<algorithmFpType, training::normEqDense, cpu>::compute(
...
template <typename algorithmFpType, CpuType cpu>
services::Status RidgeRegressionTrainDistributedKernel<algorithmFpType, training::normEqDense, cpu>::finalizeCompute(
