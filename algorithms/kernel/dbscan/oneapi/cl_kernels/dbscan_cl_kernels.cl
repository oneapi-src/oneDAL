...
DECLARE_SOURCE(
    ...
    __kernel void point_distances(__global const algorithmFPType * data, __global algorithmFPType * dist, int row_id, int power, int dim,
                                  int num_points) {
    ...
    __kernel void queue_block_distances(__global const algorithmFPType * data, __global const int * queue, __global algorithmFPType * dist,
    ...
    __kernel void count_neighbors(__global const int * assignments, __global const algorithmFPType * data, int row_id, int chunk_offset,
    ...
    __kernel void push_to_queue(__global const algorithmFPType * distances, __global const int * offsets, __global int * assignments,
                                __global int * queue, int queue_end, int row_id, int cluster_id, int chunk_offset, int chunk_size,
