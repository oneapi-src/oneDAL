...
services::Status BatchContainer<algorithmFPType, method, cpu>::compute()
{
    ...
    const multinomial_naive_bayes::interface1::Parameter * par = static_cast<multinomial_naive_bayes::interface1::Parameter *>(_par);
...
services::Status OnlineContainer<algorithmFPType, method, cpu>::compute()
{
    ...
    const multinomial_naive_bayes::interface2::Parameter * par = static_cast<multinomial_naive_bayes::interface2::Parameter *>(_par);
    daal::services::Environment::env & env                     = *_env;
