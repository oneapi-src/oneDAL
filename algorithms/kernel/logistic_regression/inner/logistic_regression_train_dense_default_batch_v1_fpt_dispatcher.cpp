...
{
__DAAL_INSTANTIATE_DISPATCH_CONTAINER(logistic_regression::training::interface1::BatchContainer, batch, DAAL_FPTYPE, logistic_regression::training::defaultDense)
