/* file: logistic_regression_train_container_v2.h */
/*******************************************************************************
...
#include "logistic_regression_train_kernel_v2.h"
...
{
    __DAAL_INITIALIZE_KERNELS(internal::I2TrainBatchKernel, algorithmFPType, method);
}
...
services::Status BatchContainer<algorithmFPType, method, cpu>::compute()
{
    ...
    const logistic_regression::training::interface2::Parameter * par = static_cast<logistic_regression::training::interface2::Parameter *>(_par);
    daal::services::Environment::env & env                           = *_env;
    __DAAL_CALL_KERNEL(env, internal::I2TrainBatchKernel, __DAAL_KERNEL_ARGUMENTS(algorithmFPType, method), compute,
...
services::Status BatchContainer<algorithmFPType, method, cpu>::setupCompute()
{
    ...
    logistic_regression::training::interface2::Parameter * par = static_cast<logistic_regression::training::interface2::Parameter *>(_par);
