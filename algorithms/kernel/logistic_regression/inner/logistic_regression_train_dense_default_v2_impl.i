/* file: logistic_regression_train_dense_default_v2_impl.i */
/*******************************************************************************
...
#ifndef __LOGISTIC_REGRESSION_TRAIN_DENSE_DEFAULT_V2_IMPL_I__
#define __LOGISTIC_REGRESSION_TRAIN_DENSE_DEFAULT_V2_IMPL_I__
...
services::Status I2TrainBatchKernel<algorithmFPType, method, cpu>::compute(const HostAppIfacePtr & pHost, const NumericTablePtr & x,
                                                                           const NumericTablePtr & y, logistic_regression::Model & m, Result & res,
                                                                           const interface2::Parameter & par)
{
