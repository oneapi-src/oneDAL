/* file: sgd_dense_momentum_v1_impl.i */
/*******************************************************************************
...
#ifndef __SGD_DENSE_MOMENTUM_IMPL_V1_I__
...
services::Status I1SGDKernel<algorithmFPType, momentum, cpu>::compute(HostAppIface * pHost, NumericTable * inputArgument, NumericTable * minimum,
                                                                      NumericTable * nProceededIterationsNT,
                                                                      interface1::Parameter<momentum> * parameter,
                                                                      ...
                                                                      engines::BatchBase & engine)
{
    ...
    sum_of_functions::interface1::BatchPtr function = parameter->function;

    const size_t nTerms = function->sumOfFunctionsParameter->numberOfTerms;
    I1SGDmomentumTask<algorithmFPType, cpu> task(
...
template <typename algorithmFPType, CpuType cpu>
services::Status I1SGDmomentumTask<algorithmFPType, cpu>::makeStep(NumericTable * gradient, NumericTable * minimum, NumericTable * pastUpdate,
...
template <typename algorithmFPType, CpuType cpu>
I1SGDmomentumTask<algorithmFPType, cpu>::~I1SGDmomentumTask()
{
...
template <typename algorithmFPType, CpuType cpu>
I1SGDmomentumTask<algorithmFPType, cpu>::I1SGDmomentumTask(size_t batchSize_, size_t nTerms_, NumericTable * resultTable,
...
I1SGDmomentumTask<algorithmFPType, cpu>::I1SGDmomentumTask(size_t batchSize_, size_t nTerms_, NumericTable * resultTable,
                                                           NumericTable * batchIndicesTable, NumericTable * pastUpdateResult,
                                                           NumericTable * lastIterationResultNT, interface1::Parameter<momentum> * parameter)
    : batchSize(batchSize_),
      nTerms(nTerms_),
      minimimWrapper(resultTable, EmptyDeleter()),
      pastUpdate(pastUpdateResult, EmptyDeleter()),
...
template <typename algorithmFPType, CpuType cpu>
Status I1SGDmomentumTask<algorithmFPType, cpu>::init(NumericTable * batchIndicesTable, NumericTable * resultTable, Parameter<momentum> * parameter,
...
template <typename algorithmFPType, CpuType cpu>
Status I1SGDmomentumTask<algorithmFPType, cpu>::init(NumericTable * batchIndicesTable, NumericTable * resultTable,
                                                     interface1::Parameter<momentum> * parameter, NumericTable * pastUpdateInput,
