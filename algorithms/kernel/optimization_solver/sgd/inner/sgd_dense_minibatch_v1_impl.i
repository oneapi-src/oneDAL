/* file: sgd_dense_minibatch_v1_impl.i */
/*******************************************************************************
...
#ifndef __SGD_DENSE_MINIBATCH_V1_IMPL_I__
...
services::Status I1SGDKernel<algorithmFPType, miniBatch, cpu>::compute(HostAppIface * pHost, NumericTable * inputArgument, NumericTable * minimum,
                                                                       NumericTable * nIterations, interface1::Parameter<miniBatch> * parameter,
                                                                       ...
                                                                       engines::BatchBase & engine)
{
    ...
    if (nIter == 0 || L == 0)
    {
        I1SGDMiniBatchTask<algorithmFPType, cpu> task(argumentSize, minimum, inputArgument, nIterations);
        DAAL_CHECK_STATUS(s, task.init(inputArgument));
        task.nProceededIterations[0] = 0;
        return Status();
    }

    SharedPtr<sum_of_functions::interface1::Batch> function = parameter->function;
    ...
    I1SGDMiniBatchTask<algorithmFPType, cpu> task(
...
template <typename algorithmFPType, CpuType cpu>
void I1SGDMiniBatchTask<algorithmFPType, cpu>::makeStep(const algorithmFPType * gradient, algorithmFPType learningRate, algorithmFPType consCoeff,
                                                        size_t argumentSize)
{
...
template <typename algorithmFPType, CpuType cpu>
I1SGDMiniBatchTask<algorithmFPType, cpu>::I1SGDMiniBatchTask(size_t argumentSize_, NumericTable * resultTable, NumericTable * startValueTable,
...
template <typename algorithmFPType, CpuType cpu>
services::Status I1SGDMiniBatchTask<algorithmFPType, cpu>::init(NumericTable * startValueTable)
{
...
template <typename algorithmFPType, CpuType cpu>
I1SGDMiniBatchTask<algorithmFPType, cpu>::~I1SGDMiniBatchTask()
{
...
template <typename algorithmFPType, CpuType cpu>
Status I1SGDMiniBatchTask<algorithmFPType, cpu>::setStartValue(NumericTable * startValueTable)
{
...
template <typename algorithmFPType, CpuType cpu>
I1SGDMiniBatchTask<algorithmFPType, cpu>::I1SGDMiniBatchTask(size_t batchSize_, size_t argumentSize_, size_t nIter_, size_t nTerms_,
...
template <typename algorithmFPType, CpuType cpu>
Status I1SGDMiniBatchTask<algorithmFPType, cpu>::init(NumericTable * startValueTable, NumericTable * learningRateSequenceTable,
