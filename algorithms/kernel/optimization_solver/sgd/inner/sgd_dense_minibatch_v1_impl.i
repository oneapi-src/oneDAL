...
Status I1SGDMiniBatchTask<algorithmFPType, cpu>::setStartValue(NumericTable *startValueTable)
{
    ...
    int result = daal::services::internal::daal_memcpy_s(mtWorkValue.get(), argumentSize * sizeof(algorithmFPType), mtStartValue.get(), argumentSize * sizeof(algorithmFPType));
