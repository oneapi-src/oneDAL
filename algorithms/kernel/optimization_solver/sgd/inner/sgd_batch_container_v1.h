...
#ifndef __SGD_BATCH_CONTAINER_V1_H__
#define __SGD_BATCH_CONTAINER_V1_H__

#include "sgd_batch.h"
#include "sgd_dense_default_kernel_v1.h"
...
{
    __DAAL_INITIALIZE_KERNELS(internal::I1SGDKernel, algorithmFPType, method);
}
...
services::Status BatchContainer<algorithmFPType, method, cpu>::compute()
{
    ...
    __DAAL_CALL_KERNEL(env, internal::I1SGDKernel, __DAAL_KERNEL_ARGUMENTS(algorithmFPType, method), compute,
                       daal::services::internal::hostApp(*input), inputArgument, minimum, nIterations, parameter, learningRateSequence, batchIndices,
                       optionalArgument, optionalResult, *parameter->engine);
}
