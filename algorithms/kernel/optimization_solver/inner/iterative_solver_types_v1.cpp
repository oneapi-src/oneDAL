...
Parameter::Parameter(const sum_of_functions::interface1::BatchPtr & function_, const size_t nIterations_, const double accuracyThreshold_,
                     bool optionalResultReq, size_t batchSize_)
