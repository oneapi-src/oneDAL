/* file: adagrad_dense_default_v1_impl.i */
/*******************************************************************************
...
#ifndef __ADAGRAD_DENSE_DEFAULT_V1_IMPL_I__
#define __ADAGRAD_DENSE_DEFAULT_V1_IMPL_I__
...
services::Status I1AdagradKernel<algorithmFPType, method, cpu>::initAccumulatedGrad(algorithmFPType *accumulatedG, size_t nRows, NumericTable *pOptInput)
{
    if(pOptInput)
    {
 ...
 */
template<typename algorithmFPType, Method method, CpuType cpu>
services::Status I1AdagradKernel<algorithmFPType, method, cpu>::compute(HostAppIface* pHost,
    ...
    OptionalArgument *optionalArgument, OptionalArgument *optionalResult, interface1::Parameter *parameter, engines::BatchBase &engine)
{
    ...
    DAAL_CHECK(nIter <= INT_MAX, ErrorAdagradIncorrectMaxNumberOfIterations)
