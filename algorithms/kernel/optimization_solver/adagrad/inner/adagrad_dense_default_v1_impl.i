...
services::Status I1AdagradKernel<algorithmFPType, method, cpu>::initAccumulatedGrad(algorithmFPType * accumulatedG, size_t nRows,
 ...
 */
template <typename algorithmFPType, Method method, CpuType cpu>
services::Status I1AdagradKernel<algorithmFPType, method, cpu>::compute(HostAppIface * pHost, NumericTable * inputArgument, NumericTable * minimum,
                                                                        ...
                                                                        OptionalArgument * optionalResult, interface1::Parameter * parameter,
