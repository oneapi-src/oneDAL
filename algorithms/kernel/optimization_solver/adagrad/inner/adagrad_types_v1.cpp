...
Parameter::Parameter(const sum_of_functions::interface1::BatchPtr & function_, size_t nIterations_, double accuracyThreshold_,
    ...
    :
      ...
      optimization_solver::iterative_solver::interface1::Parameter(function_, nIterations_, accuracyThreshold_, false, batchSize_),
