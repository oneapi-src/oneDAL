/* file: saga_dense_default_v1_impl.i */
/*******************************************************************************
...
services::Status I1SagaKernel<algorithmFPType, method, cpu>::compute(HostAppIface* pHost,
    ...
    interface1::Parameter *parameter, engines::BatchBase &engine)
{
    ...
    sum_of_functions::interface1::BatchPtr get_auto_step = function->clone();
    ...
    sum_of_functions::interface1::BatchPtr proximaProjection = function->clone();
