...
Parameter::Parameter(const SolverPtr & solver)
    : linear_model::Parameter(),
      penaltyL1(new HomogenNumericTable<double>(1, 1, NumericTableIface::doAllocate, 0.5)),
      penaltyL2(new HomogenNumericTable<double>(1, 1, NumericTableIface::doAllocate, 0.5)),
