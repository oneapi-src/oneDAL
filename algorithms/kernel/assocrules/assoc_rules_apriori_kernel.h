...
protected:
   ...
   */
    ...
    /** Generate candidate itemsets of size iset_size+1 from "large" itemsets of
   * size iset_size */
    ...
    /** Generate all subsets of size iset_size from a transaction and hash those
     subsets
      using hash tree of candidate itemsets C_tree to increment support values
     of candidates */
