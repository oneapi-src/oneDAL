...
{
    __DAAL_INITIALIZE_KERNELS(internal::SVDBatchKernel, interm, method);
}
...
{
    __DAAL_INITIALIZE_KERNELS(internal::SVDOnlineKernel, interm, method);
}
...
{
    __DAAL_INITIALIZE_KERNELS(internal::SVDDistributedStep2Kernel, interm, method);
}
...
{
    __DAAL_INITIALIZE_KERNELS(internal::SVDDistributedStep3Kernel, interm, method);
}
