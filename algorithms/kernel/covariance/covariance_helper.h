...
#ifndef __COVARIANCE_HELPER_H__
#define __COVARIANCE_HELPER_H__
...
struct BSHelper
{
    static size_t getBlockSize(const size_t n, const size_t k)
    {
        ...
        size_t rowsFitL1               = (services::internal::getL1CacheSize() / sizeof(algorithmFPType) * cacheFullness - n * n) / n;
        size_t rowsFitL2               = (services::internal::getL2CacheSize() / sizeof(algorithmFPType) * cacheFullness - n * n) / n;
        size_t blockSize               = 96;
