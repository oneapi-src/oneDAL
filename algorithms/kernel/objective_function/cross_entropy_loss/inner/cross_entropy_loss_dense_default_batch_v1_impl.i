...
void I1CrossEntropyLossKernel<algorithmFPType, method, cpu>::applyBeta(const algorithmFPType* x,
    const algorithmFPType* beta, algorithmFPType* xb, size_t nRows,
...
template<typename algorithmFPType, Method method, CpuType cpu>
void I1CrossEntropyLossKernel<algorithmFPType, method, cpu>::applyBetaThreaded(const algorithmFPType* x,
    const algorithmFPType* beta, algorithmFPType* xb, size_t nRows,
    size_t nClasses, size_t nCols, bool bIntercept)
{
...
template<typename algorithmFPType, Method method, CpuType cpu>
void I1CrossEntropyLossKernel<algorithmFPType, method, cpu>::softmax(const algorithmFPType* arg,
...
template<typename algorithmFPType, Method method, CpuType cpu>
void I1CrossEntropyLossKernel<algorithmFPType, method, cpu>::softmaxThreaded(const algorithmFPType* arg, algorithmFPType* res, size_t nRows, size_t nCols)
{
...
template<typename algorithmFPType, Method method, CpuType cpu>
services::Status I1CrossEntropyLossKernel<algorithmFPType, method, cpu>::doCompute(const algorithmFPType* x, const algorithmFPType* y,
    size_t nRows, size_t n, size_t p, NumericTable *betaNT,
    NumericTable *valueNT, NumericTable *hessianNT, NumericTable *gradientNT,
...
template<typename algorithmFPType, Method method, CpuType cpu>
services::Status I1CrossEntropyLossKernel<algorithmFPType, method, cpu>::compute(NumericTable *dataNT,
    ...
    NumericTable *lipschitzConstant, interface1::Parameter *parameter)
{
    ...
    if(ntInd)
    {
        ...
        s |= doCompute(aX.get(), aY.get(), nRows, n, p, betaNT, valueNT, hessianNT, gradientNT,
    ...
    return doCompute(xr.get(), yr.get(), nRows, nRows, p, betaNT, valueNT, hessianNT, gradientNT,
                     nonSmoothTermValue, proximalProjection, lipschitzConstant, parameter);
}
