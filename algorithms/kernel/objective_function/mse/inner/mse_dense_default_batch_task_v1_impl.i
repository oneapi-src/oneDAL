...
I1MSETask<algorithmFPType, cpu>::I1MSETask(NumericTable *data, NumericTable *dependentVariables, NumericTable *argument,
...
template<typename algorithmFPType, CpuType cpu>
Status I1MSETask<algorithmFPType, cpu>::getResultValues(
...
template<typename algorithmFPType, CpuType cpu>
void I1MSETask<algorithmFPType, cpu>::setResultValuesToZero(
    algorithmFPType *value,
    algorithmFPType *gradient,
    algorithmFPType *hessian)
{
...
template<typename algorithmFPType, CpuType cpu>
I1MSETaskAll<algorithmFPType, cpu>::I1MSETaskAll(NumericTable *data, NumericTable *dependentVariables, NumericTable *argument, NumericTable *value,
    NumericTable *hessian, NumericTable *gradient, interface1::Parameter *parameter, size_t blockSizeDefault) :
...
template<typename algorithmFPType, CpuType cpu>
Status I1MSETaskAll<algorithmFPType, cpu>::getCurrentBlock(
    size_t startIdx,
    size_t blockSize,
...
template<typename algorithmFPType, CpuType cpu>
Status I1MSETaskSample<algorithmFPType, cpu>::getCurrentBlock(
    size_t startIdx,
    size_t blockSize,
    algorithmFPType *&pBlockData,
    algorithmFPType *&pBlockDependentVariables)
