...
void I1LogLossKernel<algorithmFPType, method, cpu>::applyBeta(const algorithmFPType* x, const algorithmFPType* beta,
...
template<typename algorithmFPType, Method method, CpuType cpu>
void I1LogLossKernel<algorithmFPType, method, cpu>::applyBetaThreaded(const algorithmFPType* x, const algorithmFPType* beta,
    algorithmFPType* xb, size_t nRows, size_t nCols, bool bIntercept)
{
...
template<typename algorithmFPType, Method method, CpuType cpu>
services::Status I1LogLossKernel<algorithmFPType, method, cpu>::doCompute(const algorithmFPType* x, const algorithmFPType* y,
    size_t n, size_t p, NumericTable *betaNT,
    NumericTable *valueNT, NumericTable *hessianNT, NumericTable *gradientNT, NumericTable *nonSmoothTermValue, NumericTable *proximalProjection, NumericTable *lipschitzConstant, interface1::Parameter *parameter)
{
...
template<typename algorithmFPType, Method method, CpuType cpu>
services::Status I1LogLossKernel<algorithmFPType, method, cpu>::compute(NumericTable *dataNT,
