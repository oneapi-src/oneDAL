...
struct TaskInfoOnline<algorithmFPType, estimatesMinMax>
{
    ...
    TaskInfoOnline(): resPartialIds{partialMinimum, partialMaximum},
                      resIds{minimum, maximum}{}
};
...
struct TaskInfoOnline<algorithmFPType, estimatesMeanVariance>
{
    ...
    TaskInfoOnline(): resPartialIds{partialSum, partialSumSquaresCentered},
                      resIds{mean, variance},
                      resFinalizeIds{mean, variance}
                      {}
};
...
struct TaskInfoOnline<algorithmFPType, estimatesAll>
{
    ...
    TaskInfoOnline(): resPartialIds{partialMinimum, partialMaximum, partialSum, partialSumSquares, partialSumSquaresCentered},
                      resIds{minimum, maximum, sum, sumSquares, sumSquaresCentered, mean,
...
{
public:
    LowOrderMomentsOnlineTaskOneAPI(ExecutionContextIface& context, NumericTable *dataTable, PartialResult *partialResult, services::Status* status);
...
private:
    unsigned int nFeatures;
    constexpr static unsigned int nTotalResults = TaskInfoOnline<algorithmFPType, scope>::nPartialResults +
                                                  TaskInfoOnline<algorithmFPType, scope>::nFinalizeResults;
