...
services::Status LinearRegressionTrainDistributedKernel<algorithmFPType, training::normEqDense, cpu>::compute(
...
template <typename algorithmFPType, CpuType cpu>
services::Status LinearRegressionTrainDistributedKernel<algorithmFPType, training::normEqDense, cpu>::finalizeCompute(
