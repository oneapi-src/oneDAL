...
/*
//++
//  Implementation of the interface for initializing the K-Means algorithm in the batch
//  processing mode
//--
*/

#ifndef __KMEANS_INIT_BATCH_V1_H__
#define __KMEANS_INIT_BATCH_V1_H__
...
public:
    ...
    typedef algorithms::kmeans::init::interface1::Parameter ParameterType;
     ...
     */
    Batch(size_t nClusters) : parameter(nClusters) { initialize(); }
