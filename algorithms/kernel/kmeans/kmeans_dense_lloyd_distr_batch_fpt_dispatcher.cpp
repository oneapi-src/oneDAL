...
{
__DAAL_INSTANTIATE_DISPATCH_CONTAINER_SYCL(preview::distributed_kmeans::interface1::BatchContainer, batch, DAAL_FPTYPE, preview::distributed_kmeans::interface1::defaultDense)
} // namespace preview
} // namespace daal
