/* file: kmeans_oneccl_dense_lloyd_batch_kernel_ucapi.h */
/*******************************************************************************
...
#ifndef __KMEANS_ONECCL_DENSE_LLOYD_BATCH_KERNEL_UCAPI_H__
#define __KMEANS_ONECCL_DENSE_LLOYD_BATCH_KERNEL_UCAPI_H__
...
class KMeansOneCclDefaultBatchKernelUCAPI : public algorithms::Kernel
{
public:
    services::Status compute(const NumericTable * const * a, const NumericTable * const * r, const algorithms::Parameter * par);
