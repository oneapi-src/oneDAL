/* file: gbt_regression_train_dense_default_distr_step6_fpt_dispatcher.cpp */
/*******************************************************************************
...
{
__DAAL_INSTANTIATE_DISPATCH_CONTAINER(gbt::regression::training::DistributedContainer, distributed, step6Local,  \
...
using DistributedType = Distributed<step6Local, DAAL_FPTYPE, gbt::regression::training::defaultDense>;
