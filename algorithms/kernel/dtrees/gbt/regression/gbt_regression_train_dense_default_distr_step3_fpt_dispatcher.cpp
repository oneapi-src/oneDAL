/* file: gbt_regression_train_dense_default_distr_step3_fpt_dispatcher.cpp */
/*******************************************************************************
...
{
__DAAL_INSTANTIATE_DISPATCH_CONTAINER(gbt::regression::training::DistributedContainer, distributed, step3Local,  \
...
using DistributedType = Distributed<step3Local, DAAL_FPTYPE, gbt::regression::training::defaultDense>;
