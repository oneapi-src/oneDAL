/* file: gbt_regression_train_dense_default_distr_step2_fpt_dispatcher.cpp */
/*******************************************************************************
...
{
__DAAL_INSTANTIATE_DISPATCH_CONTAINER(gbt::regression::training::DistributedContainer, distributed, step2Local,  \
...
using DistributedType = Distributed<step2Local, DAAL_FPTYPE, gbt::regression::training::defaultDense>;
