...
services::Status OnlineContainer<algorithmFPType, svdDense, cpu>::compute()
{
    ...
    __DAAL_CALL_KERNEL_STATUS(env, internal::PCASVDOnlineKernel, __DAAL_KERNEL_ARGUMENTS(algorithmFPType), setType, dtype);
    __DAAL_CALL_KERNEL(env, internal::PCASVDOnlineKernel, __DAAL_KERNEL_ARGUMENTS(algorithmFPType),
        compute, data, nObservations, auxiliaryTable, sumSVD, sumSquaresSVD);
}
