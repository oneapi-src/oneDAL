 ...
 */
/**
 * @brief Contains classes for computing DBSCAN
 */
...
public class Batch extends AnalysisBatch {
    ...
    /**
     * Constructs the DBSCAN algorithm in the batch processing mode by copying input objects and parameters
    ...
    public Batch(DaalContext context, Class<? extends Number> cls, Method method, double epsilon, long minObservations) {
        super(context);
        ...
        this.cObject = cInit(precision.getValue(), this.method.getValue(), epsilon, minObservations);
     ...
     * @return  Result of the DBSCAN algorithm    */
    @Override
     ...
     * @param result    Structure to store the results of the DBSCAN algorithm
     */
    ...
    /**
     * Returns the newly allocated DBSCAN algorithm in the batch processing mode
     * with a copy of input objects and parameters of this DBSCAN algorithm
     * @param context Context to manage the constructed algorithm
     *
    ...
    private native long cInit(int precision, int method, double epsilon, long minObservations);
