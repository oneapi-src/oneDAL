...
using namespace daal::algorithms::elastic_net::training;

/*
 * Class:     com_intel_daal_algorithms_elastic_net_training_BatchTraining
 * Method:    cInit
 * Signature:(II)J
 */
JNIEXPORT jlong JNICALL Java_com_intel_daal_algorithms_elastic_1net_training_TrainingBatch_cInit(JNIEnv * env, jobject thisObj, jint prec,
                                                                                                 jint method)
{
    return jniBatch<elastic_net::training::Method, Batch, defaultDense>::newObj(prec, method);
}

/*
 * Class:     com_intel_daal_algorithms_elastic_net_training_TrainingBatch
 ...
 * Signature:(JII)J
 */
JNIEXPORT jlong JNICALL Java_com_intel_daal_algorithms_elastic_1net_training_TrainingBatch_cClone(JNIEnv * env, jobject thisObj, jlong algAddr,
                                                                                                  jint prec, jint method)
{
    return jniBatch<elastic_net::training::Method, Batch, defaultDense>::getClone(prec, method, algAddr);
}
