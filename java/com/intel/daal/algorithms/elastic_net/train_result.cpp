...
/*
 * Class:     com_intel_daal_algorithms_elastic_net_training_TrainingResult
 * Method:    cNewResult
 * Signature: ()J
 */

JNIEXPORT jlong JNICALL Java_com_intel_daal_algorithms_elastic_1net_training_TrainingResult_cNewResult(JNIEnv * env, jobject thisObj)
{
    return jniArgument<elastic_net::training::Result>::newObj();
}
                                                                                                      ...
                                                                                                      jint id)
{
    if (id == ModelId)
    {
        return jniArgument<elastic_net::training::Result>::get<elastic_net::training::ResultId, elastic_net::Model>(resAddr, id);
    }
