 ...
 */
/**
 * \brief Contains classes for elastic net model-based prediction
 */
 ...
 * @brief %Input object for making elastic net model-based prediction
 */
public final class Input extends com.intel.daal.algorithms.Input {
    ...
    /**
     * Sets an input object for elastic net model-based prediction
    ...
    /**
     * Returns an input object for elastic net model-based prediction
     * @param id      Identifier of the input object
