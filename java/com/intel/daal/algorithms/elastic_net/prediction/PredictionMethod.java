...
/**
 * <a name="DAAL-CLASS-ALGORITHMS__ELASTIC_NET__PREDICTION__PREDICTIONMETHOD"></a>
 * @brief Available methods of elastic net model-based prediction
 */
public final class PredictionMethod {
    ...
    public static final PredictionMethod defaultDense = new PredictionMethod(
            defaultDenseValue); /*!< Default method of elastic net model-based prediction */
}
/** @} */
