...
import com.intel.daal.algorithms.elastic_net.TrainParameter;
import com.intel.daal.services.DaalContext;

/**
 * <a name="DAAL-CLASS-ALGORITHMS__ELASTIC_NET__TRAINING__TRAININGBATCH"></a>
...
public class TrainingBatch extends com.intel.daal.algorithms.TrainingBatch {
    ...
    /**
     * Constructs a elastic net training algorithm by copying input objects and parameters of another elastic net training algorithm in the
     * batch processing mode
     * @param context   Context to manage elastic net model-based training
    ...
    /**
     * Constructs the elastic net training algorithm in the batch processing mode
     * @param context   Context to manage elastic net model-based training
     * @param cls       Data type to use in intermediate computations of elastic net, Double.class or Float.class
     ...
     * @return Result of elastic net model-based training
     */
    @Override
    ...
    /**
     * Returns a newly allocated elastic net training algorithm with a copy of the input objects and parameters of this elastic net
