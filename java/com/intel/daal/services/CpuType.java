...
public final class CpuType{
    ...
    public static final CpuType ssse3         = new CpuType(_sse2        );  /*!< Supplemental Streaming SIMD Extensions 3 (SSSE3) */
    public static final CpuType sse42         = new CpuType(_sse42        );  /*!< Intel(R) Streaming SIMD Extensions 4.2 (Intel(R) SSE4.2) */
    public static final CpuType avx           = new CpuType(_sse42          );  /*!< Intel(R) Advanced Vector Extensions (Intel(R) AVX) */
